...
using System.Data;
using System;
namespace Customization.Doors.Doors.DynamicDocuments.Planner.Planner
{
	public class DocumentView : Microarea.EasyBuilder.MVC.DocumentView
	{
		...
		public new MDPlanner Document
		{
			get
			{
				return (MDPlanner)DocumentController.controller.Document;
			}
		}
		...
		{
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(30, 38), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Size = new System.Drawing.Size(175, 68);
			ctrl_MPushButton.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton, true);
			ctrl_MPushButton.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.view_Dynamic_ctrl_MPushButton_Click);
			ctrl_MPushButton.AddChangedEvent(new EventInfo("ctrl_MPushButton.Click", "view_Dynamic_ctrl_MPushButton_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Dynamic.ctrl_MPushButton", true));
		}
