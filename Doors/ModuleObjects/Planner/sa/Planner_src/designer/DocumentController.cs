...
namespace Customization.Doors.Doors.DynamicDocuments.Planner.Planner
{
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDPlanner Document
		{
			get
			{
				return (MDPlanner)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_Planner = new MDPlanner(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_Planner;
		...
		public MDPlanner document_Planner;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_Planner, false);
			...
			controller.DocumentLoaded += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_DocumentLoaded);
			controller.AddChangedEvent(new EventInfo("controller.DocumentLoaded", "DocumentController_DocumentLoaded", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
		}
