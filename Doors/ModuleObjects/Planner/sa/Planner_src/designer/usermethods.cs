...
namespace Customization.Doors.Doors.DynamicDocuments.Planner.Planner
{
	...
	{
		public void DocumentController_DocumentLoaded(Object sender, ControllerEventArgs e)
		{
			try
			{
				//Write your code between here
				var wv = new DoorsAddoOnLibrary.FormOdpWebManager();
            wv.Show();
				//and here
			}
		...
		public void view_Dynamic_ctrl_MPushButton_Click(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
