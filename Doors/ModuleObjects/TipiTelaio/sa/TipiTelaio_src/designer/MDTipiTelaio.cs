...
{
	public class MDTipiTelaio : MDocument
	{
		public MDTipiTelaio(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSTipiTelaio DBTDOORSTipiTelaio;
		...
		{
			DBTDOORSTipiTelaio = new DBTDOORSTipiTelaio();
			this.AttachMaster(this.DBTDOORSTipiTelaio);
