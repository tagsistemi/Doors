...
namespace Customization.Doors.Doors.DynamicDocuments.TipiTelaio.TipiTelaio
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDTipiTelaio Document
		{
			get
			{
				return (MDTipiTelaio)DocumentController.controller.Document;
			}
		}
		...
		public override void CreateComponents()
		{
			...
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Descrizione", "StringEdit", new System.Drawing.Point(177, 100), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSTipiTelaio.TTAG_DOORS_TipiTelaio.fld_Descrizione, Document.DBTDOORSTipiTelaio);
			ctrl_Descrizione.AddChangedProperty("DataBinding");
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Size = new System.Drawing.Size(372, 23);
			ctrl_Descrizione.AddChangedProperty("Size");
			this.Add(ctrl_Descrizione, true);
			ctrl_Codice = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Codice", "StringEdit", new System.Drawing.Point(177, 63), false);
			ctrl_Codice.DataBinding = new FieldDataBinding(Document.DBTDOORSTipiTelaio.TTAG_DOORS_TipiTelaio.fld_Codice, Document.DBTDOORSTipiTelaio);
