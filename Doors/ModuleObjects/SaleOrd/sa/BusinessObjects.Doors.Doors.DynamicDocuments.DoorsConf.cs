...
namespace BusinessObjects.Doors.Doors.DynamicDocuments.DoorsConf
{
	...
	[Microarea.TaskBuilderNet.Core.EasyBuilder.DocumentNamespaceAttribute("Document.Doors.Doors.DynamicDocuments.DoorsConf")]
	public class MDDoorsConf : BusinessObject
	{
		public MDDoorsConf(System.IntPtr wrappedObject) : base(wrappedObject)
		{
			DocumentController.controller = new Microarea.EasyBuilder.MVC.DocumentController(this);
			this.CallCreateComponents();
		}

		public static MDDoorsConf Create()
		{
			return MDDoorsConf.Create<MDDoorsConf>("Document.Doors.Doors.DynamicDocuments.DoorsConf");
		}

		public static MDDoorsConf Create(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDDoorsConf.Create<MDDoorsConf>("Document.Doors.Doors.DynamicDocuments.DoorsConf", context);
		}

		public static MDDoorsConf CreateUnattended(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDDoorsConf.CreateUnattended<MDDoorsConf>("Document.Doors.Doors.DynamicDocuments.DoorsConf", context);
		}

		public static MDDoorsConf CreateHidden(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDDoorsConf.CreateHidden<MDDoorsConf>("Document.Doors.Doors.DynamicDocuments.DoorsConf", context);
		}

		public DBTConfLocalData DBTConfLocalData;
		...
		{
			DBTConfLocalData = new DBTConfLocalData();
			this.AttachMaster(this.DBTConfLocalData);
	...
	public class DBTConfLocalData : MDBTMaster
	{
		public DBTConfLocalData() : base("EB_LocalData", "ConfLocalData", DocumentController.controller.Document, true)
		{
		}

		public DBTConfLocalData(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TEB_LocalData;
			}
		}

		public TDBTConfLocalData_EB_LocalData TEB_LocalData;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTEB_LocalData;
			}
		}

		public TDBTConfLocalData_EB_LocalData OldTEB_LocalData;

		public virtual TDBTConfLocalData_EB_LocalData CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTConfLocalData_EB_LocalData)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTConfLocalData(dbtPtr);
		}

		public override void CreateComponents()
		{
			TEB_LocalData = new TDBTConfLocalData_EB_LocalData(this.GetRecordPtr());
			this.Add(TEB_LocalData, true);
			OldTEB_LocalData = new TDBTConfLocalData_EB_LocalData(this.GetOldRecordPtr());
			this.Add(OldTEB_LocalData, true);
		}
		...
		public override void ClearComponents()
		{
			base.ClearComponents();
			TEB_LocalData = null;
			OldTEB_LocalData = null;
		}
	}
	public class TDBTConfLocalData_EB_LocalData : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTConfLocalData_EB_LocalData(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public MDataStr fld_Apertura;

		public MDataStr fld_Larghezza;

		public MDataStr fld_Articolo;

		public MDataStr fld_Altezza;

		public override void CreateComponents()
		{
			this.AddLocalField("Apertura", "string", 50);
			fld_Apertura = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Apertura"));
			this.Add(fld_Apertura, false);
			this.AddLocalField("Larghezza", "string", 50);
			fld_Larghezza = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Larghezza"));
			this.Add(fld_Larghezza, false);
			this.AddLocalField("Articolo", "string", 50);
			fld_Articolo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Articolo"));
			this.Add(fld_Articolo, false);
			this.AddLocalField("Altezza", "string", 50);
			fld_Altezza = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Altezza"));
