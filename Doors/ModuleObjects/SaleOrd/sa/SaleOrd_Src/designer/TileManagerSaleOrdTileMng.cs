...
{
	public class TileManagerSaleOrdTileMng : Microarea.Framework.TBApplicationWrapper.MTileManager
	{
		public TileManagerSaleOrdTileMng(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public override void CreateComponents()
		{
			...
			tileGroup_MainData.AddReferencedBy("tile_Detail_ctrl_MPushButtonDetMagg_Click");
			tileGroup_MainData.AddReferencedBy("DocumentController_ControlsEnabled");
			tileGroup_MainData.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
