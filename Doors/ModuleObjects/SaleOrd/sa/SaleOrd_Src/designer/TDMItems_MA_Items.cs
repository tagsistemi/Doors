...
{
	public class TDMItems_MA_Items : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDMItems_MA_Items(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
