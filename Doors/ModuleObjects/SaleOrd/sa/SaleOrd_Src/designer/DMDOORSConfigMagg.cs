...
{
	public class DMDOORSConfigMagg : Microarea.Framework.TBApplicationWrapper.MDataManager
	{
		public DMDOORSConfigMagg() : base("TAG_DOORS_ConfigMagg", "DOORSConfigMagg", DocumentController.controller.Document)
		{
		}
		...
		public TDMDOORSConfigMagg_TAG_DOORS_ConfigMagg TTAG_DOORS_ConfigMagg;

		public TDMDOORSConfigMagg_TAG_DOORS_ConfigMagg CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDMDOORSConfigMagg_TAG_DOORS_ConfigMagg)record;
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_ConfigMagg = new TDMDOORSConfigMagg_TAG_DOORS_ConfigMagg(this.GetRecordPtr());
