...
namespace Customization.ERP.SaleOrders.Documents.SaleOrd.SaleOrd
{
	public class DocumentView : Microarea.EasyBuilder.MVC.DocumentView
	{
		...
		public TileGroupHeaderData tileGroup_HeaderData;

		public TileManagerSaleOrdTileMng tileManager_SaleOrdTileMng;

		public override void CreateComponents()
		{
			tileGroup_HeaderData = new TileGroupHeaderData(this, "HeaderData", "", new System.Drawing.Point(0, 0), true);
			this.Add(tileGroup_HeaderData, true);
			tileGroup_HeaderData.AddReferencedBy("tile_CustomerData_ctrl_MParsedCombo_ValueChanged");
			tileGroup_HeaderData.AddReferencedBy("DocumentController_ControlsEnabled");
			tileGroup_HeaderData.AddReferencedBy("DocumentController_EnteredInBrowse");
			tileManager_SaleOrdTileMng = new TileManagerSaleOrdTileMng(this, "SaleOrdTileMng", "", new System.Drawing.Point(0, 237), true);
			this.Add(tileManager_SaleOrdTileMng, true);
			tileManager_SaleOrdTileMng.AddReferencedBy("tile_Detail_ctrl_MPushButtonDetMagg_Click");
			tileManager_SaleOrdTileMng.AddReferencedBy("DocumentController_ControlsEnabled");
			tileManager_SaleOrdTileMng.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
		...
		public override void ClearComponents()
		{
			...
			tileGroup_HeaderData = null;
			tileManager_SaleOrdTileMng = null;
		}
	}
}
