...
{
	public class TileGroupMainData : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupMainData(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public TileDetail tile_Detail;

		public override void CreateComponents()
		{
			tile_Detail = new TileDetail(this, "Detail", "", new System.Drawing.Point(0, 571), true);
			this.Add(tile_Detail, true);
			tile_Detail.AddReferencedBy("tile_Detail_ctrl_MPushButtonDetMagg_Click");
			tile_Detail.AddReferencedBy("DocumentController_ControlsEnabled");
			tile_Detail.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
