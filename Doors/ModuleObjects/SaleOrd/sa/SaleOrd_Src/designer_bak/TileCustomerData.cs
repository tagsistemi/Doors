...
{
	public class TileCustomerData : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileCustomerData(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MPushButton ctrl_ConfiguraBtn;

		public MPushButton ctrl_MPushButton3;

		public MPushButton ctrl_MPushButton4;

		public MParsedCombo ctrl_MParsedCombo;

		public override void CreateComponents()
		{
			ctrl_ConfiguraBtn = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "ConfiguraBtn", "Button", new System.Drawing.Point(581, 8), false);
			ctrl_ConfiguraBtn.AddChangedProperty("Text");
			ctrl_ConfiguraBtn.Size = new System.Drawing.Size(142, 22);
			ctrl_ConfiguraBtn.AddChangedProperty("Size");
			this.Add(ctrl_ConfiguraBtn, true);
			ctrl_ConfiguraBtn.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButton2_Click);
			ctrl_ConfiguraBtn.AddChangedEvent(new EventInfo("ctrl_ConfiguraBtn.Click", "tile_Detail_ctrl_MPushButton2_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_CustomerData.ctrl_ConfiguraBtn", true));
			ctrl_MPushButton3 = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton3", "Button", new System.Drawing.Point(582, 38), false);
			ctrl_MPushButton3.AddChangedProperty("Text");
			ctrl_MPushButton3.Size = new System.Drawing.Size(141, 22);
			ctrl_MPushButton3.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton3, true);
			ctrl_MPushButton3.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButtonNavGraf_Click);
			ctrl_MPushButton3.AddChangedEvent(new EventInfo("ctrl_MPushButton3.Click", "tile_Detail_ctrl_MPushButtonNavGraf_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_CustomerData.ctrl_MPushButton3", true));
			ctrl_MPushButton4 = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton4", "Button", new System.Drawing.Point(582, 68), false);
			ctrl_MPushButton4.AddChangedProperty("Text");
			ctrl_MPushButton4.Size = new System.Drawing.Size(141, 22);
			ctrl_MPushButton4.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton4, true);
			ctrl_MPushButton4.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButtonDetMagg_Click);
			ctrl_MPushButton4.AddChangedEvent(new EventInfo("ctrl_MPushButton4.Click", "tile_Detail_ctrl_MPushButtonDetMagg_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_CustomerData.ctrl_MPushButton4", true));
			ctrl_MParsedCombo = new Microarea.Framework.TBApplicationWrapper.MParsedCombo(this, "MParsedCombo", "StringComboDropDownList", new System.Drawing.Point(847, 67), false);
			ctrl_MParsedCombo.DataBinding = new FieldDataBinding(Document.DBTSaleOrder.TMA_SaleOrd.fld_StatoOrdineDoors, Document.DBTSaleOrder);
			ctrl_MParsedCombo.AddChangedProperty("DataBinding");
			Microarea.Framework.TBApplicationWrapper.MDataStr mdatastr1 = new Microarea.Framework.TBApplicationWrapper.MDataStr();
			mdatastr1.AlwaysReadOnly = false;
			mdatastr1.FormatterName = "";
			mdatastr1.Mandatory = false;
			mdatastr1.MaxLength = 0;
			mdatastr1.ReadOnly = false;
			mdatastr1.ShowOnlyValueInPropertyGrid = false;
			mdatastr1.UpperCase = false;
			mdatastr1.Value = "Rifiutato";
			mdatastr1.Visible = true;
			Microarea.Framework.TBApplicationWrapper.MDataStr mdatastr2 = new Microarea.Framework.TBApplicationWrapper.MDataStr();
			mdatastr2.AlwaysReadOnly = false;
			mdatastr2.FormatterName = "";
			mdatastr2.Mandatory = false;
			mdatastr2.MaxLength = 0;
			mdatastr2.ReadOnly = false;
			mdatastr2.ShowOnlyValueInPropertyGrid = false;
			mdatastr2.UpperCase = false;
			mdatastr2.Value = "Confermato";
			mdatastr2.Visible = true;
			Microarea.Framework.TBApplicationWrapper.MDataStr mdatastr3 = new Microarea.Framework.TBApplicationWrapper.MDataStr();
			mdatastr3.AlwaysReadOnly = false;
			mdatastr3.FormatterName = "";
			mdatastr3.Mandatory = false;
			mdatastr3.MaxLength = 0;
			mdatastr3.ReadOnly = false;
			mdatastr3.ShowOnlyValueInPropertyGrid = false;
			mdatastr3.UpperCase = false;
			mdatastr3.Value = "Preventivo";
			mdatastr3.Visible = true;
			ctrl_MParsedCombo.ItemsSource.Add(mdatastr1);
			ctrl_MParsedCombo.ItemsSource.Add(mdatastr2);
			ctrl_MParsedCombo.ItemsSource.Add(mdatastr3);
			ctrl_MParsedCombo.AddChangedProperty("ItemsSource");
			ctrl_MParsedCombo.AddChangedProperty("Caption");
			ctrl_MParsedCombo.Enabled = false;
			ctrl_MParsedCombo.AddChangedProperty("Enabled");
			ctrl_MParsedCombo.Size = new System.Drawing.Size(175, 23);
			ctrl_MParsedCombo.AddChangedProperty("Size");
			this.Add(ctrl_MParsedCombo, true);
			ctrl_MParsedCombo.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_CustomerData_ctrl_MParsedCombo_ValueChanged);
			ctrl_MParsedCombo.AddChangedEvent(new EventInfo("ctrl_MParsedCombo.ValueChanged", "tile_CustomerData_ctrl_MParsedCombo_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_CustomerData.ctrl_MParsedCombo", true));
			ctrl_MParsedCombo.AddReferencedBy("tile_CustomerData_ctrl_MParsedCombo_ValueChanged");
			ctrl_MParsedCombo.AddReferencedBy("DocumentController_ControlsEnabled");
			ctrl_MParsedCombo.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_ConfiguraBtn, "ctrl_ConfiguraBtn");
			resources.ApplyResources(ctrl_MPushButton3, "ctrl_MPushButton3");
			resources.ApplyResources(ctrl_MPushButton4, "ctrl_MPushButton4");
			resources.ApplyResources(ctrl_MParsedCombo, "ctrl_MParsedCombo");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_ConfiguraBtn = null;
			ctrl_MPushButton3 = null;
			ctrl_MPushButton4 = null;
			ctrl_MParsedCombo = null;
		}
	}
}
