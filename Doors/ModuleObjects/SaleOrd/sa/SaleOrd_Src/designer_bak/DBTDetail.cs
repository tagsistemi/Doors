...
{
	public class DBTDetail : MDBTSlaveBuffered
	{
		public DBTDetail() : base("MA_SaleOrdDetails", "Detail", DocumentController.controller.Document, true)
		{
		}

		public DBTDetail(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TMA_SaleOrdDetails;
			}
		}

		public TDBTDetail_MA_SaleOrdDetails TMA_SaleOrdDetails;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTMA_SaleOrdDetails;
			}
		}

		public TDBTDetail_MA_SaleOrdDetails OldTMA_SaleOrdDetails;

		public virtual TDBTDetail_MA_SaleOrdDetails CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDetail_MA_SaleOrdDetails)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDetail(dbtPtr);
		}

		public virtual TDBTDetail_MA_SaleOrdDetails GetCurrentRow()
		{
			return (TDBTDetail_MA_SaleOrdDetails)this.GetCurrentRecord();
		}

		public virtual TDBTDetail_MA_SaleOrdDetails AddRow()
		{
			return (TDBTDetail_MA_SaleOrdDetails)this.AddRecord();
		}

		public virtual TDBTDetail_MA_SaleOrdDetails InsertRow(int rowNumber)
		{
			return (TDBTDetail_MA_SaleOrdDetails)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDetail_MA_SaleOrdDetails GetRow(int rowNumber)
		{
			return (TDBTDetail_MA_SaleOrdDetails)this.GetRecord(rowNumber);
		}

		public virtual TDBTDetail_MA_SaleOrdDetails GetOldRow(int rowNumber)
		{
			return (TDBTDetail_MA_SaleOrdDetails)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TMA_SaleOrdDetails = new TDBTDetail_MA_SaleOrdDetails(this.GetRecordPtr());
			this.Add(TMA_SaleOrdDetails, true);
			OldTMA_SaleOrdDetails = new TDBTDetail_MA_SaleOrdDetails(this.GetOldRecordPtr());
			this.Add(OldTMA_SaleOrdDetails, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TMA_SaleOrdDetails = null;
			OldTMA_SaleOrdDetails = null;
		}
	}
}
