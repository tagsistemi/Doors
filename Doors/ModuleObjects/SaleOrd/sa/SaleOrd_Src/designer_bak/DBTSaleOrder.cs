...
{
	public class DBTSaleOrder : MDBTMaster
	{
		public DBTSaleOrder() : base("MA_SaleOrd", "SaleOrder", DocumentController.controller.Document, true)
		{
		}

		public DBTSaleOrder(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTSaleOrder_MA_SaleOrd TMA_SaleOrd;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTMA_SaleOrd;
			}
		}

		public TDBTSaleOrder_MA_SaleOrd OldTMA_SaleOrd;

		public virtual TDBTSaleOrder_MA_SaleOrd CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTSaleOrder_MA_SaleOrd)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTSaleOrder(dbtPtr);
		}

		public override void CreateComponents()
		{
			TMA_SaleOrd = new TDBTSaleOrder_MA_SaleOrd(this.GetRecordPtr());
			this.Add(TMA_SaleOrd, true);
			OldTMA_SaleOrd = new TDBTSaleOrder_MA_SaleOrd(this.GetOldRecordPtr());
			this.Add(OldTMA_SaleOrd, true);
		}
