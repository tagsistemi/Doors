...
{
	public class DMDOORSParams : Microarea.Framework.TBApplicationWrapper.MDataManager
	{
		public DMDOORSParams() : base("TAG_DOORS_Params", "DOORSParams", DocumentController.controller.Document)
		{
		}
		...
		public TDMDOORSParams_TAG_DOORS_Params TTAG_DOORS_Params;

		public TDMDOORSParams_TAG_DOORS_Params CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDMDOORSParams_TAG_DOORS_Params)record;
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_Params = new TDMDOORSParams_TAG_DOORS_Params(this.GetRecordPtr());
