...
{
	public class TileDocumentData : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileDocumentData(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MPushButton ctrl_MPushButton1;

		public override void CreateComponents()
		{
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(257, 8), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Visible = false;
			ctrl_MPushButton.AddChangedProperty("Visible");
			ctrl_MPushButton.Size = new System.Drawing.Size(79, 33);
			ctrl_MPushButton.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton, true);
			ctrl_MPushButton.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_DocumentData_ctrl_MPushButton_Click);
			ctrl_MPushButton.AddChangedEvent(new EventInfo("ctrl_MPushButton.Click", "tile_DocumentData_ctrl_MPushButton_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_DocumentData.ctrl_MPushButton", true));
			ctrl_MPushButton1 = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton1", "Button", new System.Drawing.Point(283, 48), false);
			ctrl_MPushButton1.AddChangedProperty("Text");
			ctrl_MPushButton1.Visible = false;
			ctrl_MPushButton1.AddChangedProperty("Visible");
			ctrl_MPushButton1.Size = new System.Drawing.Size(72, 23);
			ctrl_MPushButton1.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton1, true);
			ctrl_MPushButton1.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_DocumentData_ctrl_MPushButton1_Click);
			ctrl_MPushButton1.AddChangedEvent(new EventInfo("ctrl_MPushButton1.Click", "tile_DocumentData_ctrl_MPushButton1_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileGroup_HeaderData.tile_DocumentData.ctrl_MPushButton1", true));
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_MPushButton1, "ctrl_MPushButton1");
		}
