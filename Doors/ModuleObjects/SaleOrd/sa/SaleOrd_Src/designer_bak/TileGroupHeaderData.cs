...
{
	public class TileGroupHeaderData : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupHeaderData(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public TileDocumentData tile_DocumentData;

		public TileCustomerData tile_CustomerData;

		public override void CreateComponents()
		{
			tile_DocumentData = new TileDocumentData(this, "DocumentData", "", new System.Drawing.Point(0, 0), true);
			tile_DocumentData.Size = new System.Drawing.Size(410, 82);
			tile_DocumentData.AddChangedProperty("Size");
			this.Add(tile_DocumentData, true);
			tile_CustomerData = new TileCustomerData(this, "CustomerData", "", new System.Drawing.Point(0, 83), true);
			tile_CustomerData.Size = new System.Drawing.Size(1035, 101);
			tile_CustomerData.AddChangedProperty("Size");
			this.Add(tile_CustomerData, true);
			tile_CustomerData.AddReferencedBy("tile_CustomerData_ctrl_MParsedCombo_ValueChanged");
			tile_CustomerData.AddReferencedBy("DocumentController_ControlsEnabled");
			tile_CustomerData.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tile_DocumentData, "tile_DocumentData");
			resources.ApplyResources(tile_CustomerData, "tile_CustomerData");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			tile_DocumentData = null;
			tile_CustomerData = null;
		}
	}
}
