...
{
	[ReferenceDeclarationAttribute("BusinessObject", "Document.ERP.Variants.Documents.Variants", "MDVariants")]
	[ReferenceDeclarationAttribute("BusinessObject", "Document.ERP.BillOfMaterials.Documents.BOMNavigation", "MDBOMNavigation")]
	[ReferenceDeclarationAttribute("BusinessObject", "Document.Doors.Doors.DynamicDocuments.Configurazioni", "MDConfigurazioni")]
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDSaleOrd Document
		{
			get
			{
				return (MDSaleOrd)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_SaleOrd = new MDSaleOrd(documentHandle);
			view_SaleOrd = new DocumentView(formHandle);
			this.document = document_SaleOrd;
			this.view = view_SaleOrd;
			this.CreateCodeExtender();
		}

		partial void CreateCodeExtender();

		public MDSaleOrd document_SaleOrd;

		public DocumentView view_SaleOrd;

		public override void CreateComponents()
		{
			this.Add(document_SaleOrd, true);
			this.Add(view_SaleOrd, true);
			controller.EnteredInBrowse += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_EnteredInBrowse);
			controller.AddChangedEvent(new EventInfo("controller.EnteredInBrowse", "DocumentController_EnteredInBrowse", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
			...
			controller.ExtraTransacted += new System.EventHandler<Microarea.EasyBuilder.TransactionEventArgs>(DocumentController.controller.DocumentController_ExtraTransacted);
			controller.AddChangedEvent(new EventInfo("controller.ExtraTransacted", "DocumentController_ExtraTransacted", "System.EventHandler`1[Microarea.EasyBuilder.TransactionEventArgs]", "", true));
		}
