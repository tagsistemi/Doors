...
{
	public class TileDetail : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileDetail(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public BEBEDetail ctrl_BEDetail;

		public MPushButton ctrl_MPushButton2;

		public MPushButton ctrl_MPushButtonNavGraf;

		public MPushButton ctrl_MPushButtonDetMagg;

		public override void CreateComponents()
		{
			ctrl_BEDetail = new BEBEDetail(this, "BEDetail", "BodyEdit", new System.Drawing.Point(0, 71), true);
			ctrl_BEDetail.TitleRows = 2D;
			ctrl_BEDetail.AddChangedProperty("TitleRows");
			ctrl_BEDetail.Size = new System.Drawing.Size(574, 257);
			ctrl_BEDetail.AddChangedProperty("Size");
			this.Add(ctrl_BEDetail, true);
			ctrl_BEDetail.AddReferencedBy("tile_Detail_ctrl_MPushButtonDetMagg_Click");
			ctrl_MPushButton2 = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton2", "Button", new System.Drawing.Point(188, 31), false);
			ctrl_MPushButton2.AddChangedProperty("Text");
			ctrl_MPushButton2.Enabled = false;
			ctrl_MPushButton2.AddChangedProperty("Enabled");
			ctrl_MPushButton2.Visible = false;
			ctrl_MPushButton2.AddChangedProperty("Visible");
			ctrl_MPushButton2.Size = new System.Drawing.Size(124, 28);
			ctrl_MPushButton2.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton2, true);
			ctrl_MPushButton2.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButton2_Click);
			ctrl_MPushButton2.AddChangedEvent(new EventInfo("ctrl_MPushButton2.Click", "tile_Detail_ctrl_MPushButton2_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileManager_SaleOrdTileMng.tileGroup_MainData.tile_Detail.ctrl_MPushButton2", true));
			ctrl_MPushButton2.AddReferencedBy("DocumentController_ControlsEnabled");
			ctrl_MPushButton2.AddReferencedBy("DocumentController_EnteredInBrowse");
			ctrl_MPushButtonNavGraf = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButtonNavGraf", "Button", new System.Drawing.Point(316, 31), false);
			ctrl_MPushButtonNavGraf.AddChangedProperty("Text");
			ctrl_MPushButtonNavGraf.Enabled = false;
			ctrl_MPushButtonNavGraf.AddChangedProperty("Enabled");
			ctrl_MPushButtonNavGraf.Visible = false;
			ctrl_MPushButtonNavGraf.AddChangedProperty("Visible");
			ctrl_MPushButtonNavGraf.Size = new System.Drawing.Size(124, 28);
			ctrl_MPushButtonNavGraf.AddChangedProperty("Size");
			this.Add(ctrl_MPushButtonNavGraf, true);
			ctrl_MPushButtonNavGraf.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButtonNavGraf_Click);
			ctrl_MPushButtonNavGraf.AddChangedEvent(new EventInfo("ctrl_MPushButtonNavGraf.Click", "tile_Detail_ctrl_MPushButtonNavGraf_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileManager_SaleOrdTileMng.tileGroup_MainData.tile_Detail.ctrl_MPushButtonNavGraf", true));
			ctrl_MPushButtonNavGraf.AddReferencedBy("DocumentController_ControlsEnabled");
			ctrl_MPushButtonNavGraf.AddReferencedBy("DocumentController_EnteredInBrowse");
			ctrl_MPushButtonDetMagg = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButtonDetMagg", "Button", new System.Drawing.Point(450, 31), false);
			ctrl_MPushButtonDetMagg.AddChangedProperty("Text");
			ctrl_MPushButtonDetMagg.Enabled = false;
			ctrl_MPushButtonDetMagg.AddChangedProperty("Enabled");
			ctrl_MPushButtonDetMagg.Visible = false;
			ctrl_MPushButtonDetMagg.AddChangedProperty("Visible");
			ctrl_MPushButtonDetMagg.Size = new System.Drawing.Size(124, 28);
			ctrl_MPushButtonDetMagg.AddChangedProperty("Size");
			this.Add(ctrl_MPushButtonDetMagg, true);
			ctrl_MPushButtonDetMagg.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_Detail_ctrl_MPushButtonDetMagg_Click);
			ctrl_MPushButtonDetMagg.AddChangedEvent(new EventInfo("ctrl_MPushButtonDetMagg.Click", "tile_Detail_ctrl_MPushButtonDetMagg_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_SaleOrd.tileManager_SaleOrdTileMng.tileGroup_MainData.tile_Detail.ctrl_MPushButtonDetMagg", true));
			ctrl_MPushButtonDetMagg.AddReferencedBy("DocumentController_ControlsEnabled");
			ctrl_MPushButtonDetMagg.AddReferencedBy("DocumentController_EnteredInBrowse");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_BEDetail, "ctrl_BEDetail");
			resources.ApplyResources(ctrl_MPushButton2, "ctrl_MPushButton2");
			resources.ApplyResources(ctrl_MPushButtonNavGraf, "ctrl_MPushButtonNavGraf");
			resources.ApplyResources(ctrl_MPushButtonDetMagg, "ctrl_MPushButtonDetMagg");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_BEDetail = null;
			ctrl_MPushButton2 = null;
			ctrl_MPushButtonNavGraf = null;
			ctrl_MPushButtonDetMagg = null;
		}
	}
}
