...
namespace BusinessObjects.Doors.Doors.DynamicDocuments.ConfiguratoreDoors
{
	...
	[Microarea.TaskBuilderNet.Core.EasyBuilder.DocumentNamespaceAttribute("Document.Doors.Doors.DynamicDocuments.ConfiguratoreDoors")]
	public class MDConfiguratoreDoors : BusinessObject
	{
		public MDConfiguratoreDoors(System.IntPtr wrappedObject) : base(wrappedObject)
		{
			DocumentController.controller = new Microarea.EasyBuilder.MVC.DocumentController(this);
			this.CallCreateComponents();
		}

		public static MDConfiguratoreDoors Create()
		{
			return MDConfiguratoreDoors.Create<MDConfiguratoreDoors>("Document.Doors.Doors.DynamicDocuments.ConfiguratoreDoors");
		}

		public static MDConfiguratoreDoors Create(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDConfiguratoreDoors.Create<MDConfiguratoreDoors>("Document.Doors.Doors.DynamicDocuments.ConfiguratoreDoors", context);
		}

		public static MDConfiguratoreDoors CreateUnattended(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDConfiguratoreDoors.CreateUnattended<MDConfiguratoreDoors>("Document.Doors.Doors.DynamicDocuments.ConfiguratoreDoors", context);
		}

		public static MDConfiguratoreDoors CreateHidden(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDConfiguratoreDoors.CreateHidden<MDConfiguratoreDoors>("Document.Doors.Doors.DynamicDocuments.ConfiguratoreDoors", context);
		}

		public DBTLocalData DBTLocalData;
		...
		{
			DBTLocalData = new DBTLocalData();
			this.AttachMaster(this.DBTLocalData);
	...
	public class DBTLocalData : MDBTMaster
	{
		public DBTLocalData() : base("EB_LocalData", "LocalData", DocumentController.controller.Document, true)
		{
		}

		public DBTLocalData(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTLocalData_EB_LocalData TEB_LocalData;
		...
		public TDBTLocalData_EB_LocalData OldTEB_LocalData;

		public virtual TDBTLocalData_EB_LocalData CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTLocalData_EB_LocalData)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTLocalData(dbtPtr);
		}

		public override void CreateComponents()
		{
			TEB_LocalData = new TDBTLocalData_EB_LocalData(this.GetRecordPtr());
			this.Add(TEB_LocalData, true);
			OldTEB_LocalData = new TDBTLocalData_EB_LocalData(this.GetOldRecordPtr());
	...
	public class TDBTLocalData_EB_LocalData : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTLocalData_EB_LocalData(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public MDataStr fld_Variante;

		public override void CreateComponents()
		{
			this.AddLocalField("Variante", "string", 50);
			fld_Variante = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Variante"));
			this.Add(fld_Variante, false);
		}
