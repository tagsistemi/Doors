...
{
	public class DMItems : Microarea.Framework.TBApplicationWrapper.MDataManager
	{
		public DMItems() : base("MA_Items", "Items", DocumentController.controller.Document)
		{
		}
		...
		public TDMItems_MA_Items TMA_Items;

		public TDMItems_MA_Items CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDMItems_MA_Items)record;
		}

		public override void CreateComponents()
		{
			TMA_Items = new TDMItems_MA_Items(this.GetRecordPtr());
