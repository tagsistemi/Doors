...
namespace BusinessObjects.ERP.Variants.Documents.Variants
{
	...
	[Microarea.TaskBuilderNet.Core.EasyBuilder.DocumentNamespaceAttribute("Document.ERP.Variants.Documents.Variants")]
	public class MDVariants : BusinessObject
	{
		public MDVariants(System.IntPtr wrappedObject) : base(wrappedObject)
		{
			DocumentController.controller = new Microarea.EasyBuilder.MVC.DocumentController(this);
			this.CallCreateComponents();
		}

		public static MDVariants Create()
		{
			return MDVariants.Create<MDVariants>("Document.ERP.Variants.Documents.Variants");
		}

		public static MDVariants Create(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDVariants.Create<MDVariants>("Document.ERP.Variants.Documents.Variants", context);
		}

		public static MDVariants CreateUnattended(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDVariants.CreateUnattended<MDVariants>("Document.ERP.Variants.Documents.Variants", context);
		}

		public static MDVariants CreateHidden(Microarea.Framework.TBApplicationWrapper.DocumentContext context)
		{
			return MDVariants.CreateHidden<MDVariants>("Document.ERP.Variants.Documents.Variants", context);
		}

		public DBTVariants DBTVariants;

		public DBTVariantComponents DBTVariantComponents;

		public DBTVariantRouting DBTVariantRouting;

		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_sWCHKLSelector;

		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_sItemGhostHKLSelector;
		...
		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_FromItemToCopy;

		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_VariantToCopy;
		...
		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_sTitleRouting;

		public Microarea.Framework.TBApplicationWrapper.MDataStr fld_sMasterType;

		public Microarea.Framework.TBApplicationWrapper.MDataBool fld_bEnableRoutingBtn;

		public Microarea.Framework.TBApplicationWrapper.MDataBool fld_bEnableComponentsBtn;
		...
		{
			DBTVariants = new DBTVariants();
			this.AttachMaster(this.DBTVariants);
			DBTVariantComponents = new DBTVariantComponents();
			this.AttachSlave(DBTVariantComponents);
			DBTVariantRouting = new DBTVariantRouting();
			this.AttachSlave(DBTVariantRouting);
			this.fld_sWCHKLSelector = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("sWCHKLSelector"));
			this.fld_sItemGhostHKLSelector = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("sItemGhostHKLSelector"));
			...
			this.fld_FromItemToCopy = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("FromItemToCopy"));
			this.fld_VariantToCopy = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("VariantToCopy"));
			...
			this.fld_sTitleRouting = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("sTitleRouting"));
			this.fld_sMasterType = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("sMasterType"));
			this.fld_bEnableRoutingBtn = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("bEnableRoutingBtn"));
			this.fld_bEnableComponentsBtn = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("bEnableComponentsBtn"));
		...
		public override void ClearComponents()
		{
			...
			DBTVariants = null;
			DBTVariantComponents = null;
			DBTVariantRouting = null;
			fld_sWCHKLSelector = null;
			fld_sItemGhostHKLSelector = null;
			fld_sHKLCustSuppSelector = null;
			fld__DEBUG = null;
			fld_FormMode = null;
			fld_bUseDrawings = null;
			fld_bUseScrapPercentage = null;
			fld_FromItemToCopy = null;
			fld_VariantToCopy = null;
			fld_bCheckExistItem = null;
			fld_nLen = null;
			fld_sTitleRouting = null;
			fld_sMasterType = null;
			fld_bEnableRoutingBtn = null;
			fld_bEnableComponentsBtn = null;
			fld_ItemMaxLen = null;
	...
	public class DBTVariants : MDBTMaster
	{
		public DBTVariants() : base("MA_Variants", "Variants", DocumentController.controller.Document, true)
		{
		}

		public DBTVariants(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTVariants_MA_Variants TMA_Variants;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTMA_Variants;
			}
		}

		public TDBTVariants_MA_Variants OldTMA_Variants;

		public virtual TDBTVariants_MA_Variants CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTVariants_MA_Variants)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTVariants(dbtPtr);
		}

		public override void CreateComponents()
		{
			TMA_Variants = new TDBTVariants_MA_Variants(this.GetRecordPtr());
			this.Add(TMA_Variants, false);
			OldTMA_Variants = new TDBTVariants_MA_Variants(this.GetOldRecordPtr());
			this.Add(OldTMA_Variants, false);
		}
		...
		public override void ClearComponents()
		{
			base.ClearComponents();
			TMA_Variants = null;
			OldTMA_Variants = null;
		}
	}
	public class TDBTVariants_MA_Variants : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTVariants_MA_Variants(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
	...
	public class DBTVariantComponents : MDBTSlaveBuffered
	{
		public DBTVariantComponents() : base("MA_VariantsComponents", "VariantComponents", DocumentController.controller.Document, true)
		{
		}

		public DBTVariantComponents(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TMA_VariantsComponents;
			}
		}

		public TDBTVariantComponents_MA_VariantsComponents TMA_VariantsComponents;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTMA_VariantsComponents;
			}
		}

		public TDBTVariantComponents_MA_VariantsComponents OldTMA_VariantsComponents;

		public virtual TDBTVariantComponents_MA_VariantsComponents CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTVariantComponents_MA_VariantsComponents)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTVariantComponents(dbtPtr);
		}

		public virtual TDBTVariantComponents_MA_VariantsComponents GetCurrentRow()
		{
			return (TDBTVariantComponents_MA_VariantsComponents)this.GetCurrentRecord();
		}

		public virtual TDBTVariantComponents_MA_VariantsComponents AddRow()
		{
			return (TDBTVariantComponents_MA_VariantsComponents)this.AddRecord();
		}

		public virtual TDBTVariantComponents_MA_VariantsComponents InsertRow(int rowNumber)
		{
			return (TDBTVariantComponents_MA_VariantsComponents)this.InsertRecord(rowNumber);
		}

		public virtual TDBTVariantComponents_MA_VariantsComponents GetRow(int rowNumber)
		{
			return (TDBTVariantComponents_MA_VariantsComponents)this.GetRecord(rowNumber);
		}

		public virtual TDBTVariantComponents_MA_VariantsComponents GetOldRow(int rowNumber)
		{
			return (TDBTVariantComponents_MA_VariantsComponents)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TMA_VariantsComponents = new TDBTVariantComponents_MA_VariantsComponents(this.GetRecordPtr());
			this.Add(TMA_VariantsComponents, false);
			OldTMA_VariantsComponents = new TDBTVariantComponents_MA_VariantsComponents(this.GetOldRecordPtr());
			this.Add(OldTMA_VariantsComponents, false);
		}
		...
		{
			base.ClearComponents();
			TMA_VariantsComponents = null;
			OldTMA_VariantsComponents = null;
		}
	}
	public class TDBTVariantComponents_MA_VariantsComponents : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTVariantComponents_MA_VariantsComponents(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataLng fld_BOMComponentsSubId;

		public MDataStr fld_Component;

		public MDataStr fld_ComponentVariant;
		...
		public MDataStr fld_Formula;

		public MDataEnum fld_SubstType;
		...
		public MDataBool fld_l_WasteInPerc;
		...
		public override void CreateComponents()
		{
			...
			fld_BOM = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("BOM"));
			this.Add(fld_BOM, false);
			fld_BOMComponentsSubId = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("BOMComponentsSubId"));
			this.Add(fld_BOMComponentsSubId, false);
			...
			fld_ComponentVariant = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("ComponentVariant"));
			this.Add(fld_ComponentVariant, false);
			...
			fld_Formula = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Formula"));
			this.Add(fld_Formula, false);
			fld_SubstType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("SubstType"));
			this.Add(fld_SubstType, false);
			...
			fld_l_WasteInPerc = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("l_WasteInPerc"));
			this.Add(fld_l_WasteInPerc, false);
			fld_TBCreated = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("TBCreated"));
			this.Add(fld_TBCreated, false);
			fld_TBModified = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("TBModified"));
			this.Add(fld_TBModified, false);
		...
		public override void ClearComponents()
		{
			...
			fld_Line = null;
			fld_BOM = null;
			fld_BOMComponentsSubId = null;
			fld_Component = null;
			fld_ComponentVariant = null;
	...
	public class DBTVariantRouting : MDBTSlaveBuffered
	{
		public DBTVariantRouting() : base("MA_VariantsRouting", "VariantRouting", DocumentController.controller.Document, true)
		{
		}

		public DBTVariantRouting(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TMA_VariantsRouting;
			}
		}

		public TDBTVariantRouting_MA_VariantsRouting TMA_VariantsRouting;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTMA_VariantsRouting;
			}
		}

		public TDBTVariantRouting_MA_VariantsRouting OldTMA_VariantsRouting;

		public virtual TDBTVariantRouting_MA_VariantsRouting CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTVariantRouting_MA_VariantsRouting)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTVariantRouting(dbtPtr);
		}

		public virtual TDBTVariantRouting_MA_VariantsRouting GetCurrentRow()
		{
			return (TDBTVariantRouting_MA_VariantsRouting)this.GetCurrentRecord();
		}

		public virtual TDBTVariantRouting_MA_VariantsRouting AddRow()
		{
			return (TDBTVariantRouting_MA_VariantsRouting)this.AddRecord();
		}

		public virtual TDBTVariantRouting_MA_VariantsRouting InsertRow(int rowNumber)
		{
			return (TDBTVariantRouting_MA_VariantsRouting)this.InsertRecord(rowNumber);
		}

		public virtual TDBTVariantRouting_MA_VariantsRouting GetRow(int rowNumber)
		{
			return (TDBTVariantRouting_MA_VariantsRouting)this.GetRecord(rowNumber);
		}

		public virtual TDBTVariantRouting_MA_VariantsRouting GetOldRow(int rowNumber)
		{
			return (TDBTVariantRouting_MA_VariantsRouting)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TMA_VariantsRouting = new TDBTVariantRouting_MA_VariantsRouting(this.GetRecordPtr());
			this.Add(TMA_VariantsRouting, false);
			OldTMA_VariantsRouting = new TDBTVariantRouting_MA_VariantsRouting(this.GetOldRecordPtr());
			this.Add(OldTMA_VariantsRouting, false);
		}
		...
		{
			base.ClearComponents();
			TMA_VariantsRouting = null;
			OldTMA_VariantsRouting = null;
		}
	}
	public class TDBTVariantRouting_MA_VariantsRouting : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTVariantRouting_MA_VariantsRouting(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataLng fld_BOMRoutingSubId;
		...
		public override void CreateComponents()
		{
			...
			fld_Variant = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Variant"));
			this.Add(fld_Variant, false);
			fld_BOMRoutingSubId = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("BOMRoutingSubId"));
			this.Add(fld_BOMRoutingSubId, false);
