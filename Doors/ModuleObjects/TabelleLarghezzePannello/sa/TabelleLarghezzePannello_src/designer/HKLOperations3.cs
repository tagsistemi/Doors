...
{
	public class HKLOperations3 : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLOperations3() : base("MA_Operations", "Operations3", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLOperations3_MA_Operations TMA_Operations;

		public virtual THKLOperations3_MA_Operations CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLOperations3_MA_Operations)record;
		}

		public MHotLinkSearch HKLOperations3_ByKey;

		public MHotLinkSearch HKLOperations3_ByDescription;

		public override void CreateComponents()
		{
			TMA_Operations = new THKLOperations3_MA_Operations(this.GetRecordPtr());
			this.Add(TMA_Operations, false);
			HKLOperations3_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations3_ByKey.UseInComboBox = true;
			HKLOperations3_ByKey.AddChangedProperty("UseInComboBox");
			HKLOperations3_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLOperations3_ByKey.AddChangedProperty("AssociatedButton");
			HKLOperations3_ByKey.FieldName = "Operation";
			HKLOperations3_ByKey.AddChangedProperty("FieldName");
			HKLOperations3_ByKey.AddChangedProperty("Description");
			HKLOperations3_ByKey.Name = "ByKey";
			HKLOperations3_ByKey.AddChangedProperty("Name");
			this.Add(HKLOperations3_ByKey, true);
			HKLOperations3_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations3_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLOperations3_ByDescription.AddChangedProperty("AssociatedButton");
			HKLOperations3_ByDescription.FieldName = "Description";
			HKLOperations3_ByDescription.AddChangedProperty("FieldName");
			HKLOperations3_ByDescription.AddChangedProperty("Description");
			HKLOperations3_ByDescription.Name = "ByDescription";
			HKLOperations3_ByDescription.AddChangedProperty("Name");
			this.Add(HKLOperations3_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLOperations3_ByKey, "HKLOperations3_ByKey");
			resources.ApplyResources(HKLOperations3_ByDescription, "HKLOperations3_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			TMA_Operations = null;
			HKLOperations3_ByKey = null;
			HKLOperations3_ByDescription = null;
		}
	}
}
