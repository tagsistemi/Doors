...
{
	public class HKLOperations1 : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLOperations1() : base("MA_Operations", "Operations1", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLOperations1_MA_Operations TMA_Operations;

		public virtual THKLOperations1_MA_Operations CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLOperations1_MA_Operations)record;
		}

		public MHotLinkSearch HKLOperations1_ByKey;

		public MHotLinkSearch HKLOperations1_ByDescription;

		public override void CreateComponents()
		{
			TMA_Operations = new THKLOperations1_MA_Operations(this.GetRecordPtr());
			this.Add(TMA_Operations, false);
			HKLOperations1_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations1_ByKey.UseInComboBox = true;
			HKLOperations1_ByKey.AddChangedProperty("UseInComboBox");
			HKLOperations1_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLOperations1_ByKey.AddChangedProperty("AssociatedButton");
			HKLOperations1_ByKey.FieldName = "Operation";
			HKLOperations1_ByKey.AddChangedProperty("FieldName");
			HKLOperations1_ByKey.AddChangedProperty("Description");
			HKLOperations1_ByKey.Name = "ByKey";
			HKLOperations1_ByKey.AddChangedProperty("Name");
			this.Add(HKLOperations1_ByKey, true);
			HKLOperations1_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations1_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLOperations1_ByDescription.AddChangedProperty("AssociatedButton");
			HKLOperations1_ByDescription.FieldName = "Description";
			HKLOperations1_ByDescription.AddChangedProperty("FieldName");
			HKLOperations1_ByDescription.AddChangedProperty("Description");
			HKLOperations1_ByDescription.Name = "ByDescription";
			HKLOperations1_ByDescription.AddChangedProperty("Name");
			this.Add(HKLOperations1_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLOperations1_ByKey, "HKLOperations1_ByKey");
			resources.ApplyResources(HKLOperations1_ByDescription, "HKLOperations1_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			TMA_Operations = null;
			HKLOperations1_ByKey = null;
			HKLOperations1_ByDescription = null;
		}
	}
}
