...
{
	public class HKLOperations2 : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLOperations2() : base("MA_Operations", "Operations2", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLOperations2_MA_Operations TMA_Operations;

		public virtual THKLOperations2_MA_Operations CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLOperations2_MA_Operations)record;
		}

		public MHotLinkSearch HKLOperations2_ByKey;

		public MHotLinkSearch HKLOperations2_ByDescription;

		public override void CreateComponents()
		{
			TMA_Operations = new THKLOperations2_MA_Operations(this.GetRecordPtr());
			this.Add(TMA_Operations, true);
			HKLOperations2_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations2_ByKey.UseInComboBox = true;
			HKLOperations2_ByKey.AddChangedProperty("UseInComboBox");
			HKLOperations2_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLOperations2_ByKey.AddChangedProperty("AssociatedButton");
			HKLOperations2_ByKey.FieldName = "Operation";
			HKLOperations2_ByKey.AddChangedProperty("FieldName");
			HKLOperations2_ByKey.AddChangedProperty("Description");
			HKLOperations2_ByKey.Name = "ByKey";
			HKLOperations2_ByKey.AddChangedProperty("Name");
			this.Add(HKLOperations2_ByKey, true);
			HKLOperations2_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations2_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLOperations2_ByDescription.AddChangedProperty("AssociatedButton");
			HKLOperations2_ByDescription.FieldName = "Description";
			HKLOperations2_ByDescription.AddChangedProperty("FieldName");
			HKLOperations2_ByDescription.AddChangedProperty("Description");
			HKLOperations2_ByDescription.Name = "ByDescription";
			HKLOperations2_ByDescription.AddChangedProperty("Name");
			this.Add(HKLOperations2_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLOperations2_ByKey, "HKLOperations2_ByKey");
			resources.ApplyResources(HKLOperations2_ByDescription, "HKLOperations2_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			TMA_Operations = null;
			HKLOperations2_ByKey = null;
			HKLOperations2_ByDescription = null;
		}
	}
}
