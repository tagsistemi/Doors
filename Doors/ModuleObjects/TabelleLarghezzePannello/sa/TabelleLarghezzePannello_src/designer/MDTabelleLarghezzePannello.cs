...
{
	public class MDTabelleLarghezzePannello : MDocument
	{
		public MDTabelleLarghezzePannello(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSTabellaPannelliTesta DBTDOORSTabellaPannelliTesta;

		public HKLDOORSBattute HKLDOORSBattute;

		public DBTDOORSTabellaPannelliR DBTDOORSTabellaPannelliR;

		public HKLOperations1 HKLOperations1;

		public HKLOperations2 HKLOperations2;

		public HKLOperations3 HKLOperations3;

		public HKLDOORSGruppiFiniture HKLDOORSGruppiFiniture;

		public HKLDOORSFiniture HKLDOORSFiniture;

		public HKLDOORSBattuteHlRighe HKLDOORSBattuteHlRighe;

		public DBTDOORSTabellaPannelliAp DBTDOORSTabellaPannelliAp;
		...
		{
			DBTDOORSTabellaPannelliTesta = new DBTDOORSTabellaPannelliTesta();
			this.AttachMaster(this.DBTDOORSTabellaPannelliTesta);
			HKLDOORSBattute = new HKLDOORSBattute();
			this.Add(this.HKLDOORSBattute, true);
			HKLDOORSBattute.DataMustExist = true;
			HKLDOORSBattute.AddChangedProperty("DataMustExist");
			HKLDOORSBattute.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.DOORSBattute";
			HKLDOORSBattute.AddChangedProperty("PublicationNamespace");
			DBTDOORSTabellaPannelliR = new DBTDOORSTabellaPannelliR();
			this.AttachSlave(DBTDOORSTabellaPannelliR);
			DBTDOORSTabellaPannelliR.AddMasterForeignKey(DBTDOORSTabellaPannelliR.TTAG_DOORS_TabellaPannelliR.fld_Finitura, "Finitura");
			DBTDOORSTabellaPannelliR.AddMasterForeignKey(DBTDOORSTabellaPannelliR.TTAG_DOORS_TabellaPannelliR.fld_Battuta, "Battuta");
			DBTDOORSTabellaPannelliR.DefiningQuery += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.DataManagerEventArgs>(DocumentController.controller.Document_DBTDOORSTabellaPannelliR_DefiningQuery);
			DBTDOORSTabellaPannelliR.AddChangedEvent(new EventInfo("DBTDOORSTabellaPannelliR.DefiningQuery", "Document_DBTDOORSTabellaPannelliR_DefiningQuery", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.DataManagerEventArgs]", "Document.DBTDOORSTabellaPannelliR", true));
			HKLOperations1 = new HKLOperations1();
			this.Add(this.HKLOperations1, true);
			HKLOperations1.DataMustExist = true;
			HKLOperations1.AddChangedProperty("DataMustExist");
			HKLOperations1.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.Operations1";
			HKLOperations1.AddChangedProperty("PublicationNamespace");
			HKLOperations2 = new HKLOperations2();
			this.Add(this.HKLOperations2, true);
			HKLOperations2.DataMustExist = true;
			HKLOperations2.AddChangedProperty("DataMustExist");
			HKLOperations2.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.Operations2";
			HKLOperations2.AddChangedProperty("PublicationNamespace");
			HKLOperations3 = new HKLOperations3();
			this.Add(this.HKLOperations3, true);
			HKLOperations3.DataMustExist = true;
			HKLOperations3.AddChangedProperty("DataMustExist");
			HKLOperations3.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.Operations3";
			HKLOperations3.AddChangedProperty("PublicationNamespace");
			HKLDOORSGruppiFiniture = new HKLDOORSGruppiFiniture();
			this.Add(this.HKLDOORSGruppiFiniture, true);
			HKLDOORSGruppiFiniture.DataMustExist = true;
			HKLDOORSGruppiFiniture.AddChangedProperty("DataMustExist");
			HKLDOORSGruppiFiniture.LinkedDocumentNamespace = "Document.Doors.Doors.DynamicDocuments.GruppiFiniture";
			HKLDOORSGruppiFiniture.AddChangedProperty("LinkedDocumentNamespace");
			HKLDOORSGruppiFiniture.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.DOORSGruppiFiniture";
			HKLDOORSGruppiFiniture.AddChangedProperty("PublicationNamespace");
			HKLDOORSFiniture = new HKLDOORSFiniture();
			this.Add(this.HKLDOORSFiniture, true);
			HKLDOORSFiniture.DataMustExist = true;
			HKLDOORSFiniture.AddChangedProperty("DataMustExist");
			HKLDOORSFiniture.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.DOORSFiniture";
			HKLDOORSFiniture.AddChangedProperty("PublicationNamespace");
			HKLDOORSBattuteHlRighe = new HKLDOORSBattuteHlRighe();
			this.Add(this.HKLDOORSBattuteHlRighe, true);
			HKLDOORSBattuteHlRighe.DataMustExist = true;
			HKLDOORSBattuteHlRighe.AddChangedProperty("DataMustExist");
			HKLDOORSBattuteHlRighe.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.DOORSBattuteHlRighe";
			HKLDOORSBattuteHlRighe.AddChangedProperty("PublicationNamespace");
			DBTDOORSTabellaPannelliAp = new DBTDOORSTabellaPannelliAp();
			this.AttachSlave(DBTDOORSTabellaPannelliAp);
			DBTDOORSTabellaPannelliAp.AddMasterForeignKey(DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_Finitura, "Finitura");
			DBTDOORSTabellaPannelliAp.AddMasterForeignKey(DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_Battuta, "Battuta");
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLDOORSBattute, "HKLDOORSBattute");
			resources.ApplyResources(HKLOperations1, "HKLOperations1");
			resources.ApplyResources(HKLOperations2, "HKLOperations2");
			resources.ApplyResources(HKLOperations3, "HKLOperations3");
			resources.ApplyResources(HKLDOORSGruppiFiniture, "HKLDOORSGruppiFiniture");
			resources.ApplyResources(HKLDOORSFiniture, "HKLDOORSFiniture");
			resources.ApplyResources(HKLDOORSBattuteHlRighe, "HKLDOORSBattuteHlRighe");
		...
		public override void ClearComponents()
		{
			...
			DBTDOORSTabellaPannelliTesta = null;
			HKLDOORSBattute = null;
			DBTDOORSTabellaPannelliR = null;
			HKLOperations1 = null;
			HKLOperations2 = null;
			HKLOperations3 = null;
			HKLDOORSGruppiFiniture = null;
			HKLDOORSFiniture = null;
			HKLDOORSBattuteHlRighe = null;
			DBTDOORSTabellaPannelliAp = null;
