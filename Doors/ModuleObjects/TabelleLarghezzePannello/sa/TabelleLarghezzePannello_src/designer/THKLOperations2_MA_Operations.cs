...
{
	public class THKLOperations2_MA_Operations : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public THKLOperations2_MA_Operations(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataStr fld_OperationDescriptionFile;

		public MDataStr fld_Notes;

		public MDataStr fld_Item;

		public MDataStr fld_ProcessingTeam;

		public MDataLng fld_ProcessingTime;

		public MDataPerc fld_ProcessingAttendancePerc;

		public MDataLng fld_ProcessingWorkingTime;

		public MDataInt fld_NoOfProcessingWorkers;

		public MDataStr fld_SetupTeam;

		public MDataLng fld_SetupTime;

		public MDataPerc fld_SetupAttendancePerc;

		public MDataLng fld_SetupWorkingTime;

		public MDataInt fld_NoOfSetupWorkers;

		public MDataLng fld_QueueTime;

		public MDataMon fld_HourlyCost;

		public MDataMon fld_UnitCost;

		public MDataMon fld_AdditionalCost;

		public MDataBool fld_CostsOnQty;
		...
		public MDataInt fld_LocalField1;
		...
		public override void CreateComponents()
		{
			...
			fld_OperationDescriptionFile = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("OperationDescriptionFile"));
			this.Add(fld_OperationDescriptionFile, false);
			...
			fld_ProcessingTeam = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("ProcessingTeam"));
			this.Add(fld_ProcessingTeam, false);
			...
			fld_ProcessingAttendancePerc = new Microarea.Framework.TBApplicationWrapper.MDataPerc(this.GetFieldPtr("ProcessingAttendancePerc"));
			this.Add(fld_ProcessingAttendancePerc, false);
			fld_ProcessingWorkingTime = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("ProcessingWorkingTime"));
			this.Add(fld_ProcessingWorkingTime, false);
			fld_NoOfProcessingWorkers = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("NoOfProcessingWorkers"));
			this.Add(fld_NoOfProcessingWorkers, false);
			fld_SetupTeam = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("SetupTeam"));
			this.Add(fld_SetupTeam, false);
			...
			fld_SetupAttendancePerc = new Microarea.Framework.TBApplicationWrapper.MDataPerc(this.GetFieldPtr("SetupAttendancePerc"));
			this.Add(fld_SetupAttendancePerc, false);
			fld_SetupWorkingTime = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("SetupWorkingTime"));
			this.Add(fld_SetupWorkingTime, false);
			fld_NoOfSetupWorkers = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("NoOfSetupWorkers"));
			this.Add(fld_NoOfSetupWorkers, false);
			...
			fld_HourlyCost = new Microarea.Framework.TBApplicationWrapper.MDataMon(this.GetFieldPtr("HourlyCost"));
			this.Add(fld_HourlyCost, false);
			fld_UnitCost = new Microarea.Framework.TBApplicationWrapper.MDataMon(this.GetFieldPtr("UnitCost"));
			this.Add(fld_UnitCost, false);
			fld_AdditionalCost = new Microarea.Framework.TBApplicationWrapper.MDataMon(this.GetFieldPtr("AdditionalCost"));
			this.Add(fld_AdditionalCost, false);
			fld_CostsOnQty = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("CostsOnQty"));
			this.Add(fld_CostsOnQty, false);
			...
			this.AddLocalField("LocalField1", "integer", 4);
			fld_LocalField1 = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("LocalField1"));
			this.Add(fld_LocalField1, false);
		}
		...
		public override void ClearComponents()
		{
			...
			fld_OperationDescriptionFile = null;
			fld_Notes = null;
			fld_Item = null;
			fld_ProcessingTeam = null;
			fld_ProcessingTime = null;
			fld_ProcessingAttendancePerc = null;
			fld_ProcessingWorkingTime = null;
			fld_NoOfProcessingWorkers = null;
			fld_SetupTeam = null;
			fld_SetupTime = null;
			fld_SetupAttendancePerc = null;
			fld_SetupWorkingTime = null;
			fld_NoOfSetupWorkers = null;
			fld_QueueTime = null;
			fld_HourlyCost = null;
			fld_UnitCost = null;
			fld_AdditionalCost = null;
			fld_CostsOnQty = null;
			fld_TotalTime = null;
			fld_IsWC = null;
			fld_TBCreated = null;
