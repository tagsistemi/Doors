...
{
	public class TileMTileDialog2 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialog2(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public BEDBTDOORSTabellaPannelliAp ctrl_DBTDOORSTabellaPannelliAp;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSTabellaPannelliAp = new BEDBTDOORSTabellaPannelliAp(this, "DBTDOORSTabellaPannelliAp", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTDOORSTabellaPannelliAp.DataBinding = new DBTDataBinding(Document.DBTDOORSTabellaPannelliAp);
			ctrl_DBTDOORSTabellaPannelliAp.AddChangedProperty("DataBinding");
			ctrl_DBTDOORSTabellaPannelliAp.AutoFill = true;
			ctrl_DBTDOORSTabellaPannelliAp.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSTabellaPannelliAp.RightStretch = false;
			ctrl_DBTDOORSTabellaPannelliAp.AddChangedProperty("RightStretch");
			ctrl_DBTDOORSTabellaPannelliAp.BottomStretch = false;
			ctrl_DBTDOORSTabellaPannelliAp.AddChangedProperty("BottomStretch");
			ctrl_DBTDOORSTabellaPannelliAp.Size = new System.Drawing.Size(574, 120);
			ctrl_DBTDOORSTabellaPannelliAp.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSTabellaPannelliAp, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSTabellaPannelliAp, "ctrl_DBTDOORSTabellaPannelliAp");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSTabellaPannelliAp = null;
		}
	}
}
