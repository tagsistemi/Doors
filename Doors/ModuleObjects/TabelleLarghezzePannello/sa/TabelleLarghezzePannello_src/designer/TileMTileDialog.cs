...
namespace Customization.Doors.Doors.DynamicDocuments.TabelleLarghezzePannello.TabelleLarghezzePannello
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MParsedEdit ctrl_Finitura;

		public MParsedEdit ctrl_Battuta;

		public override void CreateComponents()
		{
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Descrizione", "StringStatic", new System.Drawing.Point(317, 45), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.HKLDOORSFiniture.TTAG_DOORS_Finiture.fld_Descrizione, Document.HKLDOORSFiniture);
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Border = true;
			ctrl_Descrizione.AddChangedProperty("Border");
			ctrl_Descrizione.Size = new System.Drawing.Size(228, 23);
			ctrl_Descrizione.AddChangedProperty("Size");
			this.Add(ctrl_Descrizione, true);
			ctrl_Descrizione1 = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Descrizione1", "StringStatic", new System.Drawing.Point(316, 82), false);
			...
			ctrl_Descrizione1.Size = new System.Drawing.Size(229, 23);
			...
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(2, 24), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 107);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Finitura = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Finitura", "StringEdit", new System.Drawing.Point(177, 45), false);
			ctrl_Finitura.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliTesta.TTAG_DOORS_TabellaPannelliTesta.fld_Finitura, Document.DBTDOORSTabellaPannelliTesta);
			ctrl_Finitura.AddChangedProperty("DataBinding");
			ctrl_Finitura.AddChangedProperty("Caption");
			ctrl_Finitura.HotLink = Document.HKLDOORSFiniture;
			ctrl_Finitura.AddChangedProperty("HotLink");
			ctrl_Finitura.Size = new System.Drawing.Size(98, 23);
			ctrl_Finitura.AddChangedProperty("Size");
			this.Add(ctrl_Finitura, true);
			ctrl_Battuta = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Battuta", "StringEdit", new System.Drawing.Point(177, 82), false);
			ctrl_Battuta.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliTesta.TTAG_DOORS_TabellaPannelliTesta.fld_Battuta, Document.DBTDOORSTabellaPannelliTesta);
			ctrl_Battuta.AddChangedProperty("DataBinding");
			ctrl_Battuta.AddChangedProperty("Caption");
			ctrl_Battuta.HotLink = Document.HKLDOORSBattute;
			ctrl_Battuta.AddChangedProperty("HotLink");
			ctrl_Battuta.Size = new System.Drawing.Size(98, 23);
			ctrl_Battuta.AddChangedProperty("Size");
			this.Add(ctrl_Battuta, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_Finitura, "ctrl_Finitura");
			resources.ApplyResources(ctrl_Battuta, "ctrl_Battuta");
		}
