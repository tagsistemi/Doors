...
namespace Customization.Doors.Doors.DynamicDocuments.TabelleLarghezzePannello.TabelleLarghezzePannello
{
	public class TileMTileDialog1 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public BEDBTDOORSTabellaPannelliR ctrl_DBTDOORSTabellaPannelliR;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSTabellaPannelliR = new BEDBTDOORSTabellaPannelliR(this, "DBTDOORSTabellaPannelliR", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTDOORSTabellaPannelliR.DataBinding = new DBTDataBinding(Document.DBTDOORSTabellaPannelliR);
			ctrl_DBTDOORSTabellaPannelliR.AddChangedProperty("DataBinding");
			ctrl_DBTDOORSTabellaPannelliR.AutoFill = true;
			ctrl_DBTDOORSTabellaPannelliR.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSTabellaPannelliR.Size = new System.Drawing.Size(574, 177);
			ctrl_DBTDOORSTabellaPannelliR.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSTabellaPannelliR, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSTabellaPannelliR, "ctrl_DBTDOORSTabellaPannelliR");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSTabellaPannelliR = null;
		}
	}
}
