...
{
	public class DBTDOORSTabellaPannelliTesta : MDBTMaster
	{
		public DBTDOORSTabellaPannelliTesta() : base("TAG_DOORS_TabellaPannelliTesta", "DOORSTabellaPannelliTesta", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSTabellaPannelliTesta(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_TabellaPannelliTesta;
			}
		}

		public TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta TTAG_DOORS_TabellaPannelliTesta;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_TabellaPannelliTesta;
			}
		}

		public TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta OldTTAG_DOORS_TabellaPannelliTesta;

		public virtual TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSTabellaPannelliTesta(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_TabellaPannelliTesta = new TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta(this.GetRecordPtr());
			this.Add(TTAG_DOORS_TabellaPannelliTesta, true);
			OldTTAG_DOORS_TabellaPannelliTesta = new TDBTDOORSTabellaPannelliTesta_TAG_DOORS_TabellaPannelliTesta(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_TabellaPannelliTesta, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_TabellaPannelliTesta = null;
			OldTTAG_DOORS_TabellaPannelliTesta = null;
		}
	}
}
