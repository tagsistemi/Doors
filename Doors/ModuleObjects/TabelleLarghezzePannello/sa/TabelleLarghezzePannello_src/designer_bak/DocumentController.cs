...
namespace Customization.Doors.Doors.DynamicDocuments.TabelleLarghezzePannello.TabelleLarghezzePannello
{
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDTabelleLarghezzePannello Document
		{
			get
			{
				return (MDTabelleLarghezzePannello)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_TabelleLarghezzePannello = new MDTabelleLarghezzePannello(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_TabelleLarghezzePannello;
		...
		public MDTabelleLarghezzePannello document_TabelleLarghezzePannello;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_TabelleLarghezzePannello, true);
		...
		public override void ClearComponents()
		{
			...
			oldController = null;
			document_TabelleLarghezzePannello = null;
			view_Dynamic = null;
		}
	}
}
