...
{
	public class TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataStr fld_DescrizioneAp;
		...
		public override void CreateComponents()
		{
			...
			this.AddLocalField("DescrizioneAp", "string", 50);
			fld_DescrizioneAp = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("DescrizioneAp"));
			this.Add(fld_DescrizioneAp, false);
		}
