...
{
	public class DBTDOORSTabellaPannelliAp : MDBTSlaveBuffered
	{
		public DBTDOORSTabellaPannelliAp() : base("TAG_DOORS_TabellaPannelliAp", "DOORSTabellaPannelliAp", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSTabellaPannelliAp(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_TabellaPannelliAp;
			}
		}

		public TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp TTAG_DOORS_TabellaPannelliAp;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_TabellaPannelliAp;
			}
		}

		public TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp OldTTAG_DOORS_TabellaPannelliAp;

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSTabellaPannelliAp(dbtPtr);
		}

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp GetCurrentRow()
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp AddRow()
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)this.AddRecord();
		}

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp InsertRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp GetRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp GetOldRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_TabellaPannelliAp = new TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp(this.GetRecordPtr());
			this.Add(TTAG_DOORS_TabellaPannelliAp, true);
			OldTTAG_DOORS_TabellaPannelliAp = new TDBTDOORSTabellaPannelliAp_TAG_DOORS_TabellaPannelliAp(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_TabellaPannelliAp, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_TabellaPannelliAp = null;
			OldTTAG_DOORS_TabellaPannelliAp = null;
		}
	}
}
