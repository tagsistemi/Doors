...
{
	public class TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataStr fld_Finitura;

		public MDataStr fld_Battuta;

		public MDataDbl fld_DaCm;

		public MDataDbl fld_ACm;

		public MDataDbl fld_CmInternoBattutaPannello;

		public MDataBool fld_IsStandard;

		public MDataEnum fld_Dimensione;

		public MDataStr fld_Operation1;

		public MDataStr fld_Operation2;

		public MDataStr fld_Operation3;

		public MDataStr fld_BattutaComponente;
		...
		public override void CreateComponents()
		{
			...
			fld_Finitura = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Finitura"));
			this.Add(fld_Finitura, false);
			fld_Battuta = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Battuta"));
			this.Add(fld_Battuta, false);
			fld_DaCm = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DaCm"));
			this.Add(fld_DaCm, false);
			fld_ACm = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("ACm"));
			this.Add(fld_ACm, false);
			fld_CmInternoBattutaPannello = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("CmInternoBattutaPannello"));
			this.Add(fld_CmInternoBattutaPannello, false);
			fld_IsStandard = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("IsStandard"));
			this.Add(fld_IsStandard, false);
			...
			fld_Operation1 = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Operation1"));
			this.Add(fld_Operation1, false);
			fld_Operation2 = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Operation2"));
			this.Add(fld_Operation2, false);
			fld_Operation3 = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Operation3"));
			this.Add(fld_Operation3, false);
			fld_BattutaComponente = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("BattutaComponente"));
			this.Add(fld_BattutaComponente, false);
		}
		...
		public override void ClearComponents()
		{
			...
			fld_DaCm = null;
			fld_ACm = null;
			fld_CmInternoBattutaPannello = null;
			fld_IsStandard = null;
			fld_Dimensione = null;
			fld_Operation1 = null;
			fld_Operation2 = null;
			fld_Operation3 = null;
			fld_BattutaComponente = null;
		}
	}
}
