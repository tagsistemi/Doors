...
{
	public class BEDBTDOORSTabellaPannelliAp : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSTabellaPannelliAp(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MBodyEditColumn col_DescrizioneAp;
		...
		public override void CreateComponents()
		{
			...
			col_Finitura.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_Finitura, Document.DBTDOORSTabellaPannelliAp);
			...
			col_Battuta.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_Battuta, Document.DBTDOORSTabellaPannelliAp);
			...
			col_Apertura.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_Apertura, Document.DBTDOORSTabellaPannelliAp);
			col_Apertura.ColPos = 2;
			...
			col_DescrizioneAp = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "DescrizioneAp", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_DescrizioneAp.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaPannelliAp.TTAG_DOORS_TabellaPannelliAp.fld_DescrizioneAp, Document.DBTDOORSTabellaPannelliAp);
			col_DescrizioneAp.AddChangedProperty("DataBinding");
			col_DescrizioneAp.ColPos = 3;
			col_DescrizioneAp.AddChangedProperty("ColPos");
			col_DescrizioneAp.SizeInChars = new System.Drawing.Size(50, 1);
			col_DescrizioneAp.AddChangedProperty("SizeInChars");
			col_DescrizioneAp.TitleTextColor = System.Drawing.Color.Black;
			col_DescrizioneAp.AddChangedProperty("TitleTextColor");
			col_DescrizioneAp.TitleBackColor = System.Drawing.Color.Transparent;
			col_DescrizioneAp.AddChangedProperty("TitleBackColor");
			col_DescrizioneAp.Visible = true;
			col_DescrizioneAp.AddChangedProperty("Visible");
			col_DescrizioneAp.AddChangedProperty("ColumnTitle");
			this.Add(col_DescrizioneAp, false);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(col_DescrizioneAp, "col_DescrizioneAp");
		}
