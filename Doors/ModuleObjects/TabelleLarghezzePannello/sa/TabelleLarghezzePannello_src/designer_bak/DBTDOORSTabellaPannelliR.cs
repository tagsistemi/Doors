...
{
	public class DBTDOORSTabellaPannelliR : MDBTSlaveBuffered
	{
		public DBTDOORSTabellaPannelliR() : base("TAG_DOORS_TabellaPannelliR", "DOORSTabellaPannelliR", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSTabellaPannelliR(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_TabellaPannelliR;
			}
		}

		public TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR TTAG_DOORS_TabellaPannelliR;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_TabellaPannelliR;
			}
		}

		public TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR OldTTAG_DOORS_TabellaPannelliR;

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSTabellaPannelliR(dbtPtr);
		}

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR GetCurrentRow()
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR AddRow()
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)this.AddRecord();
		}

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR InsertRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR GetRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR GetOldRow(int rowNumber)
		{
			return (TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_TabellaPannelliR = new TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR(this.GetRecordPtr());
			this.Add(TTAG_DOORS_TabellaPannelliR, true);
			OldTTAG_DOORS_TabellaPannelliR = new TDBTDOORSTabellaPannelliR_TAG_DOORS_TabellaPannelliR(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_TabellaPannelliR, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_TabellaPannelliR = null;
			OldTTAG_DOORS_TabellaPannelliR = null;
		}
	}
}
