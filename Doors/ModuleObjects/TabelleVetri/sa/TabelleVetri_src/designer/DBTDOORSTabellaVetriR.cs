...
using System.Data;
using System;
namespace Customization.Doors.Doors.DynamicDocuments.TabelleVetri.TabelleVetri
{
	public class DBTDOORSTabellaVetriR : MDBTSlaveBuffered
	{
		public DBTDOORSTabellaVetriR() : base("TAG_DOORS_TabellaVetriR", "DOORSTabellaVetriR", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSTabellaVetriR(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_TabellaVetriR;
			}
		}

		public TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR TTAG_DOORS_TabellaVetriR;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_TabellaVetriR;
			}
		}

		public TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR OldTTAG_DOORS_TabellaVetriR;

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSTabellaVetriR(dbtPtr);
		}

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR GetCurrentRow()
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR AddRow()
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)this.AddRecord();
		}

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR InsertRow(int rowNumber)
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR GetRow(int rowNumber)
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR GetOldRow(int rowNumber)
		{
			return (TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_TabellaVetriR = new TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR(this.GetRecordPtr());
			this.Add(TTAG_DOORS_TabellaVetriR, true);
			OldTTAG_DOORS_TabellaVetriR = new TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_TabellaVetriR, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_TabellaVetriR = null;
			OldTTAG_DOORS_TabellaVetriR = null;
		}
	}
}
