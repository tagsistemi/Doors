...
namespace Customization.Doors.Doors.DynamicDocuments.TabelleVetri.TabelleVetri
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		{
			ctrl_Description = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Description", "StringStatic", new System.Drawing.Point(179, 81), false);
			ctrl_Description.DataBinding = new FieldDataBinding(Document.HKLItems.TMA_Items.fld_Description, Document.HKLItems);
			ctrl_Description.AddChangedProperty("DataBinding");
			ctrl_Description.AddChangedProperty("Caption");
			ctrl_Description.Border = true;
			ctrl_Description.AddChangedProperty("Border");
			ctrl_Description.Size = new System.Drawing.Size(359, 23);
			...
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(2, 23), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 170);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Item = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Item", "StringEdit", new System.Drawing.Point(177, 42), false);
			ctrl_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetri.TTAG_DOORS_TabellaVetri.fld_Item, Document.DBTDOORSTabellaVetri);
