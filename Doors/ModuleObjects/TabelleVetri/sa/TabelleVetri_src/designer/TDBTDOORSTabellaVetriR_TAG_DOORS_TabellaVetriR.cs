...
{
	public class TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSTabellaVetriR_TAG_DOORS_TabellaVetriR(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataDbl fld_LET;

		public MDataDbl fld_HET;

		public MDataQty fld_Qty;

		public MDataDbl fld_LVT;

		public MDataDbl fld_HVT;

		public MDataDbl fld_PVT;

		public MDataStr fld_CategoriaVt;

		public MDataEnum fld_Tipologia;
		...
		public override void CreateComponents()
		{
			...
			fld_LET = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LET"));
			this.Add(fld_LET, false);
			fld_HET = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("HET"));
			this.Add(fld_HET, false);
			fld_Qty = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("Qty"));
			this.Add(fld_Qty, false);
			fld_LVT = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LVT"));
			this.Add(fld_LVT, false);
			fld_HVT = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("HVT"));
			this.Add(fld_HVT, false);
			fld_PVT = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("PVT"));
			this.Add(fld_PVT, false);
			fld_CategoriaVt = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CategoriaVt"));
			this.Add(fld_CategoriaVt, false);
			fld_Tipologia = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("Tipologia"));
			this.Add(fld_Tipologia, false);
		}
