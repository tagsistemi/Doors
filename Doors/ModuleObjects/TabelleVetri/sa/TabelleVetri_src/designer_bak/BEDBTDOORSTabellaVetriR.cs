...
{
	public class BEDBTDOORSTabellaVetriR : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSTabellaVetriR(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}

		[Microarea.TaskBuilderNet.Core.EasyBuilder.PreserveFieldAttribute]
		public new MDTabelleVetri Document
		{
			get
			{
				return (MDTabelleVetri)DocumentController.controller.Document;
			}
		}

		public MBodyEditColumn col_Item;

		public MBodyEditColumn col_LET;

		public MBodyEditColumn col_HET;

		public MBodyEditColumn col_Qty;

		public MBodyEditColumn col_LVT;

		public MBodyEditColumn col_HVT;

		public MBodyEditColumn col_PVT;

		public MBodyEditColumn col_CategoriaVt;

		public MBodyEditColumn col_Tipologia;
		...
		public override void CreateComponents()
		{
			...
			col_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_Item, Document.DBTDOORSTabellaVetriR);
			col_Item.AddChangedProperty("DataBinding");
			col_Item.ColPos = 0;
			...
			col_LET = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "LET", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_LET.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_LET, Document.DBTDOORSTabellaVetriR);
			col_LET.AddChangedProperty("DataBinding");
			col_LET.ColPos = 1;
			col_LET.AddChangedProperty("ColPos");
			col_LET.SizeInChars = new System.Drawing.Size(1, 1);
			col_LET.AddChangedProperty("SizeInChars");
			col_LET.TitleTextColor = System.Drawing.Color.Black;
			col_LET.AddChangedProperty("TitleTextColor");
			col_LET.TitleBackColor = System.Drawing.Color.Transparent;
			col_LET.AddChangedProperty("TitleBackColor");
			col_LET.Visible = true;
			col_LET.AddChangedProperty("Visible");
			col_LET.AddChangedProperty("ColumnTitle");
			this.Add(col_LET, false);
			col_HET = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "HET", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_HET.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_HET, Document.DBTDOORSTabellaVetriR);
			col_HET.AddChangedProperty("DataBinding");
			col_HET.ColPos = 2;
			col_HET.AddChangedProperty("ColPos");
			col_HET.SizeInChars = new System.Drawing.Size(1, 1);
			col_HET.AddChangedProperty("SizeInChars");
			col_HET.TitleTextColor = System.Drawing.Color.Black;
			col_HET.AddChangedProperty("TitleTextColor");
			col_HET.TitleBackColor = System.Drawing.Color.Transparent;
			col_HET.AddChangedProperty("TitleBackColor");
			col_HET.Visible = true;
			col_HET.AddChangedProperty("Visible");
			col_HET.AddChangedProperty("ColumnTitle");
			this.Add(col_HET, false);
			...
			col_Qty.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_Qty, Document.DBTDOORSTabellaVetriR);
			col_Qty.AddChangedProperty("DataBinding");
			col_Qty.ColPos = 3;
			...
			col_LVT = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "LVT", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_LVT.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_LVT, Document.DBTDOORSTabellaVetriR);
			col_LVT.AddChangedProperty("DataBinding");
			col_LVT.ColPos = 4;
			col_LVT.AddChangedProperty("ColPos");
			col_LVT.SizeInChars = new System.Drawing.Size(1, 1);
			col_LVT.AddChangedProperty("SizeInChars");
			col_LVT.TitleTextColor = System.Drawing.Color.Black;
			col_LVT.AddChangedProperty("TitleTextColor");
			col_LVT.TitleBackColor = System.Drawing.Color.Transparent;
			col_LVT.AddChangedProperty("TitleBackColor");
			col_LVT.Visible = true;
			col_LVT.AddChangedProperty("Visible");
			col_LVT.AddChangedProperty("ColumnTitle");
			this.Add(col_LVT, false);
			col_HVT = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "HVT", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_HVT.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_HVT, Document.DBTDOORSTabellaVetriR);
			col_HVT.AddChangedProperty("DataBinding");
			col_HVT.ColPos = 5;
			col_HVT.AddChangedProperty("ColPos");
			col_HVT.SizeInChars = new System.Drawing.Size(1, 1);
			col_HVT.AddChangedProperty("SizeInChars");
			col_HVT.TitleTextColor = System.Drawing.Color.Black;
			col_HVT.AddChangedProperty("TitleTextColor");
			col_HVT.TitleBackColor = System.Drawing.Color.Transparent;
			col_HVT.AddChangedProperty("TitleBackColor");
			col_HVT.Visible = true;
			col_HVT.AddChangedProperty("Visible");
			col_HVT.AddChangedProperty("ColumnTitle");
			this.Add(col_HVT, false);
			col_PVT = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "PVT", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_PVT.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_PVT, Document.DBTDOORSTabellaVetriR);
			col_PVT.AddChangedProperty("DataBinding");
			col_PVT.ColPos = 6;
			col_PVT.AddChangedProperty("ColPos");
			col_PVT.SizeInChars = new System.Drawing.Size(1, 1);
			col_PVT.AddChangedProperty("SizeInChars");
			col_PVT.TitleTextColor = System.Drawing.Color.Black;
			col_PVT.AddChangedProperty("TitleTextColor");
			col_PVT.TitleBackColor = System.Drawing.Color.Transparent;
			col_PVT.AddChangedProperty("TitleBackColor");
			col_PVT.Visible = true;
			col_PVT.AddChangedProperty("Visible");
			col_PVT.AddChangedProperty("ColumnTitle");
			this.Add(col_PVT, false);
			col_CategoriaVt = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "CategoriaVt", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_CategoriaVt.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_CategoriaVt, Document.DBTDOORSTabellaVetriR);
			col_CategoriaVt.AddChangedProperty("DataBinding");
			col_CategoriaVt.ColPos = 7;
			col_CategoriaVt.AddChangedProperty("ColPos");
			col_CategoriaVt.SizeInChars = new System.Drawing.Size(8, 1);
			col_CategoriaVt.AddChangedProperty("SizeInChars");
			col_CategoriaVt.TitleTextColor = System.Drawing.Color.Black;
			col_CategoriaVt.AddChangedProperty("TitleTextColor");
			col_CategoriaVt.TitleBackColor = System.Drawing.Color.Transparent;
			col_CategoriaVt.AddChangedProperty("TitleBackColor");
			col_CategoriaVt.Visible = false;
			col_CategoriaVt.AddChangedProperty("Visible");
			col_CategoriaVt.AddChangedProperty("ColumnTitle");
			this.Add(col_CategoriaVt, false);
			col_Tipologia = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "Tipologia", "EnumCombo", new System.Drawing.Point(0, 0), false);
			col_Tipologia.DataBinding = new FieldDataBinding(Document.DBTDOORSTabellaVetriR.TTAG_DOORS_TabellaVetriR.fld_Tipologia, Document.DBTDOORSTabellaVetriR);
			col_Tipologia.ColPos = 8;
			col_Tipologia.AddChangedProperty("ColPos");
			col_Tipologia.SizeInChars = new System.Drawing.Size(1, 1);
			col_Tipologia.AddChangedProperty("SizeInChars");
			col_Tipologia.TitleTextColor = System.Drawing.Color.Black;
			col_Tipologia.AddChangedProperty("TitleTextColor");
			col_Tipologia.TitleBackColor = System.Drawing.Color.Transparent;
			col_Tipologia.AddChangedProperty("TitleBackColor");
			col_Tipologia.Visible = true;
			col_Tipologia.AddChangedProperty("Visible");
			col_Tipologia.AddChangedProperty("ColumnTitle");
			this.Add(col_Tipologia, false);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(col_LET, "col_LET");
			resources.ApplyResources(col_HET, "col_HET");
			resources.ApplyResources(col_Qty, "col_Qty");
			resources.ApplyResources(col_LVT, "col_LVT");
			resources.ApplyResources(col_HVT, "col_HVT");
			resources.ApplyResources(col_PVT, "col_PVT");
			resources.ApplyResources(col_CategoriaVt, "col_CategoriaVt");
			resources.ApplyResources(col_Tipologia, "col_Tipologia");
		}
