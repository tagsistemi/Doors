...
{
	public class BEMBEMagg : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEMBEMagg(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public override void CreateComponents()
		{
			...
			col_TipoMaggiorazione.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_TipoMaggiorazione, Document.DBTDOORSConfigMagg);
			col_TipoMaggiorazione.AddChangedProperty("DataBinding");
			col_TipoMaggiorazione.ColPos = 0;
			...
			this.Add(col_TipoMaggiorazione, false);
			...
			col_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_Item, Document.DBTDOORSConfigMagg);
			...
			col_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_Descrizione, Document.DBTDOORSConfigMagg);
			col_Descrizione.AddChangedProperty("DataBinding");
			col_Descrizione.ColPos = 2;
			...
			col_Importo.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_Importo, Document.DBTDOORSConfigMagg);
			col_Importo.AddChangedProperty("DataBinding");
			col_Importo.ColPos = 3;
			...
			col_Dimensione.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_Dimensione, Document.DBTDOORSConfigMagg);
			col_Dimensione.AddChangedProperty("DataBinding");
			col_Dimensione.ColPos = 4;
			...
			col_Apertura.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigMagg.TTAG_DOORS_ConfigMagg.fld_Apertura, Document.DBTDOORSConfigMagg);
			col_Apertura.AddChangedProperty("DataBinding");
			col_Apertura.ColPos = 5;
