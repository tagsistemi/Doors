...
{
	public class BEDBTDOORSConfigVetri : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSConfigVetri(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public override void CreateComponents()
		{
			...
			col_IdGuid.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigVetri.TTAG_DOORS_ConfigVetri.fld_IdGuid, Document.DBTDOORSConfigVetri);
			col_IdGuid.AddChangedProperty("DataBinding");
			col_IdGuid.ColPos = 0;
			...
			col_Line.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigVetri.TTAG_DOORS_ConfigVetri.fld_Line, Document.DBTDOORSConfigVetri);
			col_Line.AddChangedProperty("DataBinding");
			col_Line.ColPos = 1;
			...
			col_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigVetri.TTAG_DOORS_ConfigVetri.fld_Item, Document.DBTDOORSConfigVetri);
			...
			col_Description = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "Description", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_Description.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigVetri.TTAG_DOORS_ConfigVetri.fld_Description, Document.DBTDOORSConfigVetri);
			col_Description.AddChangedProperty("DataBinding");
			col_Description.ColPos = 3;
			col_Description.AddChangedProperty("ColPos");
			col_Description.SizeInChars = new System.Drawing.Size(150, 1);
			col_Description.AddChangedProperty("SizeInChars");
			col_Description.TitleTextColor = System.Drawing.Color.Black;
			col_Description.AddChangedProperty("TitleTextColor");
			col_Description.TitleBackColor = System.Drawing.Color.Transparent;
			col_Description.AddChangedProperty("TitleBackColor");
			col_Description.Visible = true;
			col_Description.AddChangedProperty("Visible");
			col_Description.AddChangedProperty("ColumnTitle");
			this.Add(col_Description, false);
			...
			col_Qty.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigVetri.TTAG_DOORS_ConfigVetri.fld_Qty, Document.DBTDOORSConfigVetri);
