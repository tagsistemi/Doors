...
{
	public class TileMTileDialogTestaConf : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialogTestaConf(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MParsedEdit ctrl_IdGuid;

		public MParsedEdit ctrl_SaleOrdId;

		public MParsedEdit ctrl_PositionSaleOrd;

		public MParsedEdit ctrl_RootItem;

		public MParsedEdit ctrl_VarianteRoot;

		public MCheckBox ctrl_VarianteStandard;

		public MParsedEdit ctrl_DescRootVar;

		public MPushButton ctrl_MPushButton;

		public MCheckBox ctrl_OkEdit;

		public override void CreateComponents()
		{
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(0, 25), new System.Drawing.Point(0, 0), false);
			this.Add(ctrl_IDC_STATIC_AREA, false);
			ctrl_IdGuid = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "IdGuid", "StringEdit", new System.Drawing.Point(177, 56), false);
			ctrl_IdGuid.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_IdGuid, Document.DBTDOORSConfigurazioni);
			ctrl_IdGuid.AddChangedProperty("DataBinding");
			ctrl_IdGuid.AddChangedProperty("Caption");
			ctrl_IdGuid.Size = new System.Drawing.Size(175, 23);
			ctrl_IdGuid.AddChangedProperty("Size");
			this.Add(ctrl_IdGuid, true);
			ctrl_SaleOrdId = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "SaleOrdId", "LongEdit", new System.Drawing.Point(177, 91), false);
			ctrl_SaleOrdId.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_SaleOrdId, Document.DBTDOORSConfigurazioni);
			ctrl_SaleOrdId.AddChangedProperty("DataBinding");
			ctrl_SaleOrdId.AddChangedProperty("Caption");
			ctrl_SaleOrdId.Size = new System.Drawing.Size(175, 23);
			ctrl_SaleOrdId.AddChangedProperty("Size");
			this.Add(ctrl_SaleOrdId, true);
			ctrl_PositionSaleOrd = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "PositionSaleOrd", "IntegerEdit", new System.Drawing.Point(177, 128), false);
			ctrl_PositionSaleOrd.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_PositionSaleOrd, Document.DBTDOORSConfigurazioni);
			ctrl_PositionSaleOrd.AddChangedProperty("DataBinding");
			ctrl_PositionSaleOrd.AddChangedProperty("Caption");
			ctrl_PositionSaleOrd.Size = new System.Drawing.Size(175, 23);
			ctrl_PositionSaleOrd.AddChangedProperty("Size");
			this.Add(ctrl_PositionSaleOrd, true);
			ctrl_RootItem = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "RootItem", "StringEdit", new System.Drawing.Point(177, 165), false);
			ctrl_RootItem.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_RootItem, Document.DBTDOORSConfigurazioni);
			ctrl_RootItem.AddChangedProperty("DataBinding");
			ctrl_RootItem.AddChangedProperty("Caption");
			ctrl_RootItem.Size = new System.Drawing.Size(175, 23);
			ctrl_RootItem.AddChangedProperty("Size");
			this.Add(ctrl_RootItem, true);
			ctrl_VarianteRoot = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "VarianteRoot", "StringEdit", new System.Drawing.Point(477, 94), false);
			ctrl_VarianteRoot.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_VarianteRoot, Document.DBTDOORSConfigurazioni);
			ctrl_VarianteRoot.AddChangedProperty("DataBinding");
			ctrl_VarianteRoot.AddChangedProperty("Caption");
			ctrl_VarianteRoot.HotLink = Document.HKLVariants;
			ctrl_VarianteRoot.AddChangedProperty("HotLink");
			ctrl_VarianteRoot.Size = new System.Drawing.Size(156, 23);
			ctrl_VarianteRoot.AddChangedProperty("Size");
			this.Add(ctrl_VarianteRoot, true);
			ctrl_VarianteStandard = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "VarianteStandard", "CheckBox", new System.Drawing.Point(477, 56), false);
			ctrl_VarianteStandard.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_VarianteStandard, Document.DBTDOORSConfigurazioni);
			ctrl_VarianteStandard.AddChangedProperty("DataBinding");
			ctrl_VarianteStandard.Size = new System.Drawing.Size(175, 23);
			ctrl_VarianteStandard.AddChangedProperty("Size");
			this.Add(ctrl_VarianteStandard, true);
			ctrl_DescRootVar = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "DescRootVar", "MultilineStringEdit", new System.Drawing.Point(477, 128), false);
			ctrl_DescRootVar.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_DescRootVar, Document.DBTDOORSConfigurazioni);
			ctrl_DescRootVar.AddChangedProperty("DataBinding");
			ctrl_DescRootVar.AddChangedProperty("Caption");
			ctrl_DescRootVar.Size = new System.Drawing.Size(438, 67);
			ctrl_DescRootVar.AddChangedProperty("Size");
			this.Add(ctrl_DescRootVar, true);
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(475, 232), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Visible = true;
			ctrl_MPushButton.AddChangedProperty("Visible");
			ctrl_MPushButton.Size = new System.Drawing.Size(440, 23);
			ctrl_MPushButton.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton, true);
			ctrl_MPushButton.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_MTileDialogTestaConf_ctrl_MPushButton_Click);
			ctrl_MPushButton.AddChangedEvent(new EventInfo("ctrl_MPushButton.Click", "tile_MTileDialogTestaConf_ctrl_MPushButton_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Dynamic.tileGroup_MTileGroup.tile_MTileDialogTestaConf.ctrl_MPushButton", true));
			ctrl_OkEdit = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "OkEdit", "CheckBox", new System.Drawing.Point(289, 232), false);
			ctrl_OkEdit.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_OkEdit, Document.DBTDOORSConfigurazioni);
			ctrl_OkEdit.AddChangedProperty("Text");
			ctrl_OkEdit.Visible = true;
			ctrl_OkEdit.AddChangedProperty("Visible");
			ctrl_OkEdit.Size = new System.Drawing.Size(175, 23);
			ctrl_OkEdit.AddChangedProperty("Size");
			this.Add(ctrl_OkEdit, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_IdGuid, "ctrl_IdGuid");
			resources.ApplyResources(ctrl_SaleOrdId, "ctrl_SaleOrdId");
			resources.ApplyResources(ctrl_PositionSaleOrd, "ctrl_PositionSaleOrd");
			resources.ApplyResources(ctrl_RootItem, "ctrl_RootItem");
			resources.ApplyResources(ctrl_VarianteRoot, "ctrl_VarianteRoot");
			resources.ApplyResources(ctrl_VarianteStandard, "ctrl_VarianteStandard");
			resources.ApplyResources(ctrl_DescRootVar, "ctrl_DescRootVar");
			resources.ApplyResources(ctrl_MPushButton, "ctrl_MPushButton");
			resources.ApplyResources(ctrl_OkEdit, "ctrl_OkEdit");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_IdGuid = null;
			ctrl_SaleOrdId = null;
			ctrl_PositionSaleOrd = null;
			ctrl_RootItem = null;
			ctrl_VarianteRoot = null;
			ctrl_VarianteStandard = null;
			ctrl_DescRootVar = null;
			ctrl_MPushButton = null;
			ctrl_OkEdit = null;
		}
	}
}
