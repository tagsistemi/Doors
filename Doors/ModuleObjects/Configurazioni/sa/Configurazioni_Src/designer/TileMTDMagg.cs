...
{
	public class TileMTDMagg : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTDMagg(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public BEMBEMagg ctrl_MBEMagg;

		public override void CreateComponents()
		{
			ctrl_MBEMagg = new BEMBEMagg(this, "MBEMagg", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_MBEMagg.DataBinding = new DBTDataBinding(Document.DBTDOORSConfigMagg);
			ctrl_MBEMagg.AddChangedProperty("DataBinding");
			ctrl_MBEMagg.AutoFill = true;
			ctrl_MBEMagg.AddChangedProperty("AutoFill");
			ctrl_MBEMagg.RightStretch = false;
			ctrl_MBEMagg.AddChangedProperty("RightStretch");
			ctrl_MBEMagg.BottomStretch = false;
			ctrl_MBEMagg.AddChangedProperty("BottomStretch");
			ctrl_MBEMagg.Size = new System.Drawing.Size(574, 120);
			ctrl_MBEMagg.AddChangedProperty("Size");
			this.Add(ctrl_MBEMagg, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_MBEMagg, "ctrl_MBEMagg");
		}
