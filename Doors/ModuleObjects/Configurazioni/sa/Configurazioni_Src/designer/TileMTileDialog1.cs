...
namespace Customization.Doors.Doors.DynamicDocuments.Configurazioni.Configurazioni
{
	public class TileMTileDialog1 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MParsedEdit ctrl_Altezza;

		public MParsedEdit ctrl_Larghezza;

		public MParsedEdit ctrl_SpessoreMuro;

		public MParsedEdit ctrl_SpessoreTelaio;

		public MParsedEdit ctrl_NoteConfText;

		public MParsedEdit ctrl_LIntBattuta;

		public MParsedEdit ctrl_HIntBattuta;

		public MParsedEdit ctrl_AriaH;

		public MParsedEdit ctrl_AriaL;

		public override void CreateComponents()
		{
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(4, 23), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 333);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Altezza = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Altezza", "DoubleEdit", new System.Drawing.Point(181, 44), false);
			ctrl_Altezza.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_Altezza, Document.DBTDOORSConfigurazioni);
			ctrl_Altezza.AddChangedProperty("DataBinding");
			ctrl_Altezza.AddChangedProperty("Caption");
			ctrl_Altezza.Size = new System.Drawing.Size(175, 23);
			ctrl_Altezza.AddChangedProperty("Size");
			this.Add(ctrl_Altezza, true);
			ctrl_Larghezza = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Larghezza", "DoubleEdit", new System.Drawing.Point(181, 73), false);
			ctrl_Larghezza.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_Larghezza, Document.DBTDOORSConfigurazioni);
			ctrl_Larghezza.AddChangedProperty("DataBinding");
			ctrl_Larghezza.AddChangedProperty("Caption");
			ctrl_Larghezza.Size = new System.Drawing.Size(175, 23);
			ctrl_Larghezza.AddChangedProperty("Size");
			this.Add(ctrl_Larghezza, true);
			ctrl_SpessoreMuro = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "SpessoreMuro", "DoubleEdit", new System.Drawing.Point(181, 108), false);
			ctrl_SpessoreMuro.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_SpessoreMuro, Document.DBTDOORSConfigurazioni);
			ctrl_SpessoreMuro.AddChangedProperty("DataBinding");
			ctrl_SpessoreMuro.AddChangedProperty("Caption");
			ctrl_SpessoreMuro.Size = new System.Drawing.Size(175, 23);
			ctrl_SpessoreMuro.AddChangedProperty("Size");
			this.Add(ctrl_SpessoreMuro, true);
			ctrl_SpessoreTelaio = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "SpessoreTelaio", "DoubleEdit", new System.Drawing.Point(181, 137), false);
			ctrl_SpessoreTelaio.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_SpessoreTelaio, Document.DBTDOORSConfigurazioni);
			ctrl_SpessoreTelaio.AddChangedProperty("DataBinding");
			ctrl_SpessoreTelaio.AddChangedProperty("Caption");
			ctrl_SpessoreTelaio.Size = new System.Drawing.Size(175, 23);
			ctrl_SpessoreTelaio.AddChangedProperty("Size");
			this.Add(ctrl_SpessoreTelaio, true);
			ctrl_NoteConfText = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "NoteConfText", "TextEdit", new System.Drawing.Point(181, 286), false);
			ctrl_NoteConfText.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_NoteConfText, Document.DBTDOORSConfigurazioni);
			ctrl_NoteConfText.AddChangedProperty("DataBinding");
			ctrl_NoteConfText.AddChangedProperty("Caption");
			ctrl_NoteConfText.Size = new System.Drawing.Size(366, 75);
			ctrl_NoteConfText.AddChangedProperty("Size");
			this.Add(ctrl_NoteConfText, true);
			ctrl_LIntBattuta = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "LIntBattuta", "DoubleEdit", new System.Drawing.Point(181, 169), false);
			ctrl_LIntBattuta.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_LIntBattuta, Document.DBTDOORSConfigurazioni);
			ctrl_LIntBattuta.AddChangedProperty("Caption");
			ctrl_LIntBattuta.Size = new System.Drawing.Size(175, 23);
			ctrl_LIntBattuta.AddChangedProperty("Size");
			this.Add(ctrl_LIntBattuta, true);
			ctrl_HIntBattuta = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "HIntBattuta", "DoubleEdit", new System.Drawing.Point(181, 198), false);
			ctrl_HIntBattuta.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_HIntBattuta, Document.DBTDOORSConfigurazioni);
			ctrl_HIntBattuta.AddChangedProperty("Caption");
			ctrl_HIntBattuta.Size = new System.Drawing.Size(175, 23);
			ctrl_HIntBattuta.AddChangedProperty("Size");
			this.Add(ctrl_HIntBattuta, true);
			ctrl_AriaH = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "AriaH", "DoubleEdit", new System.Drawing.Point(181, 228), false);
			ctrl_AriaH.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_AriaH, Document.DBTDOORSConfigurazioni);
			ctrl_AriaH.AddChangedProperty("Caption");
			ctrl_AriaH.Size = new System.Drawing.Size(175, 23);
			ctrl_AriaH.AddChangedProperty("Size");
			this.Add(ctrl_AriaH, true);
			ctrl_AriaL = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "AriaL", "DoubleEdit", new System.Drawing.Point(181, 256), false);
			ctrl_AriaL.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_AriaL, Document.DBTDOORSConfigurazioni);
			ctrl_AriaL.AddChangedProperty("Caption");
			ctrl_AriaL.Size = new System.Drawing.Size(175, 23);
			ctrl_AriaL.AddChangedProperty("Size");
			this.Add(ctrl_AriaL, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_Altezza, "ctrl_Altezza");
			resources.ApplyResources(ctrl_Larghezza, "ctrl_Larghezza");
			resources.ApplyResources(ctrl_SpessoreMuro, "ctrl_SpessoreMuro");
			resources.ApplyResources(ctrl_SpessoreTelaio, "ctrl_SpessoreTelaio");
			resources.ApplyResources(ctrl_NoteConfText, "ctrl_NoteConfText");
			resources.ApplyResources(ctrl_LIntBattuta, "ctrl_LIntBattuta");
			resources.ApplyResources(ctrl_HIntBattuta, "ctrl_HIntBattuta");
			resources.ApplyResources(ctrl_AriaH, "ctrl_AriaH");
			resources.ApplyResources(ctrl_AriaL, "ctrl_AriaL");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_Altezza = null;
			ctrl_Larghezza = null;
			ctrl_SpessoreMuro = null;
			ctrl_SpessoreTelaio = null;
			ctrl_NoteConfText = null;
			ctrl_LIntBattuta = null;
			ctrl_HIntBattuta = null;
			ctrl_AriaH = null;
			ctrl_AriaL = null;
		}
	}
