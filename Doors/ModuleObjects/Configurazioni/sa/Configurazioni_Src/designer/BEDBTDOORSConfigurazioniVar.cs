...
{
	public class BEDBTDOORSConfigurazioniVar : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSConfigurazioniVar(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MBodyEditColumn col_CodVariante;
		...
		public override void CreateComponents()
		{
			...
			col_Line.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioniVar.TTAG_DOORS_ConfigurazioniVar.fld_Line, Document.DBTDOORSConfigurazioniVar);
			col_Line.ColPos = 0;
			...
			col_IdGuid.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioniVar.TTAG_DOORS_ConfigurazioniVar.fld_IdGuid, Document.DBTDOORSConfigurazioniVar);
			col_IdGuid.ColPos = 1;
			...
			col_CodVariante = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "CodVariante", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_CodVariante.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioniVar.TTAG_DOORS_ConfigurazioniVar.fld_CodVariante, Document.DBTDOORSConfigurazioniVar);
			col_CodVariante.ColPos = 2;
			col_CodVariante.AddChangedProperty("ColPos");
			col_CodVariante.HotLink = Document.HKLVariantsCorpo;
			col_CodVariante.AddChangedProperty("HotLink");
			col_CodVariante.SizeInChars = new System.Drawing.Size(21, 1);
			col_CodVariante.AddChangedProperty("SizeInChars");
			col_CodVariante.TitleTextColor = System.Drawing.Color.Black;
			col_CodVariante.AddChangedProperty("TitleTextColor");
			col_CodVariante.TitleBackColor = System.Drawing.Color.Transparent;
			col_CodVariante.AddChangedProperty("TitleBackColor");
			col_CodVariante.Visible = true;
			col_CodVariante.AddChangedProperty("Visible");
			col_CodVariante.AddChangedProperty("ColumnTitle");
			this.Add(col_CodVariante, false);
			...
			col_Bom.DataBinding = new FieldDataBinding(Document.DBTDOORSConfigurazioniVar.TTAG_DOORS_ConfigurazioniVar.fld_Bom, Document.DBTDOORSConfigurazioniVar);
			col_Bom.ColPos = 3;
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(col_CodVariante, "col_CodVariante");
