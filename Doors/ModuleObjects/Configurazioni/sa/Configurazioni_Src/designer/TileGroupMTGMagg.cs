...
{
	public class TileGroupMTGMagg : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupMTGMagg(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public TileMTDMagg tile_MTDMagg;

		public override void CreateComponents()
		{
			tile_MTDMagg = new TileMTDMagg(this, "MTDMagg", "", new System.Drawing.Point(0, 0), false);
			tile_MTDMagg.AddChangedProperty("Text");
			tile_MTDMagg.TileDialogType = ETileDialogSize.AutoFill;
			tile_MTDMagg.AddChangedProperty("TileDialogType");
			tile_MTDMagg.Size = new System.Drawing.Size(574, 144);
			tile_MTDMagg.AddChangedProperty("Size");
			this.Add(tile_MTDMagg, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tile_MTDMagg, "tile_MTDMagg");
		}
