...
{
	public class TileMTileDialogVariantiGen : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialogVariantiGen(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public BEDBTDOORSConfigurazioniVar ctrl_DBTDOORSConfigurazioniVar;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSConfigurazioniVar = new BEDBTDOORSConfigurazioniVar(this, "DBTDOORSConfigurazioniVar", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTDOORSConfigurazioniVar.DataBinding = new DBTDataBinding(Document.DBTDOORSConfigurazioniVar);
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("DataBinding");
			ctrl_DBTDOORSConfigurazioniVar.AutoFill = true;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSConfigurazioniVar.RightStretch = false;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("RightStretch");
			ctrl_DBTDOORSConfigurazioniVar.BottomStretch = false;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("BottomStretch");
			ctrl_DBTDOORSConfigurazioniVar.EnableDeleteRow = true;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("EnableDeleteRow");
			ctrl_DBTDOORSConfigurazioniVar.EnableAddRow = false;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("EnableAddRow");
			ctrl_DBTDOORSConfigurazioniVar.Enabled = true;
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("Enabled");
			ctrl_DBTDOORSConfigurazioniVar.Size = new System.Drawing.Size(574, 120);
			ctrl_DBTDOORSConfigurazioniVar.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSConfigurazioniVar, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSConfigurazioniVar, "ctrl_DBTDOORSConfigurazioniVar");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSConfigurazioniVar = null;
		}
	}
}
