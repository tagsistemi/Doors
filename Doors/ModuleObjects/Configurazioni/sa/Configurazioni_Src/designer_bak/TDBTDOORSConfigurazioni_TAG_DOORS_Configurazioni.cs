...
namespace Customization.Doors.Doors.DynamicDocuments.Configurazioni.Configurazioni
{
	public class TDBTDOORSConfigurazioni_TAG_DOORS_Configurazioni : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		...
		public override void CreateComponents()
		{
			...
			this.Add(fld_StartVariants, true);
			fld_StartVariants.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TTAG_DOORS_Configurazioni_fld_StartVariants_ValueChanged);
			fld_StartVariants.AddChangedEvent(new EventInfo("fld_StartVariants.ValueChanged", "TTAG_DOORS_Configurazioni_fld_StartVariants_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTDOORSConfigurazioni.TTAG_DOORS_Configurazioni.fld_StartVariants", true));
