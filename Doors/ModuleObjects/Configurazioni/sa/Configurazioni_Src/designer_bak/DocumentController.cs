...
namespace Customization.Doors.Doors.DynamicDocuments.Configurazioni.Configurazioni
{
	...
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDConfigurazioni Document
		{
			get
			{
				return (MDConfigurazioni)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_Configurazioni = new MDConfigurazioni(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_Configurazioni;
		...
		public MDConfigurazioni document_Configurazioni;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_Configurazioni, true);
			this.Add(view_Dynamic, true);
			controller.ExceptionRaised += new System.EventHandler<Microarea.EasyBuilder.ExceptionRaisedEventArgs>(DocumentController.controller.DocumentController_ExceptionRaised);
			controller.AddChangedEvent(new EventInfo("controller.ExceptionRaised", "DocumentController_ExceptionRaised", "System.EventHandler`1[Microarea.EasyBuilder.ExceptionRaisedEventArgs]", "", true));
		}
