...
namespace Customization.Doors.Doors.DynamicDocuments.Configurazioni.Configurazioni
{
	public class TileMTileDialog2 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public BEDBTDOORSConfigVetri ctrl_DBTDOORSConfigVetri;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSConfigVetri = new BEDBTDOORSConfigVetri(this, "DBTDOORSConfigVetri", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTDOORSConfigVetri.DataBinding = new DBTDataBinding(Document.DBTDOORSConfigVetri);
			ctrl_DBTDOORSConfigVetri.AddChangedProperty("DataBinding");
			ctrl_DBTDOORSConfigVetri.AutoFill = true;
			ctrl_DBTDOORSConfigVetri.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSConfigVetri.RightStretch = false;
			ctrl_DBTDOORSConfigVetri.AddChangedProperty("RightStretch");
			ctrl_DBTDOORSConfigVetri.BottomStretch = false;
			ctrl_DBTDOORSConfigVetri.AddChangedProperty("BottomStretch");
			ctrl_DBTDOORSConfigVetri.Size = new System.Drawing.Size(574, 120);
			ctrl_DBTDOORSConfigVetri.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSConfigVetri, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSConfigVetri, "ctrl_DBTDOORSConfigVetri");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSConfigVetri = null;
		}
	}
}
