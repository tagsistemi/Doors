...
namespace Customization.Doors.Doors.DynamicDocuments.DuplicaTabellaMaggiorazioni.DuplicaTabellaMaggiorazioni
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDDuplicaTabellaMaggiorazioni Document
		{
			get
			{
				return (MDDuplicaTabellaMaggiorazioni)DocumentController.controller.Document;
			}
		}
		...
		{
			ctrl_MParsedGroupBox = new Microarea.Framework.TBApplicationWrapper.MParsedGroupBox(this, "MParsedGroupBox", "EnumButton", new System.Drawing.Point(31, 37), false);
			ctrl_MParsedGroupBox.AddChangedProperty("Text");
			ctrl_MParsedGroupBox.Size = new System.Drawing.Size(312, 133);
			ctrl_MParsedGroupBox.AddChangedProperty("Size");
			this.Add(ctrl_MParsedGroupBox, true);
			ctrl_Prodctg = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Prodctg", "StringEdit", new System.Drawing.Point(162, 59), false);
			ctrl_Prodctg.DataBinding = new FieldDataBinding(Document.DBTLocalData.TEB_LocalData.fld_Prodctg, Document.DBTLocalData);
			...
			ctrl_ProdSubCtg = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "ProdSubCtg", "StringEdit", new System.Drawing.Point(162, 94), false);
			ctrl_ProdSubCtg.DataBinding = new FieldDataBinding(Document.DBTLocalData.TEB_LocalData.fld_ProdSubCtg, Document.DBTLocalData);
			...
			ctrl_Customer = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Customer", "StringEdit", new System.Drawing.Point(161, 132), false);
			ctrl_Customer.DataBinding = new FieldDataBinding(Document.DBTLocalData.TEB_LocalData.fld_Customer, Document.DBTLocalData);
			...
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(200, 178), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Size = new System.Drawing.Size(136, 23);
