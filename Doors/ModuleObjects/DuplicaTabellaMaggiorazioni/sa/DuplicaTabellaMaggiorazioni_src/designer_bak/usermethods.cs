	...
	public partial class DocumentController
	{
		public void tile_MTileDialog_ctrl_MPushButton_Click(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				...
				var tabmaggdocfinder = MDMaggiorazioni.Create();
				tabmaggdocfinder.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Prodctg.Value = Document.DBTLocalData.TEB_LocalData.fld_Prodctg.Value;
				tabmaggdocfinder.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_ProdSubCtg.Value = Document.DBTLocalData.TEB_LocalData.fld_ProdSubCtg.Value;
				tabmaggdocfinder.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Customer.Value = Document.DBTLocalData.TEB_LocalData.fld_Customer.Value;
				
				tabmaggdocfinder.BrowseRecord();
				
				
				
				var tabmaggnew = MDMaggiorazioni.Create();
				tabmaggnew.EnterInNewRecord();
				tabmaggnew.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Prodctg.Value = Document.DBTLocalData.TEB_LocalData.fld_Prodctg.Value;
				tabmaggnew.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_ProdSubCtg.Value = Document.DBTLocalData.TEB_LocalData.fld_ProdSubCtg.Value;
				
				
				for(int i = 0 ; i < tabmaggdocfinder.DBTDOORSMaggiorazioniDetail.RowsCount; i++)
				{
					TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail riga = tabmaggdocfinder.DBTDOORSMaggiorazioniDetail.GetRow(i);
					var newr = tabmaggnew.DBTDOORSMaggiorazioniDetail.AddRow();
					newr.fld_ADim.Value = riga.fld_ADim.Value;
					newr.fld_Apertura.Value = riga.fld_Apertura.Value;
					newr.fld_CtgProd.Value = riga.fld_CtgProd.Value;
					newr.fld_Customer.Value = riga.fld_Customer.Value;
					newr.fld_DaDim.Value = riga.fld_DaDim.Value;
					newr.fld_DescriApertura.Value = riga.fld_DescriApertura.Value;
					newr.fld_Descrizione.Value = riga.fld_DescriApertura.Value;
					newr.fld_Dimensione.Value = riga.fld_Dimensione.Value;
					newr.fld_Importo.Value = riga.fld_Importo.Value;
					newr.fld_Item.Value = riga.fld_Item.Value;
					newr.fld_OltreStandard.Value = riga.fld_OltreStandard.Value;
					newr.fld_TipoMaggiorazione.Value = riga.fld_TipoMaggiorazione.Value;
				}
				
				
				tabmaggdocfinder.Close();
