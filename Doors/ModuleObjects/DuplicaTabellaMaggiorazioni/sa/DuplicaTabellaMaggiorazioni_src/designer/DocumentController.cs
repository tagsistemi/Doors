...
{
	[ReferenceDeclarationAttribute("BusinessObject", "Document.Doors.Doors.DynamicDocuments.Maggiorazioni", "MDMaggiorazioni")]
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		[Microarea.TaskBuilderNet.Core.EasyBuilder.PreserveFieldAttribute]
		public new MDDuplicaTabellaMaggiorazioni Document
		{
			get
			{
				return (MDDuplicaTabellaMaggiorazioni)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_DuplicaTabellaMaggiorazioni = new MDDuplicaTabellaMaggiorazioni(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_DuplicaTabellaMaggiorazioni;
		...
		public MDDuplicaTabellaMaggiorazioni document_DuplicaTabellaMaggiorazioni;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_DuplicaTabellaMaggiorazioni, true);
		...
		public override void ClearComponents()
		{
			...
			oldController = null;
			document_DuplicaTabellaMaggiorazioni = null;
			view_Dynamic = null;
		}
	}
}
