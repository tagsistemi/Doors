...
namespace Customization.Doors.Doors.DynamicDocuments.DuplicaTabellaMaggiorazioni.DuplicaTabellaMaggiorazioni
{
	...
	{
		public HKLCustSupp() : base(new Microarea.TaskBuilderNet.Core.Generic.NameSpace("HotKeyLink.ERP.CustomersSuppliers.Dbl.CustSupp"), "CustSupp", DocumentController.controller.Document, false)
		{
		}
		...
		[Microarea.TaskBuilderNet.Core.Localization.LocalizedCategoryAttribute("Parameters", typeof(Microarea.TaskBuilderNet.Core.EasyBuilder.EBCategories))]
