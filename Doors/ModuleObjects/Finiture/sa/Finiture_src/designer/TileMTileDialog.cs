...
namespace Customization.Doors.Doors.DynamicDocuments.Finiture.Finiture
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDFiniture Document
		{
			get
			{
				return (MDFiniture)DocumentController.controller.Document;
			}
		}
		...
		public MParsedEdit ctrl_Gruppo;

		public override void CreateComponents()
		{
			ctrl_Descrizione1 = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Descrizione1", "StringStatic", new System.Drawing.Point(282, 123), false);
			ctrl_Descrizione1.DataBinding = new FieldDataBinding(Document.HKLDOORSGruppiFiniture.TTAG_DOORS_GruppiFiniture.fld_Descrizione, Document.HKLDOORSGruppiFiniture);
			ctrl_Descrizione1.AddChangedProperty("Caption");
			ctrl_Descrizione1.Border = true;
			ctrl_Descrizione1.AddChangedProperty("Border");
			ctrl_Descrizione1.Visible = false;
			ctrl_Descrizione1.AddChangedProperty("Visible");
			ctrl_Descrizione1.Size = new System.Drawing.Size(273, 23);
			...
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(2, 25), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 165);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Codice = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Codice", "StringEdit", new System.Drawing.Point(180, 49), false);
			ctrl_Codice.DataBinding = new FieldDataBinding(Document.DBTDOORSFiniture.TTAG_DOORS_Finiture.fld_Codice, Document.DBTDOORSFiniture);
			...
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Descrizione", "StringEdit", new System.Drawing.Point(180, 83), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSFiniture.TTAG_DOORS_Finiture.fld_Descrizione, Document.DBTDOORSFiniture);
			ctrl_Descrizione.AddChangedProperty("DataBinding");
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Size = new System.Drawing.Size(375, 23);
			ctrl_Descrizione.AddChangedProperty("Size");
			this.Add(ctrl_Descrizione, true);
			ctrl_Gruppo = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Gruppo", "StringEdit", new System.Drawing.Point(180, 123), false);
			ctrl_Gruppo.DataBinding = new FieldDataBinding(Document.DBTDOORSFiniture.TTAG_DOORS_Finiture.fld_Gruppo, Document.DBTDOORSFiniture);
			ctrl_Gruppo.AddChangedProperty("DataBinding");
			ctrl_Gruppo.AddChangedProperty("Caption");
			ctrl_Gruppo.HotLink = Document.HKLDOORSGruppiFiniture;
			ctrl_Gruppo.AddChangedProperty("HotLink");
			ctrl_Gruppo.Visible = false;
			ctrl_Gruppo.AddChangedProperty("Visible");
			ctrl_Gruppo.Size = new System.Drawing.Size(70, 23);
			ctrl_Gruppo.AddChangedProperty("Size");
			this.Add(ctrl_Gruppo, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_Gruppo, "ctrl_Gruppo");
		}
