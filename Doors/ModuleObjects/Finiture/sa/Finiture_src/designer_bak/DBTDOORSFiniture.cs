...
{
	public class DBTDOORSFiniture : MDBTMaster
	{
		public DBTDOORSFiniture() : base("TAG_DOORS_Finiture", "DOORSFiniture", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSFiniture(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_Finiture;
			}
		}

		public TDBTDOORSFiniture_TAG_DOORS_Finiture TTAG_DOORS_Finiture;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_Finiture;
			}
		}

		public TDBTDOORSFiniture_TAG_DOORS_Finiture OldTTAG_DOORS_Finiture;

		public virtual TDBTDOORSFiniture_TAG_DOORS_Finiture CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSFiniture_TAG_DOORS_Finiture)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSFiniture(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_Finiture = new TDBTDOORSFiniture_TAG_DOORS_Finiture(this.GetRecordPtr());
			this.Add(TTAG_DOORS_Finiture, true);
			OldTTAG_DOORS_Finiture = new TDBTDOORSFiniture_TAG_DOORS_Finiture(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_Finiture, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_Finiture = null;
			OldTTAG_DOORS_Finiture = null;
		}
	}
}
