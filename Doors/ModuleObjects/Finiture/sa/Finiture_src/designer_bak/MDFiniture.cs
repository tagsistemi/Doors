...
{
	public class MDFiniture : MDocument
	{
		public MDFiniture(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSFiniture DBTDOORSFiniture;
		...
		{
			DBTDOORSFiniture = new DBTDOORSFiniture();
			this.AttachMaster(this.DBTDOORSFiniture);
			...
			HKLDOORSGruppiFiniture.CanAddOnFly = true;
			HKLDOORSGruppiFiniture.AddChangedProperty("CanAddOnFly");
