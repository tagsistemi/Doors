...
{
	public class TileGroupOtherData : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupOtherData(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public TileNotes tile_Notes;

		public override void CreateComponents()
		{
			tile_MTileDialog = new TileMTileDialog(this, "MTileDialog", "", new System.Drawing.Point(0, 877), false);
			tile_MTileDialog.AddChangedProperty("Text");
			tile_MTileDialog.TabOrder = 0;
			tile_MTileDialog.AddChangedProperty("TabOrder");
			tile_MTileDialog.Collapsible = true;
			tile_MTileDialog.AddChangedProperty("Collapsible");
			tile_MTileDialog.Size = new System.Drawing.Size(1668, 931);
			tile_MTileDialog.AddChangedProperty("Size");
			this.Add(tile_MTileDialog, true);
			tile_Notes = new TileNotes(this, "Notes", "", new System.Drawing.Point(0, 261), true);
			tile_Notes.Collapsed = true;
			tile_Notes.AddChangedProperty("Collapsed");
			this.Add(tile_Notes, false);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tile_Notes, "tile_Notes");
		}
