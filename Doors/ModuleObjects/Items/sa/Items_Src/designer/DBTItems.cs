...
{
	public class DBTItems : MDBTMaster
	{
		public DBTItems() : base("MA_Items", "Items", DocumentController.controller.Document, true)
		{
		}

		public DBTItems(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTItems_MA_Items TMA_Items;
		...
		public TDBTItems_MA_Items OldTMA_Items;

		public virtual TDBTItems_MA_Items CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTItems_MA_Items)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTItems(dbtPtr);
		}

		public override void CreateComponents()
		{
			TMA_Items = new TDBTItems_MA_Items(this.GetRecordPtr());
			this.Add(TMA_Items, true);
			OldTMA_Items = new TDBTItems_MA_Items(this.GetOldRecordPtr());
			this.Add(OldTMA_Items, true);
		}
