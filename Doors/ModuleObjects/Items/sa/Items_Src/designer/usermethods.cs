...
namespace Customization.ERP.Items.Documents.Items.Items
{
	...
	{
		public void TMA_Items_fld_DoorsCoeffP_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
				CalcolaMisureEffettive();
				//and here
			}
		...
		public void TMA_Items_fld_DoorsCoeffH_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TMA_Items_fld_DoorsCoeffL_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TMA_Items_fld_DoorsPNominale_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TMA_Items_fld_DoorsHNominale_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TMA_Items_fld_DoorsLNominale_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void Document_DBTItems_Queried(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void DocumentController_ControlsEnabled(Object sender, ControllerEventArgs e)
		{
			...
			{
				//Write your code between here
				if(Document.FormMode == FormModeType.Browse)
				{
					view_Items.tileGroup_Header.tile_ItemHead.ctrl_MPushButton.Enabled = true;
				}
				else
				{
					view_Items.tileGroup_Header.tile_ItemHead.ctrl_MPushButton.Enabled = false;
				}
				//and here
			}
			catch (System.Exception exc)
		...
		public void tile_ItemHead_ctrl_MPushButton_Click(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
				if(Document.FormMode == FormModeType.Browse && (!string.IsNullOrEmpty(Document.DBTItems.TMA_Items.fld_Item.Value)) )
				{
					var db = MDBillOfMaterials.Create();
					if(db.EnterInNewRecord())
					{
						db.DBTBillOfMaterials.TMA_BillOfMaterials.fld_BOM.Value = Document.DBTItems.TMA_Items.fld_Item.Value;
						db.DBTBillOfMaterials.TMA_BillOfMaterials.fld_BOM.FireValueChanged();
					}
				}
				else
				{
					MessageBox.Show("Codice articolo nullo!");
				}
		...
		public void CalcolaMisureEffettive()
		{
			Document.DBTItems.TMA_Items.fld_DoorsLEffettiva.Value = Document.DBTItems.TMA_Items.fld_DoorsLNominale.Value - Document.DBTItems.TMA_Items.fld_DoorsCoeffL.Value;
			Document.DBTItems.TMA_Items.fld_DoorsLEffettiva.FireValueChanged();
			Document.DBTItems.TMA_Items.fld_DoorsHEffettiva.Value = Document.DBTItems.TMA_Items.fld_DoorsHNominale.Value - Document.DBTItems.TMA_Items.fld_DoorsCoeffH.Value;
			Document.DBTItems.TMA_Items.fld_DoorsHEffettiva.FireValueChanged();
			Document.DBTItems.TMA_Items.fld_DoorsPEffettiva.Value = Document.DBTItems.TMA_Items.fld_DoorsPNominale.Value - Document.DBTItems.TMA_Items.fld_DoorsCoeffP.Value;
			Document.DBTItems.TMA_Items.fld_DoorsPEffettiva.FireValueChanged();
