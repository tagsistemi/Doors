...
{
	[ReferenceDeclarationAttribute("BusinessObject", "Document.ERP.BillOfMaterials.Documents.BillOfMaterials", "MDBillOfMaterials")]
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_Items = new MDItems(documentHandle);
			view_Items = new DocumentView(formHandle);
			this.document = document_Items;
			this.view = view_Items;
			this.CreateCodeExtender();
		}

		partial void CreateCodeExtender();

		public MDItems document_Items;

		public DocumentView view_Items;

		public override void CreateComponents()
		{
			this.Add(document_Items, true);
			this.Add(view_Items, true);
