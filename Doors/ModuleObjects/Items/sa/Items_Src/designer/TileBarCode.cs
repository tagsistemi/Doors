...
{
	public class TileBarCode : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileBarCode(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MParsedEdit ctrl_MA_Items_SaleBarCode;

		public MPushButton ctrl_IDC_GOODS_BTN_STRIP_VIEW;

		public override void CreateComponents()
		{
			ctrl_MA_Items_SaleBarCode = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "MA_Items_SaleBarCode", "StringEdit", new System.Drawing.Point(177, 28), true);
			ctrl_MA_Items_SaleBarCode.Size = new System.Drawing.Size(285, 22);
			ctrl_MA_Items_SaleBarCode.AddChangedProperty("Size");
			this.Add(ctrl_MA_Items_SaleBarCode, true);
			ctrl_IDC_GOODS_BTN_STRIP_VIEW = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "IDC_GOODS_BTN_STRIP_VIEW", "Button", new System.Drawing.Point(480, 28), true);
			this.Add(ctrl_IDC_GOODS_BTN_STRIP_VIEW, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_MA_Items_SaleBarCode, "ctrl_MA_Items_SaleBarCode");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_MA_Items_SaleBarCode = null;
			ctrl_IDC_GOODS_BTN_STRIP_VIEW = null;
		}
	}
}
