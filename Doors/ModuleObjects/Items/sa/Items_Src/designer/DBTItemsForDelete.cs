...
{
	public class DBTItemsForDelete : MDBTSlave
	{
		public DBTItemsForDelete() : base("MA_Lots", "ItemsForDelete", DocumentController.controller.Document, true)
		{
		}

		public DBTItemsForDelete(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTItemsForDelete_MA_Lots TMA_Lots;
		...
		public TDBTItemsForDelete_MA_Lots OldTMA_Lots;

		public virtual TDBTItemsForDelete_MA_Lots CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTItemsForDelete_MA_Lots)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTItemsForDelete(dbtPtr);
		}

		public override void CreateComponents()
		{
			TMA_Lots = new TDBTItemsForDelete_MA_Lots(this.GetRecordPtr());
			this.Add(TMA_Lots, true);
			OldTMA_Lots = new TDBTItemsForDelete_MA_Lots(this.GetOldRecordPtr());
			this.Add(OldTMA_Lots, true);
		}
