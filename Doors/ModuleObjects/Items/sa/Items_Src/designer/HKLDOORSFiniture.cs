...
{
	public class HKLDOORSFiniture : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLDOORSFiniture() : base("TAG_DOORS_Finiture", "DOORSFiniture", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLDOORSFiniture_TAG_DOORS_Finiture TTAG_DOORS_Finiture;

		public virtual THKLDOORSFiniture_TAG_DOORS_Finiture CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLDOORSFiniture_TAG_DOORS_Finiture)record;
		}

		public MHotLinkSearch HKLDOORSFiniture_ByKey;

		public MHotLinkSearch HKLDOORSFiniture_ByDescription;

		public override void CreateComponents()
		{
			TTAG_DOORS_Finiture = new THKLDOORSFiniture_TAG_DOORS_Finiture(this.GetRecordPtr());
			this.Add(TTAG_DOORS_Finiture, true);
			HKLDOORSFiniture_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLDOORSFiniture_ByKey.UseInComboBox = true;
			HKLDOORSFiniture_ByKey.AddChangedProperty("UseInComboBox");
			HKLDOORSFiniture_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLDOORSFiniture_ByKey.AddChangedProperty("AssociatedButton");
			HKLDOORSFiniture_ByKey.FieldName = "Codice";
			HKLDOORSFiniture_ByKey.AddChangedProperty("FieldName");
			HKLDOORSFiniture_ByKey.AddChangedProperty("Description");
			HKLDOORSFiniture_ByKey.Name = "ByKey";
			HKLDOORSFiniture_ByKey.AddChangedProperty("Name");
			this.Add(HKLDOORSFiniture_ByKey, true);
			HKLDOORSFiniture_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLDOORSFiniture_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLDOORSFiniture_ByDescription.AddChangedProperty("AssociatedButton");
			HKLDOORSFiniture_ByDescription.FieldName = "Descrizione";
			HKLDOORSFiniture_ByDescription.AddChangedProperty("FieldName");
			HKLDOORSFiniture_ByDescription.AddChangedProperty("Description");
			HKLDOORSFiniture_ByDescription.Name = "ByDescription";
			HKLDOORSFiniture_ByDescription.AddChangedProperty("Name");
			this.Add(HKLDOORSFiniture_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLDOORSFiniture_ByKey, "HKLDOORSFiniture_ByKey");
			resources.ApplyResources(HKLDOORSFiniture_ByDescription, "HKLDOORSFiniture_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			HKLDOORSFiniture_ByKey = null;
			HKLDOORSFiniture_ByDescription = null;
		}
	}
}
