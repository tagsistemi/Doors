...
{
	public class TileItemHead : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileItemHead(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		{
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(175, 83), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Enabled = true;
			ctrl_MPushButton.AddChangedProperty("Enabled");
			ctrl_MPushButton.Size = new System.Drawing.Size(175, 29);
			ctrl_MPushButton.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton, true);
			ctrl_MPushButton.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_ItemHead_ctrl_MPushButton_Click);
			ctrl_MPushButton.AddChangedEvent(new EventInfo("ctrl_MPushButton.Click", "tile_ItemHead_ctrl_MPushButton_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Items.tileGroup_Header.tile_ItemHead.ctrl_MPushButton", true));
			ctrl_MPushButton.AddReferencedBy("DocumentController_ControlsEnabled");
		}
