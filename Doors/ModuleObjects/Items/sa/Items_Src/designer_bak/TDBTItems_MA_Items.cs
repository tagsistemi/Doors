...
using CLFtp;
using BusinessObjects.ERP.BillOfMaterials.Documents.BillOfMaterials;
...
using System.Data;
using System;
namespace Customization.ERP.Items.Documents.Items.Items
{
	public class TDBTItems_MA_Items : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTItems_MA_Items(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataText fld_ItemLongDescription;
		...
		public MDataStr fld_EIAdminstrativeRef;

		public MDataStr fld_PJ_MasterItem;

		public MDataStr fld_PJ_HLTRef;

		public MDataStr fld_PJ_Division;

		public MDataBool fld_PJ_AutoMinimumStock;

		public MDataInt fld_PJ_DaysForSellAvg;

		public MDataBool fld_PJ_OutOfStock;

		public MDataBool fld_PJ_LoadStorage;

		public MDataBool fld_PJ_I4AutoManufacturing;

		public MDataStr fld_PJ_Storage;

		public MDataStr fld_PJ_PickingStorage;

		public MDataBool fld_PJ_MOConfirmedForLess;
		...
		public MDataBool fld_PJ_OnlyJoinedSuppliers;

		public MDataBool fld_PJ_IsTyre;

		public MDataStr fld_PJ_TyreSection;

		public MDataEnum fld_PJ_TyreNature;

		public MDataStr fld_PJ_TyreIndex;

		public MDataDbl fld_PJ_MaxTyreKm;

		public MDataDbl fld_PJ_StartWidth;

		public MDataBool fld_PJ_UseXAB;

		public MDataDbl fld_DoorsCoeffL;

		public MDataDbl fld_DoorsCoeffH;

		public MDataDbl fld_DoorsCoeffP;

		public MDataDbl fld_DoorsLEffettiva;

		public MDataDbl fld_DoorsHEffettiva;

		public MDataDbl fld_DoorsPEffettiva;
		...
		public override void CreateComponents()
		{
			...
			fld_ItemLongDescription = new Microarea.Framework.TBApplicationWrapper.MDataText(this.GetFieldPtr("ItemLongDescription"));
			this.Add(fld_ItemLongDescription, false);
			...
			fld_EIAdminstrativeRef = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("EIAdminstrativeRef"));
			this.Add(fld_EIAdminstrativeRef, false);
			fld_PJ_MasterItem = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_MasterItem"));
			this.Add(fld_PJ_MasterItem, false);
			fld_PJ_HLTRef = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_HLTRef"));
			this.Add(fld_PJ_HLTRef, false);
			...
			fld_PJ_AutoMinimumStock = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_AutoMinimumStock"));
			this.Add(fld_PJ_AutoMinimumStock, false);
			fld_PJ_DaysForSellAvg = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("PJ_DaysForSellAvg"));
			this.Add(fld_PJ_DaysForSellAvg, false);
			fld_PJ_OutOfStock = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_OutOfStock"));
			this.Add(fld_PJ_OutOfStock, false);
			fld_PJ_LoadStorage = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_LoadStorage"));
			this.Add(fld_PJ_LoadStorage, false);
			fld_PJ_I4AutoManufacturing = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_I4AutoManufacturing"));
			this.Add(fld_PJ_I4AutoManufacturing, false);
			fld_PJ_Storage = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_Storage"));
			this.Add(fld_PJ_Storage, false);
			fld_PJ_PickingStorage = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_PickingStorage"));
			this.Add(fld_PJ_PickingStorage, false);
			fld_PJ_MOConfirmedForLess = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_MOConfirmedForLess"));
			this.Add(fld_PJ_MOConfirmedForLess, false);
			...
			this.Add(fld_DoorsLNominale, true);
			fld_DoorsLNominale.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsLNominale_ValueChanged);
			fld_DoorsLNominale.AddChangedEvent(new EventInfo("fld_DoorsLNominale.ValueChanged", "TMA_Items_fld_DoorsLNominale_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsLNominale", true));
			fld_DoorsHNominale = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsHNominale"));
			this.Add(fld_DoorsHNominale, true);
			fld_DoorsHNominale.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsHNominale_ValueChanged);
			fld_DoorsHNominale.AddChangedEvent(new EventInfo("fld_DoorsHNominale.ValueChanged", "TMA_Items_fld_DoorsHNominale_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsHNominale", true));
			fld_DoorsPNominale = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsPNominale"));
			this.Add(fld_DoorsPNominale, true);
			fld_DoorsPNominale.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsPNominale_ValueChanged);
			fld_DoorsPNominale.AddChangedEvent(new EventInfo("fld_DoorsPNominale.ValueChanged", "TMA_Items_fld_DoorsPNominale_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsPNominale", true));
			fld_PJ_OnlyJoinedSuppliers = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_OnlyJoinedSuppliers"));
			this.Add(fld_PJ_OnlyJoinedSuppliers, false);
			fld_PJ_IsTyre = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_IsTyre"));
			this.Add(fld_PJ_IsTyre, false);
			fld_PJ_TyreSection = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_TyreSection"));
			this.Add(fld_PJ_TyreSection, false);
			fld_PJ_TyreNature = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("PJ_TyreNature"));
			this.Add(fld_PJ_TyreNature, false);
			fld_PJ_TyreIndex = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PJ_TyreIndex"));
			this.Add(fld_PJ_TyreIndex, false);
			fld_PJ_MaxTyreKm = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("PJ_MaxTyreKm"));
			this.Add(fld_PJ_MaxTyreKm, false);
			fld_PJ_StartWidth = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("PJ_StartWidth"));
			this.Add(fld_PJ_StartWidth, false);
			fld_PJ_UseXAB = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_UseXAB"));
			this.Add(fld_PJ_UseXAB, false);
			fld_DoorsCoeffL = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsCoeffL"));
			this.Add(fld_DoorsCoeffL, true);
			fld_DoorsCoeffL.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsCoeffL_ValueChanged);
			fld_DoorsCoeffL.AddChangedEvent(new EventInfo("fld_DoorsCoeffL.ValueChanged", "TMA_Items_fld_DoorsCoeffL_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsCoeffL", true));
			fld_DoorsCoeffH = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsCoeffH"));
			this.Add(fld_DoorsCoeffH, true);
			fld_DoorsCoeffH.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsCoeffH_ValueChanged);
			fld_DoorsCoeffH.AddChangedEvent(new EventInfo("fld_DoorsCoeffH.ValueChanged", "TMA_Items_fld_DoorsCoeffH_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsCoeffH", true));
			fld_DoorsCoeffP = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsCoeffP"));
			this.Add(fld_DoorsCoeffP, true);
			fld_DoorsCoeffP.ValueChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.TMA_Items_fld_DoorsCoeffP_ValueChanged);
			fld_DoorsCoeffP.AddChangedEvent(new EventInfo("fld_DoorsCoeffP.ValueChanged", "TMA_Items_fld_DoorsCoeffP_ValueChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.DBTItems.TMA_Items.fld_DoorsCoeffP", true));
			this.AddLocalField("DoorsLEffettiva", "double", 8);
			fld_DoorsLEffettiva = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsLEffettiva"));
			this.Add(fld_DoorsLEffettiva, false);
			this.AddLocalField("DoorsHEffettiva", "double", 8);
			fld_DoorsHEffettiva = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsHEffettiva"));
			this.Add(fld_DoorsHEffettiva, false);
			this.AddLocalField("DoorsPEffettiva", "double", 8);
			fld_DoorsPEffettiva = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("DoorsPEffettiva"));
			this.Add(fld_DoorsPEffettiva, false);
		}
		...
		public override void ClearComponents()
		{
			...
			fld_EIAdminstrativeRef = null;
			fld_PJ_MasterItem = null;
			fld_PJ_HLTRef = null;
			fld_PJ_Division = null;
			fld_PJ_AutoMinimumStock = null;
			fld_PJ_DaysForSellAvg = null;
			fld_PJ_OutOfStock = null;
			fld_PJ_LoadStorage = null;
			fld_PJ_I4AutoManufacturing = null;
			fld_PJ_Storage = null;
			fld_PJ_PickingStorage = null;
			fld_PJ_MOConfirmedForLess = null;
			fld_TBCreated = null;
			fld_TBModified = null;
			...
			fld_PJ_OnlyJoinedSuppliers = null;
			fld_PJ_IsTyre = null;
			fld_PJ_TyreSection = null;
			fld_PJ_TyreNature = null;
			fld_PJ_TyreIndex = null;
			fld_PJ_MaxTyreKm = null;
			fld_PJ_StartWidth = null;
			fld_PJ_UseXAB = null;
			fld_DoorsCoeffL = null;
			fld_DoorsCoeffH = null;
			fld_DoorsCoeffP = null;
			fld_DoorsLEffettiva = null;
			fld_DoorsHEffettiva = null;
			fld_DoorsPEffettiva = null;
		}
	}
}
