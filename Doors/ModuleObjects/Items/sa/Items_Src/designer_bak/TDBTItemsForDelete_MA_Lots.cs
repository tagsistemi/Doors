...
{
	public class TDBTItemsForDelete_MA_Lots : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTItemsForDelete_MA_Lots(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataLng fld_ReceiptInvTransId;

		public MDataStr fld_ReceiptDocNo;

		public MDataDate fld_ValidFrom;

		public MDataDate fld_ValidTo;

		public MDataDate fld_OutOfStockDate;

		public MDataBool fld_TotallyConsumed;

		public MDataMon fld_Cost;

		public MDataStr fld_Supplier;

		public MDataDate fld_LoadDate;

		public MDataStr fld_PurchaseOrdNo;

		public MDataStr fld_SupplierLotNo;

		public MDataStr fld_ParentLotNo;

		public MDataInt fld_NoOfPacks;

		public MDataStr fld_AnalysisRefNo;

		public MDataDate fld_AnalysisDate;

		public MDataStr fld_AnalysisPerson;

		public MDataEnum fld_AnalysisStatus;

		public MDataStr fld_Notes;

		public MDataBool fld_InternallyProduced;

		public MDataBool fld_Disabled;

		public MDataQty fld_BookedQty;

		public MDataStr fld_MONo;

		public MDataLng fld_MOId;

		public MDataDate fld_ProductionDate;

		public MDataMon fld_ReceiptLastCost;

		public MDataQty fld_ReservedByMO;

		public MDataQty fld_UsedByProduction;

		public MDataStr fld_DescriptionText;

		public MDataDate fld_PurchaseDate;

		public MDataStr fld_BarcodeSegment;

		public MDataQty fld_MinimumStock;

		public MDataStr fld_Producer;

		public MDataDate fld_l_PreexpiringDate;

		public MDataQty fld_l__InitialBookInv;

		public MDataQty fld_l__InitialOnHand;
		...
		public MDataBool fld_PJ_1SE;

		public MDataBool fld_PJ_1SI;

		public MDataBool fld_PJ_1DI;

		public MDataBool fld_PJ_1DE;

		public MDataBool fld_PJ_2SE;

		public MDataBool fld_PJ_2SI;

		public MDataBool fld_PJ_2DE;

		public MDataBool fld_PJ_2DI;

		public MDataBool fld_PJ_3SE;

		public MDataBool fld_PJ_3SI;

		public MDataBool fld_PJ_3DI;

		public MDataBool fld_PJ_3DE;

		public MDataBool fld_PJ_4SE;

		public MDataBool fld_PJ_4SI;

		public MDataBool fld_PJ_4DI;

		public MDataBool fld_PJ_4DE;

		public MDataBool fld_PJ_Spare;
		...
		public MDataBool fld_PJ_NoCostAnalisys;
		...
		public override void CreateComponents()
		{
			...
			fld_ReceiptInvTransId = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("ReceiptInvTransId"));
			this.Add(fld_ReceiptInvTransId, false);
			fld_ReceiptDocNo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("ReceiptDocNo"));
			this.Add(fld_ReceiptDocNo, false);
			fld_ValidFrom = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("ValidFrom"));
			this.Add(fld_ValidFrom, false);
			fld_ValidTo = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("ValidTo"));
			this.Add(fld_ValidTo, false);
			fld_OutOfStockDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("OutOfStockDate"));
			this.Add(fld_OutOfStockDate, false);
			fld_TotallyConsumed = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("TotallyConsumed"));
			this.Add(fld_TotallyConsumed, false);
			fld_Cost = new Microarea.Framework.TBApplicationWrapper.MDataMon(this.GetFieldPtr("Cost"));
			this.Add(fld_Cost, false);
			fld_Supplier = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Supplier"));
			this.Add(fld_Supplier, false);
			fld_LoadDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("LoadDate"));
			this.Add(fld_LoadDate, false);
			fld_PurchaseOrdNo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PurchaseOrdNo"));
			this.Add(fld_PurchaseOrdNo, false);
			fld_SupplierLotNo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("SupplierLotNo"));
			this.Add(fld_SupplierLotNo, false);
			fld_ParentLotNo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("ParentLotNo"));
			this.Add(fld_ParentLotNo, false);
			...
			fld_AnalysisRefNo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("AnalysisRefNo"));
			this.Add(fld_AnalysisRefNo, false);
			fld_AnalysisDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("AnalysisDate"));
			this.Add(fld_AnalysisDate, false);
			fld_AnalysisPerson = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("AnalysisPerson"));
			this.Add(fld_AnalysisPerson, false);
			fld_AnalysisStatus = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("AnalysisStatus"));
			this.Add(fld_AnalysisStatus, false);
			fld_Notes = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Notes"));
			this.Add(fld_Notes, false);
			fld_InternallyProduced = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("InternallyProduced"));
			this.Add(fld_InternallyProduced, false);
			...
			fld_MONo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("MONo"));
			this.Add(fld_MONo, false);
			fld_MOId = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("MOId"));
			this.Add(fld_MOId, false);
			fld_ProductionDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("ProductionDate"));
			this.Add(fld_ProductionDate, false);
			fld_ReceiptLastCost = new Microarea.Framework.TBApplicationWrapper.MDataMon(this.GetFieldPtr("ReceiptLastCost"));
			this.Add(fld_ReceiptLastCost, false);
			fld_ReservedByMO = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("ReservedByMO"));
			this.Add(fld_ReservedByMO, false);
			fld_UsedByProduction = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("UsedByProduction"));
			this.Add(fld_UsedByProduction, false);
			...
			fld_PurchaseDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("PurchaseDate"));
			this.Add(fld_PurchaseDate, false);
			...
			fld_MinimumStock = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("MinimumStock"));
			this.Add(fld_MinimumStock, false);
			fld_Producer = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Producer"));
			this.Add(fld_Producer, false);
			fld_l_PreexpiringDate = new Microarea.Framework.TBApplicationWrapper.MDataDate(this.GetFieldPtr("l_PreexpiringDate"));
			this.Add(fld_l_PreexpiringDate, false);
			fld_l__InitialBookInv = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("l__InitialBookInv"));
			this.Add(fld_l__InitialBookInv, false);
			fld_l__InitialOnHand = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("l__InitialOnHand"));
			this.Add(fld_l__InitialOnHand, false);
			...
			fld_PJ_1SE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_1SE"));
			this.Add(fld_PJ_1SE, false);
			fld_PJ_1SI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_1SI"));
			this.Add(fld_PJ_1SI, false);
			fld_PJ_1DI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_1DI"));
			this.Add(fld_PJ_1DI, false);
			fld_PJ_1DE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_1DE"));
			this.Add(fld_PJ_1DE, false);
			fld_PJ_2SE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_2SE"));
			this.Add(fld_PJ_2SE, false);
			fld_PJ_2SI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_2SI"));
			this.Add(fld_PJ_2SI, false);
			fld_PJ_2DE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_2DE"));
			this.Add(fld_PJ_2DE, false);
			fld_PJ_2DI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_2DI"));
			this.Add(fld_PJ_2DI, false);
			fld_PJ_3SE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_3SE"));
			this.Add(fld_PJ_3SE, false);
			fld_PJ_3SI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_3SI"));
			this.Add(fld_PJ_3SI, false);
			fld_PJ_3DI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_3DI"));
			this.Add(fld_PJ_3DI, false);
			fld_PJ_3DE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_3DE"));
			this.Add(fld_PJ_3DE, false);
			fld_PJ_4SE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_4SE"));
			this.Add(fld_PJ_4SE, false);
			fld_PJ_4SI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_4SI"));
			this.Add(fld_PJ_4SI, false);
			fld_PJ_4DI = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_4DI"));
			this.Add(fld_PJ_4DI, false);
			fld_PJ_4DE = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_4DE"));
			this.Add(fld_PJ_4DE, false);
			fld_PJ_Spare = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_Spare"));
			this.Add(fld_PJ_Spare, false);
			...
			fld_PJ_NoCostAnalisys = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PJ_NoCostAnalisys"));
			this.Add(fld_PJ_NoCostAnalisys, false);
		}
		...
		public override void ClearComponents()
		{
			...
			fld_Storage = null;
			fld_ReceiptInvTransId = null;
			fld_ReceiptDocNo = null;
			fld_ValidFrom = null;
			fld_ValidTo = null;
			fld_OutOfStockDate = null;
			fld_TotallyConsumed = null;
			fld_Cost = null;
			fld_Supplier = null;
			fld_LoadDate = null;
			fld_PurchaseOrdNo = null;
			fld_SupplierLotNo = null;
			fld_ParentLotNo = null;
			fld_NoOfPacks = null;
			fld_AnalysisRefNo = null;
			fld_AnalysisDate = null;
			fld_AnalysisPerson = null;
			fld_AnalysisStatus = null;
			fld_Notes = null;
			fld_InternallyProduced = null;
			fld_Disabled = null;
			fld_BookedQty = null;
			fld_MONo = null;
			fld_MOId = null;
			fld_ProductionDate = null;
			fld_ReceiptLastCost = null;
			fld_ReservedByMO = null;
			fld_UsedByProduction = null;
			fld_DescriptionText = null;
			fld_PurchaseDate = null;
			fld_BarcodeSegment = null;
			fld_MinimumStock = null;
			fld_Producer = null;
			fld_l_PreexpiringDate = null;
			fld_l__InitialBookInv = null;
			fld_l__InitialOnHand = null;
			fld_TBCreated = null;
			fld_TBModified = null;
