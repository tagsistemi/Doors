...
namespace Customization.ERP.Items.Documents.Items.Items
{
	public class DocumentView : Microarea.EasyBuilder.MVC.DocumentView
	{
		...
		public TileGroupHeader tileGroup_Header;

		public TileManagerItemsTileManager tileManager_ItemsTileManager;

		public override void CreateComponents()
		{
			tileGroup_Header = new TileGroupHeader(this, "Header", "", new System.Drawing.Point(0, 0), true);
			this.Add(tileGroup_Header, true);
			tileManager_ItemsTileManager = new TileManagerItemsTileManager(this, "ItemsTileManager", "", new System.Drawing.Point(0, 345), true);
			tileManager_ItemsTileManager.AutoFill = false;
			tileManager_ItemsTileManager.AddChangedProperty("AutoFill");
			this.Add(tileManager_ItemsTileManager, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tileManager_ItemsTileManager, "tileManager_ItemsTileManager");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			tileGroup_Header = null;
			tileManager_ItemsTileManager = null;
		}
	}
}
