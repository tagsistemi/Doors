...
{
	public class TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataDbl fld_SpDa;

		public MDataDbl fld_SpA;

		public MDataDbl fld_LCf;

		public MDataQty fld_QtaCf;

		public MDataDbl fld_LCfAl;

		public MDataQty fld_QtaCfAl;

		public MDataBool fld_Imbotto;

		public MDataQty fld_QtaImb;

		public MDataDbl fld_LCf1;

		public MDataQty fld_QyaCf1;

		public MDataDbl fld_LTelaio;
		...
		public override void CreateComponents()
		{
			...
			fld_SpDa = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("SpDa"));
			this.Add(fld_SpDa, false);
			fld_SpA = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("SpA"));
			this.Add(fld_SpA, false);
			fld_LCf = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LCf"));
			this.Add(fld_LCf, false);
			fld_QtaCf = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("QtaCf"));
			this.Add(fld_QtaCf, false);
			fld_LCfAl = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LCfAl"));
			this.Add(fld_LCfAl, false);
			fld_QtaCfAl = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("QtaCfAl"));
			this.Add(fld_QtaCfAl, false);
			fld_Imbotto = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("Imbotto"));
			this.Add(fld_Imbotto, false);
			fld_QtaImb = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("QtaImb"));
			this.Add(fld_QtaImb, false);
			fld_LCf1 = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LCf1"));
			this.Add(fld_LCf1, false);
			fld_QyaCf1 = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("QyaCf1"));
			this.Add(fld_QyaCf1, false);
			fld_LTelaio = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LTelaio"));
			this.Add(fld_LTelaio, false);
		}
