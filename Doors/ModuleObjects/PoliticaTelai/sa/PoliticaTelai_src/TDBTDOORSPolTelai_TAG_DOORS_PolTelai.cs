...
{
	public class TDBTDOORSPolTelai_TAG_DOORS_PolTelai : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSPolTelai_TAG_DOORS_PolTelai(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataDbl fld_SpMuroDa;

		public MDataDbl fld_SpMuroA;

		public MDataDbl fld_LTelaio;

		public MDataStr fld_TipoTelaio;
		...
		public override void CreateComponents()
		{
			...
			fld_SpMuroDa = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("SpMuroDa"));
			this.Add(fld_SpMuroDa, false);
			fld_SpMuroA = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("SpMuroA"));
			this.Add(fld_SpMuroA, false);
			fld_LTelaio = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LTelaio"));
			this.Add(fld_LTelaio, false);
			fld_TipoTelaio = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("TipoTelaio"));
			this.Add(fld_TipoTelaio, false);
