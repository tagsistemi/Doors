...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaTelai.PoliticaTelai
{
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDPoliticaTelai Document
		{
			get
			{
				return (MDPoliticaTelai)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_PoliticaTelai = new MDPoliticaTelai(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_PoliticaTelai;
		...
		public MDPoliticaTelai document_PoliticaTelai;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_PoliticaTelai, true);
			this.Add(view_Dynamic, true);
			controller.ControlsEnabled += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_ControlsEnabled);
			controller.AddChangedEvent(new EventInfo("controller.ControlsEnabled", "DocumentController_ControlsEnabled", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
			controller.CheckingDataForTransaction += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_CheckingDataForTransaction);
			controller.AddChangedEvent(new EventInfo("controller.CheckingDataForTransaction", "DocumentController_CheckingDataForTransaction", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
			controller.DataForTransactionChecked += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_DataForTransactionChecked);
			controller.AddChangedEvent(new EventInfo("controller.DataForTransactionChecked", "DocumentController_DataForTransactionChecked", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
		}
