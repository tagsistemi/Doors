...
{
	public class MDPoliticaTelai : MDocument
	{
		public MDPoliticaTelai(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSPolTelai DBTDOORSPolTelai;

		public HKLDOORSTipiTelaio HKLDOORSTipiTelaio;

		public DBTDOORSPolTelaioDetail DBTDOORSPolTelaioDetail;
		...
		{
			DBTDOORSPolTelai = new DBTDOORSPolTelai();
			this.AttachMaster(this.DBTDOORSPolTelai);
			HKLDOORSTipiTelaio = new HKLDOORSTipiTelaio();
			this.Add(this.HKLDOORSTipiTelaio, true);
			HKLDOORSTipiTelaio.DataMustExist = true;
			HKLDOORSTipiTelaio.AddChangedProperty("DataMustExist");
			HKLDOORSTipiTelaio.LinkedDocumentNamespace = "Document.Doors.Doors.DynamicDocuments.TipiTelaio";
			HKLDOORSTipiTelaio.AddChangedProperty("LinkedDocumentNamespace");
			HKLDOORSTipiTelaio.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.DOORSTipiTelaio";
			HKLDOORSTipiTelaio.AddChangedProperty("PublicationNamespace");
			DBTDOORSPolTelaioDetail = new DBTDOORSPolTelaioDetail();
			this.AttachSlave(DBTDOORSPolTelaioDetail);
			DBTDOORSPolTelaioDetail.AddMasterForeignKey(DBTDOORSPolTelaioDetail.TTAG_DOORS_PolTelaioDetail.fld_Codice, "Codice");
			DBTDOORSPolTelaioDetail.PrimaryKeyPrepared += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSPolTelaioDetail_PrimaryKeyPrepared);
			DBTDOORSPolTelaioDetail.AddChangedEvent(new EventInfo("DBTDOORSPolTelaioDetail.PrimaryKeyPrepared", "Document_DBTDOORSPolTelaioDetail_PrimaryKeyPrepared", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSPolTelaioDetail", true));
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLDOORSTipiTelaio, "HKLDOORSTipiTelaio");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			DBTDOORSPolTelai = null;
			HKLDOORSTipiTelaio = null;
			DBTDOORSPolTelaioDetail = null;
			fld__DEBUG = null;
			fld_FormMode = null;
