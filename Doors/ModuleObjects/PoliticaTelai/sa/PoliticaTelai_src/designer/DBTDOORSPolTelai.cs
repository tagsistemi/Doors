...
{
	public class DBTDOORSPolTelai : MDBTMaster
	{
		public DBTDOORSPolTelai() : base("TAG_DOORS_PolTelai", "DOORSPolTelai", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSPolTelai(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_PolTelai;
			}
		}

		public TDBTDOORSPolTelai_TAG_DOORS_PolTelai TTAG_DOORS_PolTelai;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_PolTelai;
			}
		}

		public TDBTDOORSPolTelai_TAG_DOORS_PolTelai OldTTAG_DOORS_PolTelai;

		public virtual TDBTDOORSPolTelai_TAG_DOORS_PolTelai CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSPolTelai_TAG_DOORS_PolTelai)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSPolTelai(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_PolTelai = new TDBTDOORSPolTelai_TAG_DOORS_PolTelai(this.GetRecordPtr());
			this.Add(TTAG_DOORS_PolTelai, true);
			OldTTAG_DOORS_PolTelai = new TDBTDOORSPolTelai_TAG_DOORS_PolTelai(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_PolTelai, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_PolTelai = null;
			OldTTAG_DOORS_PolTelai = null;
		}
	}
}
