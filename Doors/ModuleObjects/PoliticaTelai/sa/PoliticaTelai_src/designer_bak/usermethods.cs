...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaTelai.PoliticaTelai
{
	...
	{
		public void Document_DBTDOORSPolTelaioDetail_PrimaryKeyPrepared(Object sender, Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail record = (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)e.Record;
				//Write your code between here
				Document.DBTDOORSPolTelaioDetail.CastToMyRecord(record).fld_Riga.Value =  (short)(e.RowNumber + 1);
				//and here
			}
		...
		public void DocumentController_DataForTransactionChecked(Object sender, ControllerEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void DocumentController_CheckingDataForTransaction(Object sender, ControllerEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TTAG_DOORS_PolTelai_fld_TipoTelaio_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TTAG_DOORS_PolTelai_fld_LTelaio_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TTAG_DOORS_PolTelai_fld_SpMuroA_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void TTAG_DOORS_PolTelai_fld_SpMuroDa_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
		...
		public void DocumentController_ControlsEnabled(Object sender, ControllerEventArgs e)
		{
			...
			{
				//Write your code between here
				//Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.ReadOnly = true;
				//Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Descrizione.ReadOnly = true;
				//and here
		...
		public void SetCode()
		{
			var da = Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_SpMuroDa.Value;
			string resda = (da.ToString("N2")).PadLeft(5, '0');
			var codice = Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.Value;
			codice += resda.Remove(2, 1);
			Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.Value = codice;
			
			var a = Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_SpMuroA.Value;
			string resa = (a.ToString("N2")).PadLeft(5, '0');
			codice += resa.Remove(2, 1);
			Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.Value = codice;
			
			var lt = Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_LTelaio.Value;
			string reslt = (lt.ToString("N2")).PadLeft(5, '0');
			codice += reslt.Remove(2, 1);
			Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.Value = codice;
			
			var tipo = Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_TipoTelaio.Value;
			codice += tipo;
			Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Codice.Value = codice;
			
			var descri = "";
			System.Text.StringBuilder sb = new System.Text.StringBuilder();
			sb.AppendFormat("Sp. Muro da {0} a {1} tipo telaio {2} L. Telaio {3}" , da, a, Document.HKLDOORSTipiTelaio.TTAG_DOORS_TipiTelaio.fld_Descrizione.Value, lt);
			descri = sb.ToString();
			
			Document.DBTDOORSPolTelai.TTAG_DOORS_PolTelai.fld_Descrizione.Value = descri;
