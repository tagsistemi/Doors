...
{
	public class DBTDOORSPolTelaioDetail : MDBTSlaveBuffered
	{
		public DBTDOORSPolTelaioDetail() : base("TAG_DOORS_PolTelaioDetail", "DOORSPolTelaioDetail", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSPolTelaioDetail(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_PolTelaioDetail;
			}
		}

		public TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail TTAG_DOORS_PolTelaioDetail;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_PolTelaioDetail;
			}
		}

		public TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail OldTTAG_DOORS_PolTelaioDetail;

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSPolTelaioDetail(dbtPtr);
		}

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail GetCurrentRow()
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail AddRow()
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)this.AddRecord();
		}

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail InsertRow(int rowNumber)
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail GetRow(int rowNumber)
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail GetOldRow(int rowNumber)
		{
			return (TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_PolTelaioDetail = new TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail(this.GetRecordPtr());
			this.Add(TTAG_DOORS_PolTelaioDetail, true);
			OldTTAG_DOORS_PolTelaioDetail = new TDBTDOORSPolTelaioDetail_TAG_DOORS_PolTelaioDetail(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_PolTelaioDetail, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_PolTelaioDetail = null;
			OldTTAG_DOORS_PolTelaioDetail = null;
		}
	}
}
