...
{
	public class TileGroupMTileGroup : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupMTileGroup(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public TileMTileDialog tile_MTileDialog;

		public TileMTDScontiPB tile_MTDScontiPB;

		public TileMTDScontoMagg tile_MTDScontoMagg;

		public override void CreateComponents()
		{
			tile_MTileDialog = new TileMTileDialog(this, "MTileDialog", "", new System.Drawing.Point(0, 0), false);
			tile_MTileDialog.AddChangedProperty("Text");
			tile_MTileDialog.Size = new System.Drawing.Size(1016, 180);
			tile_MTileDialog.AddChangedProperty("Size");
			this.Add(tile_MTileDialog, true);
			tile_MTDScontiPB = new TileMTDScontiPB(this, "MTDScontiPB", "", new System.Drawing.Point(0, 181), false);
			tile_MTDScontiPB.AddChangedProperty("Text");
			tile_MTDScontiPB.Collapsible = true;
			tile_MTDScontiPB.AddChangedProperty("Collapsible");
			tile_MTDScontiPB.ParentContainerLayout = Microarea.Framework.TBApplicationWrapper.EContainerLayout.Vbox;
			tile_MTDScontiPB.AddChangedProperty("ParentContainerLayout");
			tile_MTDScontiPB.Size = new System.Drawing.Size(574, 106);
			tile_MTDScontiPB.AddChangedProperty("Size");
			this.Add(tile_MTDScontiPB, true);
			tile_MTDScontoMagg = new TileMTDScontoMagg(this, "MTDScontoMagg", "", new System.Drawing.Point(0, 288), false);
			tile_MTDScontoMagg.AddChangedProperty("Text");
			tile_MTDScontoMagg.Collapsible = true;
			tile_MTDScontoMagg.AddChangedProperty("Collapsible");
			tile_MTDScontoMagg.Size = new System.Drawing.Size(574, 106);
			tile_MTDScontoMagg.AddChangedProperty("Size");
			this.Add(tile_MTDScontoMagg, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tile_MTileDialog, "tile_MTileDialog");
			resources.ApplyResources(tile_MTDScontiPB, "tile_MTDScontiPB");
			resources.ApplyResources(tile_MTDScontoMagg, "tile_MTDScontoMagg");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			tile_MTileDialog = null;
			tile_MTDScontiPB = null;
			tile_MTDScontoMagg = null;
		}
	}
}
