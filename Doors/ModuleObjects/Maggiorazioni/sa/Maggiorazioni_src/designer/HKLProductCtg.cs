...
namespace Customization.Doors.Doors.DynamicDocuments.Maggiorazioni.Maggiorazioni
{
	...
	{
		public HKLProductCtg() : base(new Microarea.TaskBuilderNet.Core.Generic.NameSpace("HotKeyLink.ERP.Items.Dbl.ProductCtg"), "ProductCtg", DocumentController.controller.Document, false)
		{
		}
