...
namespace Customization.Doors.Doors.DynamicDocuments.Maggiorazioni.Maggiorazioni
{
	...
	{
		public HKLProductSubCtg() : base(new Microarea.TaskBuilderNet.Core.Generic.NameSpace("HotKeyLink.ERP.Items.Dbl.ProductSubCtg"), "ProductSubCtg", DocumentController.controller.Document, false)
		{
		}
