...
{
	public class MDMaggiorazioni : MDocument
	{
		...
		public override void CreateComponents()
		{
			...
			DBTDOORSMaggiorazioniDetail.AddMasterForeignKey(DBTDOORSMaggiorazioniDetail.TTAG_DOORS_MaggiorazioniDetail.fld_CtgProd, "Prodctg");
			DBTDOORSMaggiorazioniDetail.AddMasterForeignKey(DBTDOORSMaggiorazioniDetail.TTAG_DOORS_MaggiorazioniDetail.fld_SubCtgProd, "ProdSubCtg");
			DBTDOORSMaggiorazioniDetail.AddMasterForeignKey(DBTDOORSMaggiorazioniDetail.TTAG_DOORS_MaggiorazioniDetail.fld_Customer, "Customer");
			DBTDOORSMaggiorazioniDetail.PrimaryKeyPrepared += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSMaggiorazioniDetail_PrimaryKeyPrepared);
			DBTDOORSMaggiorazioniDetail.AddChangedEvent(new EventInfo("DBTDOORSMaggiorazioniDetail.PrimaryKeyPrepared", "Document_DBTDOORSMaggiorazioniDetail_PrimaryKeyPrepared", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSMaggiorazioniDetail", true));
			DBTDOORSMaggiorazioniDetail.CurrentRowChanged += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSMaggiorazioniDetail_CurrentRowChanged);
			DBTDOORSMaggiorazioniDetail.AddChangedEvent(new EventInfo("DBTDOORSMaggiorazioniDetail.CurrentRowChanged", "Document_DBTDOORSMaggiorazioniDetail_CurrentRowChanged", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSMaggiorazioniDetail", true));
			DBTDOORSMaggiorazioniDetail.AuxColumnsPrepared += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSMaggiorazioniDetail_AuxColumnsPrepared);
			DBTDOORSMaggiorazioniDetail.AddChangedEvent(new EventInfo("DBTDOORSMaggiorazioniDetail.AuxColumnsPrepared", "Document_DBTDOORSMaggiorazioniDetail_AuxColumnsPrepared", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSMaggiorazioniDetail", true));
			DBTDOORSMaggiorazioniDetail.RowInserted += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSMaggiorazioniDetail_RowInserted);
			DBTDOORSMaggiorazioniDetail.AddChangedEvent(new EventInfo("DBTDOORSMaggiorazioniDetail.RowInserted", "Document_DBTDOORSMaggiorazioniDetail_RowInserted", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSMaggiorazioniDetail", true));
			HKLProductCtg = new HKLProductCtg();
			this.Add(this.HKLProductCtg, true);
			HKLProductCtg.ReadOnDataLoaded = true;
			HKLProductCtg.AddChangedProperty("ReadOnDataLoaded");
			...
			HKLProductSubCtg.ReadOnDataLoaded = true;
			HKLProductSubCtg.AddChangedProperty("ReadOnDataLoaded");
			...
			HKLCustSupp.ReadOnDataLoaded = true;
			HKLCustSupp.AddChangedProperty("ReadOnDataLoaded");
			...
			HKLItems.ReadOnDataLoaded = true;
			HKLItems.AddChangedProperty("ReadOnDataLoaded");
			...
			HKLDOORSAperture.Queried += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.Document_HKLDOORSAperture_Queried);
			HKLDOORSAperture.AddChangedEvent(new EventInfo("HKLDOORSAperture.Queried", "Document_HKLDOORSAperture_Queried", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.HKLDOORSAperture", true));
