...
using System.Data;
#endregion
namespace Customization.Doors.Doors.DynamicDocuments.Maggiorazioni.Maggiorazioni
{
	public partial class DocumentController
	{
		public void tile_MTileDialog_ctrl_MPushButtonTest_Click(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
				var test = new DoorsAddoOnLibrary.FormOdpWebManager();
				test.Show();
				//and here
			}
		...
		public void Document_DBTDOORSMaggiorazioniDetail_RowInserted(Object sender, Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				short r = 1;
				TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail record = (TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail)e.Record;
				for (int i = 0; i < Document.DBTDOORSMaggiorazioniDetail.Records.Count ; i++)
            {
					TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail rec = (TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail)Document.DBTDOORSMaggiorazioniDetail.GetRecord(i);
					rec.fld_Riga.Value = r++;
		...
		public void Document_HKLDOORSAperture_Queried(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
				var record = Document.DBTDOORSMaggiorazioniDetail.GetCurrentRow();
				if(record != null)
				{
					if(Document.FormMode == FormModeType.New || Document.FormMode == FormModeType.Edit)
					{
						record.fld_DescriApertura.Value = Document.HKLDOORSAperture.TTAG_DOORS_Aperture.fld_Descrizione.Value;
					}
				}
				//and here
			}
		...
		public void Document_DBTDOORSMaggiorazioniDetail_AuxColumnsPrepared(Object sender, Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail record = (TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail)e.Record;
				if(record != null)
				{
					Document.HKLDOORSAperture.FindRecord(record.fld_Apertura);
					record.fld_DescriApertura.Value = Document.HKLDOORSAperture.TTAG_DOORS_Aperture.fld_Descrizione.Value;
				}
		...
		public void Document_DBTDOORSMaggiorazioniDetail_CurrentRowChanged(Object sender, Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail record = (TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail)e.Record;
				ImpostaColonne(record);
			}
			catch (System.Exception exc)
			{
				this.OnExceptionRaised(exc);
		...
		public void ImpostaColonne(TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail record)
		{
			
			if(record != null)
			{
				//Write your code between here
				if(record.fld_TipoMaggiorazione.Value == Enums.TipoMaggiorazione.Dimensioni)
				{
					record.fld_Dimensione.ReadOnly = false;
					record.fld_Dimensione.FireValueChanged();
					
					record.fld_OltreStandard.ReadOnly = false;
					record.fld_OltreStandard.FireValueChanged();
					
//					if(record.fld_OltreStandard.Value > 0)
//					{
					
					//record.fld_DaDim.Value = 0;
					record.fld_DaDim.ReadOnly = false;
					record.fld_DaDim.FireValueChanged();
					//record.fld_ADim.Value = 0;
					record.fld_ADim.ReadOnly = false;
					record.fld_ADim.FireValueChanged();
...
//					}
					...
					record.fld_Item.Value = "";
					record.fld_Item.ReadOnly = true;
					record.fld_Item.FireValueChanged();
					record.fld_Apertura.Value = "";
					record.fld_Apertura.ReadOnly = true;
					record.fld_Apertura.FireValueChanged();
					
					
				}
				
				if(record.fld_TipoMaggiorazione.Value == Enums.TipoMaggiorazione.Articolo)
				{
					record.fld_Item.ReadOnly = false;
					record.fld_Item.FireValueChanged();
					record.fld_Dimensione.ReadOnly = true;
					record.fld_Dimensione.FireValueChanged();
					record.fld_DaDim.Value = 0;
					record.fld_DaDim.ReadOnly = true;
					record.fld_DaDim.FireValueChanged();
					record.fld_ADim.Value = 0;
					record.fld_ADim.ReadOnly = true;
					record.fld_ADim.FireValueChanged();
					record.fld_OltreStandard.Value = 0;
					record.fld_OltreStandard.ReadOnly = true;
					record.fld_OltreStandard.FireValueChanged();
					record.fld_Apertura.Value = "";
					record.fld_Apertura.ReadOnly = true;
					record.fld_Apertura.FireValueChanged();
				...
				if(record.fld_TipoMaggiorazione.Value == Enums.TipoMaggiorazione.TipoApertura)
				{
					record.fld_Item.Value = "";
					record.fld_Item.ReadOnly = true;
					record.fld_Item.FireValueChanged();
					...
					record.fld_OltreStandard.ReadOnly = true;
					record.fld_OltreStandard.FireValueChanged();
					record.fld_Apertura.ReadOnly = false;
					record.fld_Apertura.FireValueChanged();
		...
		public void TTAG_DOORS_MaggiorazioniDetail_fld_TipoMaggiorazione_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				var record = Document.DBTDOORSMaggiorazioniDetail.GetCurrentRow();
				...
				//view_Dynamic.tileManager_MTileManager.tileGroup_MTileGroup1.tile_MTileDialog1.ctrl_DBTDOORSMaggiorazioniDetail.Enabled = false;
				//view_Dynamic.tileManager_MTileManager.tileGroup_MTileGroup1.tile_MTileDialog1.ctrl_DBTDOORSMaggiorazioniDetail.Enabled = true;
		...
		public void TTAG_DOORS_Maggiorazioni_fld_ProdSubCtg_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				if(Document.FormMode == FormModeType.New)
				{
					var val = Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella.Value;
					val += " " + Document.HKLProductSubCtg.TMA_ProductCtgSubCtg.fld_Description.Value;
					Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella.Value = val;
		...
		public void TTAG_DOORS_Maggiorazioni_fld_Prodctg_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				if(Document.FormMode == FormModeType.New)
				{
					var val = Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella.Value;
					val += " " + Document.HKLProductCtg.TMA_ProductCtg.fld_Description.Value;
					Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella.Value = val;
					Document.UpdateDataView();
				}
			}
		...
		public void DocumentController_ControlsEnabled(Object sender, ControllerEventArgs e)
		{
			try
			{
				...
				if(Document.FormMode == FormModeType.New)
				{
					Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella.Value = "MAGGIORAZIONI";
				}
				//and here
			}
			catch (System.Exception exc)
		...
		public void Document_DBTDOORSMaggiorazioniDetail_PrimaryKeyPrepared(Object sender,  Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail record = (TDBTDOORSMaggiorazioniDetail_TAG_DOORS_MaggiorazioniDetail)e.Record;
				Document.DBTDOORSMaggiorazioniDetail.CastToMyRecord(record).fld_Riga.Value =  (short)(e.RowNumber + 1);
			}
			catch (System.Exception exc)
			{
				this.OnExceptionRaised(exc);
