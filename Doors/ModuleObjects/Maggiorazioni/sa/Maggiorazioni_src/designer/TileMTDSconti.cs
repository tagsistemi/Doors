...
{
	public class TileMTDSconti : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTDSconti(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
