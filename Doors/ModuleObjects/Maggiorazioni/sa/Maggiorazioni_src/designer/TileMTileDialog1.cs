...
namespace Customization.Doors.Doors.DynamicDocuments.Maggiorazioni.Maggiorazioni
{
	public class TileMTileDialog1 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public BEDBTDOORSMaggiorazioniDetail ctrl_DBTDOORSMaggiorazioniDetail;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSMaggiorazioniDetail = new BEDBTDOORSMaggiorazioniDetail(this, "DBTDOORSMaggiorazioniDetail", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTDOORSMaggiorazioniDetail.DataBinding = new DBTDataBinding(Document.DBTDOORSMaggiorazioniDetail);
			ctrl_DBTDOORSMaggiorazioniDetail.AddChangedProperty("DataBinding");
			ctrl_DBTDOORSMaggiorazioniDetail.AutoFill = true;
			ctrl_DBTDOORSMaggiorazioniDetail.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSMaggiorazioniDetail.RightStretch = false;
			ctrl_DBTDOORSMaggiorazioniDetail.AddChangedProperty("RightStretch");
			ctrl_DBTDOORSMaggiorazioniDetail.BottomStretch = false;
			ctrl_DBTDOORSMaggiorazioniDetail.AddChangedProperty("BottomStretch");
			ctrl_DBTDOORSMaggiorazioniDetail.Size = new System.Drawing.Size(1129, 122);
			ctrl_DBTDOORSMaggiorazioniDetail.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSMaggiorazioniDetail, true);
			ctrl_DBTDOORSMaggiorazioniDetail.AddReferencedBy("TTAG_DOORS_MaggiorazioniDetail_fld_TipoMaggiorazione_ValueChanged");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSMaggiorazioniDetail, "ctrl_DBTDOORSMaggiorazioniDetail");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSMaggiorazioniDetail = null;
		}
	}
}
