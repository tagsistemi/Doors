...
namespace Customization.Doors.Doors.DynamicDocuments.Maggiorazioni.Maggiorazioni
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MParsedStatic ctrl_CompanyName;
		...
		public MParsedEdit ctrl_Prodctg;

		public MParsedEdit ctrl_ProdSubCtg;

		public MParsedEdit ctrl_Customer;

		public MParsedEdit ctrl_DescriTabella;

		public MParsedEdit ctrl_Provvigione;

		public MPushButton ctrl_MPushButtonTest;

		public override void CreateComponents()
		{
			ctrl_CompanyName = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "CompanyName", "StringStatic", new System.Drawing.Point(380, 85), false);
			ctrl_CompanyName.DataBinding = new FieldDataBinding(Document.HKLCustSupp.TMA_CustSupp.fld_CompanyName, Document.HKLCustSupp);
			ctrl_CompanyName.AddChangedProperty("Caption");
			ctrl_CompanyName.Border = true;
			ctrl_CompanyName.AddChangedProperty("Border");
			ctrl_CompanyName.Size = new System.Drawing.Size(290, 23);
			ctrl_CompanyName.AddChangedProperty("Size");
			MLabelProperties ctrl_CompanyName_MLabelProperties = (MLabelProperties)ctrl_CompanyName.Extensions["MLabelProperties"];
			ctrl_CompanyName_MLabelProperties.Sunken = true;
			ctrl_CompanyName_MLabelProperties.AddChangedProperty("Sunken");
			this.Add(ctrl_CompanyName, true);
			ctrl_Description = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Description", "StringStatic", new System.Drawing.Point(380, 31), false);
			ctrl_Description.DataBinding = new FieldDataBinding(Document.HKLProductCtg.TMA_ProductCtg.fld_Description, Document.HKLProductCtg);
			ctrl_Description.AddChangedProperty("Caption");
			ctrl_Description.Border = true;
			ctrl_Description.AddChangedProperty("Border");
			ctrl_Description.Size = new System.Drawing.Size(290, 23);
			...
			ctrl_Description1 = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Description1", "StringStatic", new System.Drawing.Point(380, 58), false);
			ctrl_Description1.DataBinding = new FieldDataBinding(Document.HKLProductSubCtg.TMA_ProductCtgSubCtg.fld_Description, Document.HKLProductSubCtg);
			ctrl_Description1.AddChangedProperty("Caption");
			ctrl_Description1.Border = true;
			ctrl_Description1.AddChangedProperty("Border");
			ctrl_Description1.Size = new System.Drawing.Size(290, 23);
			...
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(4, 24), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 142);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Prodctg = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Prodctg", "StringEdit", new System.Drawing.Point(179, 31), false);
			ctrl_Prodctg.DataBinding = new FieldDataBinding(Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Prodctg, Document.DBTDOORSMaggiorazioni);
			ctrl_Prodctg.AddChangedProperty("DataBinding");
			ctrl_Prodctg.AddChangedProperty("Caption");
			ctrl_Prodctg.HotLink = Document.HKLProductCtg;
			ctrl_Prodctg.AddChangedProperty("HotLink");
			ctrl_Prodctg.Size = new System.Drawing.Size(156, 23);
			ctrl_Prodctg.AddChangedProperty("Size");
			this.Add(ctrl_Prodctg, true);
			ctrl_ProdSubCtg = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "ProdSubCtg", "StringEdit", new System.Drawing.Point(179, 58), false);
			ctrl_ProdSubCtg.DataBinding = new FieldDataBinding(Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_ProdSubCtg, Document.DBTDOORSMaggiorazioni);
			ctrl_ProdSubCtg.AddChangedProperty("DataBinding");
			ctrl_ProdSubCtg.AddChangedProperty("Caption");
			ctrl_ProdSubCtg.HotLink = Document.HKLProductSubCtg;
			ctrl_ProdSubCtg.AddChangedProperty("HotLink");
			ctrl_ProdSubCtg.Size = new System.Drawing.Size(156, 23);
			ctrl_ProdSubCtg.AddChangedProperty("Size");
			this.Add(ctrl_ProdSubCtg, true);
			ctrl_Customer = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Customer", "StringEdit", new System.Drawing.Point(179, 85), false);
			ctrl_Customer.DataBinding = new FieldDataBinding(Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Customer, Document.DBTDOORSMaggiorazioni);
			ctrl_Customer.AddChangedProperty("DataBinding");
			ctrl_Customer.AddChangedProperty("Caption");
			ctrl_Customer.HotLink = Document.HKLCustSupp;
			ctrl_Customer.AddChangedProperty("HotLink");
			ctrl_Customer.Size = new System.Drawing.Size(156, 23);
			ctrl_Customer.AddChangedProperty("Size");
			this.Add(ctrl_Customer, true);
			ctrl_DescriTabella = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "DescriTabella", "StringEdit", new System.Drawing.Point(179, 112), false);
			ctrl_DescriTabella.DataBinding = new FieldDataBinding(Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_DescriTabella, Document.DBTDOORSMaggiorazioni);
			ctrl_DescriTabella.AddChangedProperty("DataBinding");
			ctrl_DescriTabella.AddChangedProperty("Caption");
			ctrl_DescriTabella.Size = new System.Drawing.Size(491, 23);
			ctrl_DescriTabella.AddChangedProperty("Size");
			this.Add(ctrl_DescriTabella, true);
			ctrl_Provvigione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Provvigione", "PercentEdit", new System.Drawing.Point(179, 143), false);
			ctrl_Provvigione.DataBinding = new FieldDataBinding(Document.DBTDOORSMaggiorazioni.TTAG_DOORS_Maggiorazioni.fld_Provvigione, Document.DBTDOORSMaggiorazioni);
			ctrl_Provvigione.AddChangedProperty("Caption");
			ctrl_Provvigione.Size = new System.Drawing.Size(78, 23);
			ctrl_Provvigione.AddChangedProperty("Size");
			this.Add(ctrl_Provvigione, true);
			ctrl_MPushButtonTest = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButtonTest", "Button", new System.Drawing.Point(755, 54), false);
			ctrl_MPushButtonTest.AddChangedProperty("Text");
			ctrl_MPushButtonTest.Size = new System.Drawing.Size(175, 23);
			ctrl_MPushButtonTest.AddChangedProperty("Size");
			this.Add(ctrl_MPushButtonTest, true);
			ctrl_MPushButtonTest.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_MTileDialog_ctrl_MPushButtonTest_Click);
			ctrl_MPushButtonTest.AddChangedEvent(new EventInfo("ctrl_MPushButtonTest.Click", "tile_MTileDialog_ctrl_MPushButtonTest_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Dynamic.tileGroup_MTileGroup.tile_MTileDialog.ctrl_MPushButtonTest", true));
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_CompanyName, "ctrl_CompanyName");
			...
			resources.ApplyResources(ctrl_Prodctg, "ctrl_Prodctg");
			resources.ApplyResources(ctrl_ProdSubCtg, "ctrl_ProdSubCtg");
			resources.ApplyResources(ctrl_Customer, "ctrl_Customer");
			resources.ApplyResources(ctrl_DescriTabella, "ctrl_DescriTabella");
			resources.ApplyResources(ctrl_Provvigione, "ctrl_Provvigione");
			resources.ApplyResources(ctrl_MPushButtonTest, "ctrl_MPushButtonTest");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_CompanyName = null;
			ctrl_Description = null;
			ctrl_Description1 = null;
			ctrl_IDC_STATIC_AREA = null;
			ctrl_Prodctg = null;
			ctrl_ProdSubCtg = null;
			ctrl_Customer = null;
			ctrl_DescriTabella = null;
			ctrl_Provvigione = null;
			ctrl_MPushButtonTest = null;
		}
	}
}
