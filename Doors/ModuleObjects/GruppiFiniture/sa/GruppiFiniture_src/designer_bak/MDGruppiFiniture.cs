...
{
	public class MDGruppiFiniture : MDocument
	{
		public MDGruppiFiniture(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSGruppiFiniture DBTDOORSGruppiFiniture;
		...
		{
			DBTDOORSGruppiFiniture = new DBTDOORSGruppiFiniture();
			this.AttachMaster(this.DBTDOORSGruppiFiniture);
