...
namespace Customization.Doors.Doors.DynamicDocuments.GruppiFiniture.GruppiFiniture
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDGruppiFiniture Document
		{
			get
			{
				return (MDGruppiFiniture)DocumentController.controller.Document;
			}
		}
		...
		public override void CreateComponents()
		{
			...
			ctrl_Codice = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Codice", "StringEdit", new System.Drawing.Point(177, 73), false);
			ctrl_Codice.DataBinding = new FieldDataBinding(Document.DBTDOORSGruppiFiniture.TTAG_DOORS_GruppiFiniture.fld_Codice, Document.DBTDOORSGruppiFiniture);
			ctrl_Codice.AddChangedProperty("Caption");
			ctrl_Codice.Size = new System.Drawing.Size(107, 23);
			ctrl_Codice.AddChangedProperty("Size");
			this.Add(ctrl_Codice, true);
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Descrizione", "StringEdit", new System.Drawing.Point(177, 120), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSGruppiFiniture.TTAG_DOORS_GruppiFiniture.fld_Descrizione, Document.DBTDOORSGruppiFiniture);
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Size = new System.Drawing.Size(339, 23);
