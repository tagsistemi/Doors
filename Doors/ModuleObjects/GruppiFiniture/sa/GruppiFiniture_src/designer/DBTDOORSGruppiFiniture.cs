...
using System.Data;
using System;
namespace Customization.Doors.Doors.DynamicDocuments.GruppiFiniture.GruppiFiniture
{
	public class DBTDOORSGruppiFiniture : MDBTMaster
	{
		public DBTDOORSGruppiFiniture() : base("TAG_DOORS_GruppiFiniture", "DOORSGruppiFiniture", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSGruppiFiniture(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_GruppiFiniture;
			}
		}

		public TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture TTAG_DOORS_GruppiFiniture;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_GruppiFiniture;
			}
		}

		public TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture OldTTAG_DOORS_GruppiFiniture;

		public virtual TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSGruppiFiniture(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_GruppiFiniture = new TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture(this.GetRecordPtr());
			this.Add(TTAG_DOORS_GruppiFiniture, true);
			OldTTAG_DOORS_GruppiFiniture = new TDBTDOORSGruppiFiniture_TAG_DOORS_GruppiFiniture(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_GruppiFiniture, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_GruppiFiniture = null;
			OldTTAG_DOORS_GruppiFiniture = null;
		}
	}
}
