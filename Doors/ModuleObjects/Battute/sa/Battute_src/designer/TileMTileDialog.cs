...
namespace Customization.Doors.Doors.DynamicDocuments.Battute.Battute
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDBattute Document
		{
			get
			{
				return (MDBattute)DocumentController.controller.Document;
			}
		}
		...
		public override void CreateComponents()
		{
			...
			ctrl_Codice = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Codice", "StringEdit", new System.Drawing.Point(177, 65), false);
			ctrl_Codice.DataBinding = new FieldDataBinding(Document.DBTDOORSBattute.TTAG_DOORS_Battute.fld_Codice, Document.DBTDOORSBattute);
			...
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Descrizione", "StringEdit", new System.Drawing.Point(177, 102), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSBattute.TTAG_DOORS_Battute.fld_Descrizione, Document.DBTDOORSBattute);
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Size = new System.Drawing.Size(370, 23);
