...
{
	public class MDBattute : MDocument
	{
		public MDBattute(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSBattute DBTDOORSBattute;
		...
		{
			DBTDOORSBattute = new DBTDOORSBattute();
			this.AttachMaster(this.DBTDOORSBattute);
