...
using System.Data;
using System;
namespace Customization.Doors.Doors.DynamicDocuments.Battute.Battute
{
	public class DBTDOORSBattute : MDBTMaster
	{
		public DBTDOORSBattute() : base("TAG_DOORS_Battute", "DOORSBattute", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSBattute(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_Battute;
			}
		}

		public TDBTDOORSBattute_TAG_DOORS_Battute TTAG_DOORS_Battute;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_Battute;
			}
		}

		public TDBTDOORSBattute_TAG_DOORS_Battute OldTTAG_DOORS_Battute;

		public virtual TDBTDOORSBattute_TAG_DOORS_Battute CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSBattute_TAG_DOORS_Battute)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSBattute(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_Battute = new TDBTDOORSBattute_TAG_DOORS_Battute(this.GetRecordPtr());
			this.Add(TTAG_DOORS_Battute, true);
			OldTTAG_DOORS_Battute = new TDBTDOORSBattute_TAG_DOORS_Battute(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_Battute, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_Battute = null;
			OldTTAG_DOORS_Battute = null;
		}
	}
}
