...
{
	public class TDBTImpCF_EB_LocalData : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTImpCF_EB_LocalData(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public MDataStr fld_NomeFile;

		public MDataBool fld_Clienti;

		public MDataBool fld_Selezione;

		public override void CreateComponents()
		{
			this.AddLocalField("NomeFile", "string", 250);
			fld_NomeFile = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("NomeFile"));
			this.Add(fld_NomeFile, false);
			this.AddLocalField("Clienti", "bool", 1);
			fld_Clienti = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("Clienti"));
			this.Add(fld_Clienti, false);
			this.AddLocalField("Selezione", "bool", 1);
			fld_Selezione = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("Selezione"));
			this.Add(fld_Selezione, false);
		}
