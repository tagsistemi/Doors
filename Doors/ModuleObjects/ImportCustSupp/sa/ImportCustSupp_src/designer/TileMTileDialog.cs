...
namespace Customization.Doors.Doors.DynamicDocuments.ImportCustSupp.ImportCustSupp
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MParsedEdit ctrl_NomeFile;

		public MPushButton ctrl_MPushButton;

		public MRadioButton ctrl_MRadioButton;

		public MRadioButton ctrl_MRadioButton1;

		public MCheckBox ctrl_MCheckBox;
		...
		public override void CreateComponents()
		{
			...
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 46);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_MParsedGroupBox = new Microarea.Framework.TBApplicationWrapper.MParsedGroupBox(this, "MParsedGroupBox", "EnumButton", new System.Drawing.Point(719, 23), false);
			ctrl_MParsedGroupBox.Size = new System.Drawing.Size(190, 75);
			ctrl_MParsedGroupBox.AddChangedProperty("Size");
			this.Add(ctrl_MParsedGroupBox, true);
			ctrl_NomeFile = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "NomeFile", "StringEdit", new System.Drawing.Point(175, 37), false);
			ctrl_NomeFile.DataBinding = new FieldDataBinding(Document.DBTImpCF.TEB_LocalData.fld_NomeFile, Document.DBTImpCF);
			ctrl_NomeFile.AddChangedProperty("DataBinding");
			ctrl_NomeFile.AddChangedProperty("Caption");
			ctrl_NomeFile.Size = new System.Drawing.Size(511, 23);
			ctrl_NomeFile.AddChangedProperty("Size");
			MStateObject ctrl_NomeFile_StateButton = (MStateObject)ctrl_NomeFile.Extensions["StateButton"];
			ctrl_NomeFile_StateButton.Style = Microarea.Framework.TBApplicationWrapper.MStateObject.ButtonStyle.Arrow;
			ctrl_NomeFile_StateButton.AddChangedProperty("Style");
			this.Add(ctrl_NomeFile, true);
			ctrl_NomeFile_StateButton.StateButtonClicked += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.MStateObjectEventArgs>(DocumentController.controller.view_Dynamic_tileGroup_MTileGroup_tile_MTileDialog_ctrl_NomeFile_StateButton_StateButtonClicked);
			ctrl_NomeFile_StateButton.AddChangedEvent(new EventInfo("ctrl_NomeFile.StateButton.StateButtonClicked", "view_Dynamic_tileGroup_MTileGroup_tile_MTileDialog_ctrl_NomeFile_StateButton_StateButtonClicked", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.MStateObjectEventArgs]", "view_Dynamic.tileGroup_MTileGroup.tile_MTileDialog.ctrl_NomeFile.StateButton", true));
			ctrl_MPushButton = new Microarea.Framework.TBApplicationWrapper.MPushButton(this, "MPushButton", "Button", new System.Drawing.Point(727, 66), false);
			ctrl_MPushButton.AddChangedProperty("Text");
			ctrl_MPushButton.Size = new System.Drawing.Size(175, 23);
			ctrl_MPushButton.AddChangedProperty("Size");
			this.Add(ctrl_MPushButton, true);
			ctrl_MPushButton.Click += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_MTileDialog_ctrl_MPushButton_Click);
			ctrl_MPushButton.AddChangedEvent(new EventInfo("ctrl_MPushButton.Click", "tile_MTileDialog_ctrl_MPushButton_Click", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Dynamic.tileGroup_MTileGroup.tile_MTileDialog.ctrl_MPushButton", true));
			ctrl_MRadioButton = new Microarea.Framework.TBApplicationWrapper.MRadioButton(this, "MRadioButton", "RadioButton", new System.Drawing.Point(728, 40), false);
			ctrl_MRadioButton.DataBinding = new FieldDataBinding(Document.DBTImpCF.TEB_LocalData.fld_Clienti, Document.DBTImpCF);
			ctrl_MRadioButton.Checked = true;
			ctrl_MRadioButton.AddChangedProperty("Checked");
			ctrl_MRadioButton.AddChangedProperty("Text");
			ctrl_MRadioButton.Size = new System.Drawing.Size(69, 15);
			ctrl_MRadioButton.AddChangedProperty("Size");
			this.Add(ctrl_MRadioButton, true);
			ctrl_MRadioButton1 = new Microarea.Framework.TBApplicationWrapper.MRadioButton(this, "MRadioButton1", "RadioButton", new System.Drawing.Point(818, 40), false);
			ctrl_MRadioButton1.AddChangedProperty("Text");
			ctrl_MRadioButton1.Size = new System.Drawing.Size(80, 15);
			ctrl_MRadioButton1.AddChangedProperty("Size");
			this.Add(ctrl_MRadioButton1, true);
			ctrl_MCheckBox = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "MCheckBox", "CheckBox", new System.Drawing.Point(177, 67), false);
			ctrl_MCheckBox.DataBinding = new FieldDataBinding(Document.DBTImpCF.TEB_LocalData.fld_Selezione, Document.DBTImpCF);
			ctrl_MCheckBox.AddChangedProperty("Text");
			ctrl_MCheckBox.Size = new System.Drawing.Size(175, 23);
			ctrl_MCheckBox.AddChangedProperty("Size");
			MCheckBoxProperties ctrl_MCheckBox_MCheckBoxProperties = (MCheckBoxProperties)ctrl_MCheckBox.Extensions["MCheckBoxProperties"];
			ctrl_MCheckBox_MCheckBoxProperties.LabelOnLeft = false;
			ctrl_MCheckBox_MCheckBoxProperties.AddChangedProperty("LabelOnLeft");
			ctrl_MCheckBox_MCheckBoxProperties.TextAlignment = Microarea.Framework.TBApplicationWrapper.ETextAlign.Left;
			ctrl_MCheckBox_MCheckBoxProperties.AddChangedProperty("TextAlignment");
			this.Add(ctrl_MCheckBox, true);
			ctrl_MCheckBox.CheckedChanged += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.tile_MTileDialog_ctrl_MCheckBox_CheckedChanged);
			ctrl_MCheckBox.AddChangedEvent(new EventInfo("ctrl_MCheckBox.CheckedChanged", "tile_MTileDialog_ctrl_MCheckBox_CheckedChanged", "System.EventHandler`1[EasyBuilderEventArgs]", "view_Dynamic.tileGroup_MTileGroup.tile_MTileDialog.ctrl_MCheckBox", true));
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_NomeFile, "ctrl_NomeFile");
			resources.ApplyResources(ctrl_MPushButton, "ctrl_MPushButton");
			resources.ApplyResources(ctrl_MRadioButton, "ctrl_MRadioButton");
			resources.ApplyResources(ctrl_MRadioButton1, "ctrl_MRadioButton1");
			resources.ApplyResources(ctrl_MCheckBox, "ctrl_MCheckBox");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_MRadioButton = null;
			ctrl_MRadioButton1 = null;
			ctrl_MCheckBox = null;
		}
	}
}
