...
{
	public class DBTElencoCF : MDBTSlaveBuffered
	{
		public DBTElencoCF() : base("EB_LocalData", "ElencoCF", DocumentController.controller.Document, false)
		{
		}

		public DBTElencoCF(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTElencoCF_EB_LocalData TEB_LocalData;
		...
		public TDBTElencoCF_EB_LocalData OldTEB_LocalData;

		public virtual TDBTElencoCF_EB_LocalData CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTElencoCF_EB_LocalData)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTElencoCF(dbtPtr);
		}

		public virtual TDBTElencoCF_EB_LocalData GetCurrentRow()
		{
			return (TDBTElencoCF_EB_LocalData)this.GetCurrentRecord();
		}

		public virtual TDBTElencoCF_EB_LocalData AddRow()
		{
			return (TDBTElencoCF_EB_LocalData)this.AddRecord();
		}

		public virtual TDBTElencoCF_EB_LocalData InsertRow(int rowNumber)
		{
			return (TDBTElencoCF_EB_LocalData)this.InsertRecord(rowNumber);
		}

		public virtual TDBTElencoCF_EB_LocalData GetRow(int rowNumber)
		{
			return (TDBTElencoCF_EB_LocalData)this.GetRecord(rowNumber);
		}

		public virtual TDBTElencoCF_EB_LocalData GetOldRow(int rowNumber)
		{
			return (TDBTElencoCF_EB_LocalData)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TEB_LocalData = new TDBTElencoCF_EB_LocalData(this.GetRecordPtr());
			this.Add(TEB_LocalData, true);
			OldTEB_LocalData = new TDBTElencoCF_EB_LocalData(this.GetOldRecordPtr());
