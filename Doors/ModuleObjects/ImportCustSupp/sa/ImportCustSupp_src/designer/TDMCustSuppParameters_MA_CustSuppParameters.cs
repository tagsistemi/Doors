...
{
	public class TDMCustSuppParameters_MA_CustSuppParameters : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDMCustSuppParameters_MA_CustSuppParameters(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public MDataLng fld_CustSuppParametersId;

		public MDataStr fld_ISOCountryCode;

		public MDataBool fld_CustomerAutoNum;

		public MDataLng fld_LastCustomer;

		public MDataBool fld_SupplierAutonum;

		public MDataLng fld_LastSupplier;

		public MDataInt fld_CustSuppMaxChars;

		public MDataBool fld_ContactsAutoNum;

		public MDataLng fld_LastContact;

		public MDataInt fld_ContactsMaxChars;

		public MDataBool fld_ProspSuppAutoNum;

		public MDataLng fld_LastProspSupp;

		public MDataStr fld_CustPaymentTerm;

		public MDataStr fld_SuppPaymentTerm;

		public MDataStr fld_EUCustomerTaxCode;

		public MDataBool fld_PrefixWithSiteCode;

		public MDataBool fld_AutomaticPrefix;

		public MDataBool fld_ContactsAutomaticPrefix;

		public MDataBool fld_CustSuppDraftDefault;

		public MDataEnum fld_CustSuppDraftType;

		public MDataLng fld_BankComboMaxItems;

		public MDataStr fld_TaxIdNumberLinkUrl;

		public MDataLng fld_CityComboMaxItems;

		public MDataEnum fld_CustMailSendingType;

		public MDataEnum fld_CustDocumentSendingType;

		public MDataEnum fld_SuppMailSendingType;

		public MDataEnum fld_SuppDocumentSendingType;

		public MDataStr fld_ExtraEUCustomerTaxCode;

		public MDataBool fld_EUCustSuppCheckTaxId;

		public MDataBool fld_EUContactsCheckTaxId;

		public MDataStr fld_EUTaxIdNumberLinkUrl;

		public MDataStr fld_GermanBanksLinkUrl;

		public MDataBool fld_CheckRomanianSuspOnLine;
		...
		{
			fld_CustSuppParametersId = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("CustSuppParametersId"));
			this.Add(fld_CustSuppParametersId, false);
			...
			fld_CustomerAutoNum = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("CustomerAutoNum"));
			this.Add(fld_CustomerAutoNum, false);
			fld_LastCustomer = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("LastCustomer"));
			this.Add(fld_LastCustomer, false);
			fld_SupplierAutonum = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("SupplierAutonum"));
			this.Add(fld_SupplierAutonum, false);
			fld_LastSupplier = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("LastSupplier"));
			this.Add(fld_LastSupplier, false);
			fld_CustSuppMaxChars = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("CustSuppMaxChars"));
			this.Add(fld_CustSuppMaxChars, false);
			fld_ContactsAutoNum = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("ContactsAutoNum"));
			this.Add(fld_ContactsAutoNum, false);
			fld_LastContact = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("LastContact"));
			this.Add(fld_LastContact, false);
			fld_ContactsMaxChars = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("ContactsMaxChars"));
			this.Add(fld_ContactsMaxChars, false);
			fld_ProspSuppAutoNum = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("ProspSuppAutoNum"));
			this.Add(fld_ProspSuppAutoNum, false);
			fld_LastProspSupp = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("LastProspSupp"));
			this.Add(fld_LastProspSupp, false);
			fld_CustPaymentTerm = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CustPaymentTerm"));
			this.Add(fld_CustPaymentTerm, false);
			fld_SuppPaymentTerm = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("SuppPaymentTerm"));
			this.Add(fld_SuppPaymentTerm, false);
			fld_EUCustomerTaxCode = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("EUCustomerTaxCode"));
			this.Add(fld_EUCustomerTaxCode, false);
			fld_PrefixWithSiteCode = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("PrefixWithSiteCode"));
			this.Add(fld_PrefixWithSiteCode, false);
			fld_AutomaticPrefix = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("AutomaticPrefix"));
			this.Add(fld_AutomaticPrefix, false);
			fld_ContactsAutomaticPrefix = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("ContactsAutomaticPrefix"));
			this.Add(fld_ContactsAutomaticPrefix, false);
			fld_CustSuppDraftDefault = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("CustSuppDraftDefault"));
			this.Add(fld_CustSuppDraftDefault, false);
			fld_CustSuppDraftType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("CustSuppDraftType"));
			this.Add(fld_CustSuppDraftType, false);
			fld_BankComboMaxItems = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("BankComboMaxItems"));
			this.Add(fld_BankComboMaxItems, false);
			fld_TaxIdNumberLinkUrl = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("TaxIdNumberLinkUrl"));
			this.Add(fld_TaxIdNumberLinkUrl, false);
			fld_CityComboMaxItems = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("CityComboMaxItems"));
			this.Add(fld_CityComboMaxItems, false);
			fld_CustMailSendingType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("CustMailSendingType"));
			this.Add(fld_CustMailSendingType, false);
			fld_CustDocumentSendingType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("CustDocumentSendingType"));
			this.Add(fld_CustDocumentSendingType, false);
			fld_SuppMailSendingType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("SuppMailSendingType"));
			this.Add(fld_SuppMailSendingType, false);
			fld_SuppDocumentSendingType = new Microarea.Framework.TBApplicationWrapper.MDataEnum(this.GetFieldPtr("SuppDocumentSendingType"));
			this.Add(fld_SuppDocumentSendingType, false);
			fld_ExtraEUCustomerTaxCode = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("ExtraEUCustomerTaxCode"));
			this.Add(fld_ExtraEUCustomerTaxCode, false);
			fld_EUCustSuppCheckTaxId = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("EUCustSuppCheckTaxId"));
			this.Add(fld_EUCustSuppCheckTaxId, false);
			fld_EUContactsCheckTaxId = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("EUContactsCheckTaxId"));
			this.Add(fld_EUContactsCheckTaxId, false);
			fld_EUTaxIdNumberLinkUrl = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("EUTaxIdNumberLinkUrl"));
			this.Add(fld_EUTaxIdNumberLinkUrl, false);
			fld_GermanBanksLinkUrl = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("GermanBanksLinkUrl"));
			this.Add(fld_GermanBanksLinkUrl, false);
			fld_CheckRomanianSuspOnLine = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("CheckRomanianSuspOnLine"));
			this.Add(fld_CheckRomanianSuspOnLine, false);
		...
		public override void ClearComponents()
		{
			...
			fld_CustSuppParametersId = null;
			fld_ISOCountryCode = null;
			fld_CustomerAutoNum = null;
			fld_LastCustomer = null;
			fld_SupplierAutonum = null;
			fld_LastSupplier = null;
			fld_CustSuppMaxChars = null;
			fld_ContactsAutoNum = null;
			fld_LastContact = null;
			fld_ContactsMaxChars = null;
			fld_ProspSuppAutoNum = null;
			fld_LastProspSupp = null;
			fld_CustPaymentTerm = null;
			fld_SuppPaymentTerm = null;
			fld_EUCustomerTaxCode = null;
			fld_PrefixWithSiteCode = null;
			fld_AutomaticPrefix = null;
			fld_ContactsAutomaticPrefix = null;
			fld_CustSuppDraftDefault = null;
			fld_CustSuppDraftType = null;
			fld_BankComboMaxItems = null;
			fld_TaxIdNumberLinkUrl = null;
			fld_CityComboMaxItems = null;
			fld_CustMailSendingType = null;
			fld_CustDocumentSendingType = null;
			fld_SuppMailSendingType = null;
			fld_SuppDocumentSendingType = null;
			fld_ExtraEUCustomerTaxCode = null;
			fld_EUCustSuppCheckTaxId = null;
			fld_EUContactsCheckTaxId = null;
			fld_EUTaxIdNumberLinkUrl = null;
			fld_GermanBanksLinkUrl = null;
			fld_CheckRomanianSuspOnLine = null;
			fld_TBCreated = null;
			fld_TBModified = null;
