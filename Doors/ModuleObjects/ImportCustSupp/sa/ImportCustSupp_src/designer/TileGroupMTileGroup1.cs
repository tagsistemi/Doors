...
{
	public class TileGroupMTileGroup1 : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupMTileGroup1(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		{
			tile_MTileDialog1 = new TileMTileDialog1(this, "MTileDialog1", "", new System.Drawing.Point(0, 0), false);
			tile_MTileDialog1.AddChangedProperty("Text");
			tile_MTileDialog1.Size = new System.Drawing.Size(1196, 367);
			tile_MTileDialog1.AddChangedProperty("Size");
			this.Add(tile_MTileDialog1, true);
			tile_MTileDialog1.AddReferencedBy("tile_MTileDialog_ctrl_MPushButton_Click");
			tile_MTileDialog1.AddReferencedBy("tile_MTileDialog_ctrl_MCheckBox_CheckedChanged");
		}
