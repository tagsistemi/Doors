...
{
	public class TDBTElencoCF_EB_LocalData : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTElencoCF_EB_LocalData(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public MDataStr fld_Codice;

		public MDataStr fld_RagSoc;

		public MDataStr fld_Indirizzo;

		public MDataStr fld_CAP;

		public MDataStr fld_Citta;

		public MDataStr fld_Provincia;

		public MDataStr fld_Telefono;

		public MDataStr fld_EMail;

		public MDataStr fld_PartitaIva;

		public MDataStr fld_DestMerce;

		public MDataBool fld_Sel;

		public MDataStr fld_NoteElab;

		public override void CreateComponents()
		{
			this.AddLocalField("Codice", "string", 50);
			fld_Codice = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Codice"));
			this.Add(fld_Codice, false);
			this.AddLocalField("RagSoc", "string", 50);
			fld_RagSoc = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("RagSoc"));
			this.Add(fld_RagSoc, false);
			this.AddLocalField("Indirizzo", "string", 150);
			fld_Indirizzo = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Indirizzo"));
			this.Add(fld_Indirizzo, false);
			this.AddLocalField("CAP", "string", 50);
			fld_CAP = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CAP"));
			this.Add(fld_CAP, false);
			this.AddLocalField("Citta", "string", 150);
			fld_Citta = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Citta"));
			this.Add(fld_Citta, false);
			this.AddLocalField("Provincia", "string", 50);
			fld_Provincia = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Provincia"));
			this.Add(fld_Provincia, false);
			this.AddLocalField("Telefono", "string", 50);
			fld_Telefono = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Telefono"));
			this.Add(fld_Telefono, false);
			this.AddLocalField("EMail", "string", 200);
			fld_EMail = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("EMail"));
			this.Add(fld_EMail, false);
			this.AddLocalField("PartitaIva", "string", 50);
			fld_PartitaIva = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("PartitaIva"));
			this.Add(fld_PartitaIva, false);
			this.AddLocalField("DestMerce", "string", 250);
			fld_DestMerce = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("DestMerce"));
			this.Add(fld_DestMerce, false);
			this.AddLocalField("Sel", "bool", 1);
			fld_Sel = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("Sel"));
			this.Add(fld_Sel, false);
			this.AddLocalField("NoteElab", "string", 512);
			fld_NoteElab = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("NoteElab"));
			this.Add(fld_NoteElab, false);
		}
