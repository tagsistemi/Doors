...
{
	public class MDImportCustSupp : MDocument
	{
		public MDImportCustSupp(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTImpCF DBTImpCF;

		public DBTElencoCF DBTElencoCF;

		public DMCustSuppParameters DMCustSuppParameters;
		...
		{
			DBTImpCF = new DBTImpCF();
			this.AttachMaster(this.DBTImpCF);
			DBTElencoCF = new DBTElencoCF();
			this.AttachSlave(DBTElencoCF);
			DBTElencoCF.CheckDuplicateKey = false;
			DBTElencoCF.AddChangedProperty("CheckDuplicateKey");
			DMCustSuppParameters = new DMCustSuppParameters();
			this.Add(DMCustSuppParameters, false);
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(DBTElencoCF, "DBTElencoCF");
		}
