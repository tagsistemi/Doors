...
namespace Customization.Doors.Doors.DynamicDocuments.ImportCustSupp.ImportCustSupp
{
	public class TileMTileDialog1 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public BEDBTElencoCF ctrl_DBTElencoCF;

		public override void CreateComponents()
		{
			ctrl_DBTElencoCF = new BEDBTElencoCF(this, "DBTElencoCF", "BodyEdit", new System.Drawing.Point(0, 24), false);
			ctrl_DBTElencoCF.DataBinding = new DBTDataBinding(Document.DBTElencoCF);
			ctrl_DBTElencoCF.AddChangedProperty("DataBinding");
			ctrl_DBTElencoCF.AutoFill = true;
			ctrl_DBTElencoCF.AddChangedProperty("AutoFill");
			ctrl_DBTElencoCF.Size = new System.Drawing.Size(1196, 343);
			ctrl_DBTElencoCF.AddChangedProperty("Size");
			this.Add(ctrl_DBTElencoCF, true);
			ctrl_DBTElencoCF.AddReferencedBy("tile_MTileDialog_ctrl_MPushButton_Click");
			ctrl_DBTElencoCF.AddReferencedBy("tile_MTileDialog_ctrl_MCheckBox_CheckedChanged");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTElencoCF, "ctrl_DBTElencoCF");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTElencoCF = null;
		}
	}
}
