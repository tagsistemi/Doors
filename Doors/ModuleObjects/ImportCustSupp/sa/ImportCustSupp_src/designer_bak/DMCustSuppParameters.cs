...
{
	public class DMCustSuppParameters : Microarea.Framework.TBApplicationWrapper.MDataManager
	{
		public DMCustSuppParameters() : base("MA_CustSuppParameters", "CustSuppParameters", DocumentController.controller.Document)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TMA_CustSuppParameters;
			}
		}

		public TDMCustSuppParameters_MA_CustSuppParameters TMA_CustSuppParameters;

		public TDMCustSuppParameters_MA_CustSuppParameters CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDMCustSuppParameters_MA_CustSuppParameters)record;
		}

		public override void CreateComponents()
		{
			TMA_CustSuppParameters = new TDMCustSuppParameters_MA_CustSuppParameters(this.GetRecordPtr());
			this.Add(TMA_CustSuppParameters, false);
		}
