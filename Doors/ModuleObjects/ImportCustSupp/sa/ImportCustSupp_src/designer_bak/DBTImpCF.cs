...
{
	public class DBTImpCF : MDBTMaster
	{
		public DBTImpCF() : base("EB_LocalData", "ImpCF", DocumentController.controller.Document, false)
		{
		}

		public DBTImpCF(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTImpCF_EB_LocalData TEB_LocalData;
		...
		public TDBTImpCF_EB_LocalData OldTEB_LocalData;

		public virtual TDBTImpCF_EB_LocalData CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTImpCF_EB_LocalData)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTImpCF(dbtPtr);
		}

		public override void CreateComponents()
		{
			TEB_LocalData = new TDBTImpCF_EB_LocalData(this.GetRecordPtr());
			this.Add(TEB_LocalData, true);
			OldTEB_LocalData = new TDBTImpCF_EB_LocalData(this.GetOldRecordPtr());
