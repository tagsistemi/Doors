...
{
	[ReferenceDeclarationAttribute("BusinessObject", "Document.ERP.CustomersSuppliers.Documents.Customers", "MDCustomers")]
	[ReferenceDeclarationAttribute("BusinessObject", "Document.ERP.CustomersSuppliers.Documents.Suppliers", "MDSuppliers")]
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDImportCustSupp Document
		{
			get
			{
				return (MDImportCustSupp)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_ImportCustSupp = new MDImportCustSupp(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_ImportCustSupp;
		...
		public MDImportCustSupp document_ImportCustSupp;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_ImportCustSupp, false);
			this.Add(view_Dynamic, true);
			controller.BatchExecute += new System.EventHandler<Microarea.EasyBuilder.ControllerEventArgs>(DocumentController.controller.DocumentController_BatchExecute);
			controller.AddChangedEvent(new EventInfo("controller.BatchExecute", "DocumentController_BatchExecute", "System.EventHandler`1[Microarea.EasyBuilder.ControllerEventArgs]", "", true));
		}
