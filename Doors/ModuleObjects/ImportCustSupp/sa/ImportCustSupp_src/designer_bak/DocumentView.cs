...
{
	public class DocumentView : Microarea.EasyBuilder.MVC.DocumentView
	{
		public DocumentView(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public TileManagerMTileManager tileManager_MTileManager;

		public override void CreateComponents()
		{
			tileGroup_MTileGroup = new TileGroupMTileGroup(this, "MTileGroup", "", new System.Drawing.Point(0, 0), false);
			tileGroup_MTileGroup.Size = new System.Drawing.Size(1867, 633);
			tileGroup_MTileGroup.AddChangedProperty("Size");
			this.Add(tileGroup_MTileGroup, true);
			tileManager_MTileManager = new TileManagerMTileManager(this, "MTileManager", "", new System.Drawing.Point(0, 634), false);
			tileManager_MTileManager.Flex = 100;
			tileManager_MTileManager.AddChangedProperty("Flex");
			tileManager_MTileManager.Size = new System.Drawing.Size(1867, 633);
			tileManager_MTileManager.AddChangedProperty("Size");
			this.Add(tileManager_MTileManager, true);
			tileManager_MTileManager.AddReferencedBy("tile_MTileDialog_ctrl_MPushButton_Click");
			tileManager_MTileManager.AddReferencedBy("tile_MTileDialog_ctrl_MCheckBox_CheckedChanged");
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tileManager_MTileManager, "tileManager_MTileManager");
		}
