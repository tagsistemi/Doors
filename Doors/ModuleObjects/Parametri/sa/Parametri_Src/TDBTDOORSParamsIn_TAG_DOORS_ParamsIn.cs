...
{
	public class TDBTDOORSParamsIn_TAG_DOORS_ParamsIn : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSParamsIn_TAG_DOORS_ParamsIn(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataInt fld_idparam;

		public MDataStr fld_CatProd;
		...
		public override void CreateComponents()
		{
			...
			fld_idparam = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("idparam"));
			this.Add(fld_idparam, false);
			fld_CatProd = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatProd"));
			this.Add(fld_CatProd, false);
		}
