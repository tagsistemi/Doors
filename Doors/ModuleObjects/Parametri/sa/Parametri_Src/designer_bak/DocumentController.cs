...
namespace Customization.Doors.Doors.DynamicDocuments.Parametri.Parametri
{
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDParametri Document
		{
			get
			{
				return (MDParametri)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_Parametri = new MDParametri(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_Parametri;
		...
		public MDParametri document_Parametri;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_Parametri, true);
			document_Parametri.OnlyOneRecord = true;
			document_Parametri.AddChangedProperty("OnlyOneRecord");
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(document_Parametri, "document_Parametri");
		}
