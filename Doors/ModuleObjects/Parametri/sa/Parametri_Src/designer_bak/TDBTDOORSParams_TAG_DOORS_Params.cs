...
{
	public class TDBTDOORSParams_TAG_DOORS_Params : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSParams_TAG_DOORS_Params(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataInt fld_id;

		public MDataStr fld_Server;

		public MDataStr fld_Installazione;

		public MDataInt fld_Porta;

		public MDataStr fld_Company;

		public MDataStr fld_User;

		public MDataStr fld_Password;

		public MDataStr fld_UtenteMago;

		public MDataLng fld_ProgConf;

		public MDataStr fld_CatMercPorte;

		public MDataStr fld_CatMercTelai;

		public MDataStr fld_CatMercImbotti;

		public MDataStr fld_CatMercPannelli;

		public MDataStr fld_CatMercAccessori;

		public MDataStr fld_CatMercPanneliLav;

		public MDataStr fld_OperazioneFuoriMisura;

		public MDataStr fld_OpFuoriMisuraPrimaDi;

		public MDataBool fld_OpFuoriMIsuraUltima;

		public MDataStr fld_OpFuorimisuraDopoDi;

		public MDataStr fld_CatMercTelaiLav;

		public MDataStr fld_CatMercCoprifiliLav;

		public MDataStr fld_CatMercCfAlettaLunga;

		public MDataStr fld_CatMercFerramenta;

		public MDataStr fld_CatMercVetri;
		...
		public override void CreateComponents()
		{
			...
			fld_id = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("id"));
			this.Add(fld_id, false);
			fld_Server = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Server"));
			this.Add(fld_Server, false);
			fld_Installazione = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Installazione"));
			this.Add(fld_Installazione, false);
			fld_Porta = new Microarea.Framework.TBApplicationWrapper.MDataInt(this.GetFieldPtr("Porta"));
			this.Add(fld_Porta, false);
			fld_Company = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Company"));
			this.Add(fld_Company, false);
			fld_User = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("User"));
			this.Add(fld_User, false);
			fld_Password = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("Password"));
			this.Add(fld_Password, false);
			fld_UtenteMago = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("UtenteMago"));
			this.Add(fld_UtenteMago, false);
			fld_ProgConf = new Microarea.Framework.TBApplicationWrapper.MDataLng(this.GetFieldPtr("ProgConf"));
			this.Add(fld_ProgConf, false);
			fld_CatMercPorte = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercPorte"));
			this.Add(fld_CatMercPorte, false);
			fld_CatMercTelai = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercTelai"));
			this.Add(fld_CatMercTelai, false);
			fld_CatMercImbotti = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercImbotti"));
			this.Add(fld_CatMercImbotti, false);
			fld_CatMercPannelli = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercPannelli"));
			this.Add(fld_CatMercPannelli, false);
			fld_CatMercAccessori = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercAccessori"));
			this.Add(fld_CatMercAccessori, false);
			fld_CatMercPanneliLav = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercPanneliLav"));
			this.Add(fld_CatMercPanneliLav, false);
			fld_OperazioneFuoriMisura = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("OperazioneFuoriMisura"));
			this.Add(fld_OperazioneFuoriMisura, false);
			fld_OpFuoriMisuraPrimaDi = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("OpFuoriMisuraPrimaDi"));
			this.Add(fld_OpFuoriMisuraPrimaDi, false);
			fld_OpFuoriMIsuraUltima = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("OpFuoriMIsuraUltima"));
			this.Add(fld_OpFuoriMIsuraUltima, false);
			fld_OpFuorimisuraDopoDi = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("OpFuorimisuraDopoDi"));
			this.Add(fld_OpFuorimisuraDopoDi, false);
			fld_CatMercTelaiLav = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercTelaiLav"));
			this.Add(fld_CatMercTelaiLav, false);
			fld_CatMercCoprifiliLav = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercCoprifiliLav"));
			this.Add(fld_CatMercCoprifiliLav, false);
			fld_CatMercCfAlettaLunga = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercCfAlettaLunga"));
			this.Add(fld_CatMercCfAlettaLunga, false);
			fld_CatMercFerramenta = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercFerramenta"));
			this.Add(fld_CatMercFerramenta, false);
			fld_CatMercVetri = new Microarea.Framework.TBApplicationWrapper.MDataStr(this.GetFieldPtr("CatMercVetri"));
			this.Add(fld_CatMercVetri, false);
		}
		...
		public override void ClearComponents()
		{
			...
			fld_UtenteMago = null;
			fld_ProgConf = null;
			fld_CatMercPorte = null;
			fld_CatMercTelai = null;
			fld_CatMercImbotti = null;
			fld_CatMercPannelli = null;
			fld_CatMercAccessori = null;
			fld_CatMercPanneliLav = null;
			fld_OperazioneFuoriMisura = null;
			fld_OpFuoriMisuraPrimaDi = null;
			fld_OpFuoriMIsuraUltima = null;
			fld_OpFuorimisuraDopoDi = null;
			fld_CatMercTelaiLav = null;
			fld_CatMercCoprifiliLav = null;
			fld_CatMercCfAlettaLunga = null;
			fld_CatMercFerramenta = null;
			fld_CatMercVetri = null;
		}
	}
}
