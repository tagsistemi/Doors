...
{
	public class TileMTileDialog3 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialog3(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MParsedEdit ctrl_OperazioneFuoriMisura;

		public MParsedEdit ctrl_OpFuorimisuraDopoDi;

		public MCheckBox ctrl_OpFuoriMIsuraUltima;
		...
		public override void CreateComponents()
		{
			...
			ctrl_OperazioneFuoriMisura = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "OperazioneFuoriMisura", "StringEdit", new System.Drawing.Point(177, 45), false);
			ctrl_OperazioneFuoriMisura.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OperazioneFuoriMisura, Document.DBTDOORSParams);
			ctrl_OperazioneFuoriMisura.AddChangedProperty("DataBinding");
			ctrl_OperazioneFuoriMisura.AddChangedProperty("Caption");
			ctrl_OperazioneFuoriMisura.HotLink = Document.HKLOperations;
			ctrl_OperazioneFuoriMisura.AddChangedProperty("HotLink");
			ctrl_OperazioneFuoriMisura.Size = new System.Drawing.Size(158, 23);
			ctrl_OperazioneFuoriMisura.AddChangedProperty("Size");
			this.Add(ctrl_OperazioneFuoriMisura, true);
			ctrl_OpFuorimisuraDopoDi = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "OpFuorimisuraDopoDi", "StringEdit", new System.Drawing.Point(177, 86), false);
			ctrl_OpFuorimisuraDopoDi.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuorimisuraDopoDi, Document.DBTDOORSParams);
			ctrl_OpFuorimisuraDopoDi.AddChangedProperty("DataBinding");
			ctrl_OpFuorimisuraDopoDi.AddChangedProperty("Caption");
			ctrl_OpFuorimisuraDopoDi.HotLink = Document.HKLOperationsPrimaDi;
			ctrl_OpFuorimisuraDopoDi.AddChangedProperty("HotLink");
			ctrl_OpFuorimisuraDopoDi.Size = new System.Drawing.Size(156, 23);
			ctrl_OpFuorimisuraDopoDi.AddChangedProperty("Size");
			this.Add(ctrl_OpFuorimisuraDopoDi, true);
			ctrl_OpFuoriMIsuraUltima = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "OpFuoriMIsuraUltima", "CheckBox", new System.Drawing.Point(177, 119), false);
			ctrl_OpFuoriMIsuraUltima.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuoriMIsuraUltima, Document.DBTDOORSParams);
			ctrl_OpFuoriMIsuraUltima.AddChangedProperty("DataBinding");
			ctrl_OpFuoriMIsuraUltima.AddChangedProperty("Text");
			ctrl_OpFuoriMIsuraUltima.Size = new System.Drawing.Size(175, 23);
			ctrl_OpFuoriMIsuraUltima.AddChangedProperty("Size");
			this.Add(ctrl_OpFuoriMIsuraUltima, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_OperazioneFuoriMisura, "ctrl_OperazioneFuoriMisura");
			resources.ApplyResources(ctrl_OpFuorimisuraDopoDi, "ctrl_OpFuorimisuraDopoDi");
			resources.ApplyResources(ctrl_OpFuoriMIsuraUltima, "ctrl_OpFuoriMIsuraUltima");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_OperazioneFuoriMisura = null;
			ctrl_OpFuorimisuraDopoDi = null;
			ctrl_OpFuoriMIsuraUltima = null;
		}
	}
}
