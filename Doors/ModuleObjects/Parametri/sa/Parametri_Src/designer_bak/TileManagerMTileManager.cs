...
namespace Customization.Doors.Doors.DynamicDocuments.Parametri.Parametri
{
	public class TileManagerMTileManager : Microarea.Framework.TBApplicationWrapper.MTileManager
	{
		...
		public TileGroupMTileGroup tileGroup_MTileGroup;

		public TileGroupMTileGroupContatori tileGroup_MTileGroupContatori;

		public TileGroupMTileGroupCategorie tileGroup_MTileGroupCategorie;

		public TileGroupMTileGroupPannelli tileGroup_MTileGroupPannelli;

		public override void CreateComponents()
		{
			tileGroup_MTileGroup = new TileGroupMTileGroup(this, "MTileGroup", "", new System.Drawing.Point(0, 0), false);
			tileGroup_MTileGroup.AddChangedProperty("Text");
			tileGroup_MTileGroup.Size = new System.Drawing.Size(1687, 1268);
			tileGroup_MTileGroup.AddChangedProperty("Size");
			this.Add(tileGroup_MTileGroup, true);
			tileGroup_MTileGroupContatori = new TileGroupMTileGroupContatori(this, "MTileGroupContatori", "", new System.Drawing.Point(0, 0), false);
			tileGroup_MTileGroupContatori.AddChangedProperty("Text");
			tileGroup_MTileGroupContatori.Size = new System.Drawing.Size(1687, 1268);
			tileGroup_MTileGroupContatori.AddChangedProperty("Size");
			this.Add(tileGroup_MTileGroupContatori, true);
			tileGroup_MTileGroupCategorie = new TileGroupMTileGroupCategorie(this, "MTileGroupCategorie", "", new System.Drawing.Point(0, 0), false);
			tileGroup_MTileGroupCategorie.AddChangedProperty("Text");
			tileGroup_MTileGroupCategorie.Size = new System.Drawing.Size(1687, 1268);
			tileGroup_MTileGroupCategorie.AddChangedProperty("Size");
			this.Add(tileGroup_MTileGroupCategorie, true);
			tileGroup_MTileGroupPannelli = new TileGroupMTileGroupPannelli(this, "MTileGroupPannelli", "", new System.Drawing.Point(0, 0), false);
			tileGroup_MTileGroupPannelli.AddChangedProperty("Text");
			tileGroup_MTileGroupPannelli.TileStyle = Microarea.Framework.TBApplicationWrapper.ETileDialogStyle.Normal;
			tileGroup_MTileGroupPannelli.AddChangedProperty("TileStyle");
			tileGroup_MTileGroupPannelli.Size = new System.Drawing.Size(1685, 1266);
			tileGroup_MTileGroupPannelli.AddChangedProperty("Size");
			this.Add(tileGroup_MTileGroupPannelli, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(tileGroup_MTileGroup, "tileGroup_MTileGroup");
			resources.ApplyResources(tileGroup_MTileGroupContatori, "tileGroup_MTileGroupContatori");
			resources.ApplyResources(tileGroup_MTileGroupCategorie, "tileGroup_MTileGroupCategorie");
			resources.ApplyResources(tileGroup_MTileGroupPannelli, "tileGroup_MTileGroupPannelli");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			tileGroup_MTileGroup = null;
			tileGroup_MTileGroupContatori = null;
			tileGroup_MTileGroupCategorie = null;
			tileGroup_MTileGroupPannelli = null;
		}
	}
}
