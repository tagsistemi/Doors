...
namespace Customization.Doors.Doors.DynamicDocuments.Parametri.Parametri
{
	...
	{
		public void TTAG_DOORS_Params_fld_OpFuoriMIsuraUltima_ValueChanged(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				//Write your code between here
				if(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuoriMIsuraUltima)
				{
					Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuorimisuraDopoDi.Value = "";
					Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuorimisuraDopoDi.FireValueChanged();
					
					Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuorimisuraDopoDi.ReadOnly = true;
				}
				else
					Document.DBTDOORSParams.TTAG_DOORS_Params.fld_OpFuorimisuraDopoDi.ReadOnly = false;
