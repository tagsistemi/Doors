...
{
	public class TileGroupMTileGroupContatori : Microarea.Framework.TBApplicationWrapper.MTileGroup
	{
		public TileGroupMTileGroupContatori(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
