...
{
	public class TileMTileDialogParametriMl : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialogParametriMl(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MParsedEdit ctrl_Installazione;

		public MParsedEdit ctrl_Company;

		public MParsedEdit ctrl_Porta;

		public MParsedEdit ctrl_Password;

		public MParsedEdit ctrl_Server;

		public MParsedEdit ctrl_UtenteMago;

		public override void CreateComponents()
		{
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(3, 24), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 264);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Installazione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Installazione", "StringEdit", new System.Drawing.Point(180, 98), false);
			ctrl_Installazione.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_Installazione, Document.DBTDOORSParams);
			ctrl_Installazione.AddChangedProperty("Caption");
			ctrl_Installazione.Size = new System.Drawing.Size(175, 23);
			ctrl_Installazione.AddChangedProperty("Size");
			this.Add(ctrl_Installazione, true);
			ctrl_Company = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Company", "StringEdit", new System.Drawing.Point(180, 153), false);
			ctrl_Company.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_Company, Document.DBTDOORSParams);
			ctrl_Company.AddChangedProperty("Caption");
			ctrl_Company.Size = new System.Drawing.Size(175, 23);
			ctrl_Company.AddChangedProperty("Size");
			this.Add(ctrl_Company, true);
			ctrl_Porta = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Porta", "IntegerEdit", new System.Drawing.Point(180, 208), false);
			ctrl_Porta.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_Porta, Document.DBTDOORSParams);
			ctrl_Porta.AddChangedProperty("Caption");
			ctrl_Porta.Size = new System.Drawing.Size(175, 23);
			ctrl_Porta.AddChangedProperty("Size");
			this.Add(ctrl_Porta, true);
			ctrl_Password = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Password", "StringEdit", new System.Drawing.Point(180, 318), false);
			ctrl_Password.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_Password, Document.DBTDOORSParams);
			ctrl_Password.AddChangedProperty("Caption");
			ctrl_Password.Size = new System.Drawing.Size(175, 23);
			ctrl_Password.AddChangedProperty("Size");
			this.Add(ctrl_Password, true);
			ctrl_Server = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Server", "StringEdit", new System.Drawing.Point(180, 43), false);
			ctrl_Server.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_Server, Document.DBTDOORSParams);
			ctrl_Server.AddChangedProperty("Caption");
			ctrl_Server.Size = new System.Drawing.Size(175, 23);
			ctrl_Server.AddChangedProperty("Size");
			this.Add(ctrl_Server, true);
			ctrl_UtenteMago = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "UtenteMago", "StringEdit", new System.Drawing.Point(180, 263), false);
			ctrl_UtenteMago.DataBinding = new FieldDataBinding(Document.DBTDOORSParams.TTAG_DOORS_Params.fld_UtenteMago, Document.DBTDOORSParams);
			ctrl_UtenteMago.AddChangedProperty("DataBinding");
			ctrl_UtenteMago.AddChangedProperty("Caption");
			ctrl_UtenteMago.Size = new System.Drawing.Size(175, 23);
			ctrl_UtenteMago.AddChangedProperty("Size");
			this.Add(ctrl_UtenteMago, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_Installazione, "ctrl_Installazione");
			resources.ApplyResources(ctrl_Company, "ctrl_Company");
			resources.ApplyResources(ctrl_Porta, "ctrl_Porta");
			resources.ApplyResources(ctrl_Password, "ctrl_Password");
			resources.ApplyResources(ctrl_Server, "ctrl_Server");
			resources.ApplyResources(ctrl_UtenteMago, "ctrl_UtenteMago");
		}
		...
		public override void ClearComponents()
		{
			...
			ctrl_Installazione = null;
			ctrl_Company = null;
			ctrl_Porta = null;
			ctrl_Password = null;
			ctrl_Server = null;
			ctrl_UtenteMago = null;
		}
	}
}
