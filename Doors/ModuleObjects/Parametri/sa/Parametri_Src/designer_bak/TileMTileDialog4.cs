...
{
	public class TileMTileDialog4 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		public TileMTileDialog4(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MParsedStatic ctrl_MParsedStatic;
		...
		public override void CreateComponents()
		{
			...
			ctrl_MParsedStatic = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "MParsedStatic", "StringStatic", new System.Drawing.Point(232, 73), false);
			ctrl_MParsedStatic.AddChangedProperty("Caption");
			ctrl_MParsedStatic.Size = new System.Drawing.Size(175, 23);
			ctrl_MParsedStatic.AddChangedProperty("Size");
			this.Add(ctrl_MParsedStatic, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_MParsedStatic, "ctrl_MParsedStatic");
		}
