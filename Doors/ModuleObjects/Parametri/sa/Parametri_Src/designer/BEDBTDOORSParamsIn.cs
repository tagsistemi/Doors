...
{
	public class BEDBTDOORSParamsIn : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSParamsIn(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}
		...
		public MBodyEditColumn col_idparam;

		public MBodyEditColumn col_CatProd;

		public override void CreateComponents()
		{
			col_idparam = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "idparam", "IntegerEdit", new System.Drawing.Point(0, 0), false);
			col_idparam.DataBinding = new FieldDataBinding(Document.DBTDOORSParamsIn.TTAG_DOORS_ParamsIn.fld_idparam, Document.DBTDOORSParamsIn);
			col_idparam.ColPos = 0;
			col_idparam.AddChangedProperty("ColPos");
			col_idparam.SizeInChars = new System.Drawing.Size(1, 1);
			col_idparam.AddChangedProperty("SizeInChars");
			col_idparam.TitleTextColor = System.Drawing.Color.Black;
			col_idparam.AddChangedProperty("TitleTextColor");
			col_idparam.TitleBackColor = System.Drawing.Color.Transparent;
			col_idparam.AddChangedProperty("TitleBackColor");
			col_idparam.Visible = false;
			col_idparam.AddChangedProperty("Visible");
			col_idparam.AddChangedProperty("ColumnTitle");
			this.Add(col_idparam, false);
			col_CatProd = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "CatProd", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_CatProd.DataBinding = new FieldDataBinding(Document.DBTDOORSParamsIn.TTAG_DOORS_ParamsIn.fld_CatProd, Document.DBTDOORSParamsIn);
			col_CatProd.ColPos = 1;
			col_CatProd.AddChangedProperty("ColPos");
			col_CatProd.HotLink = Document.HKLProductCtg;
			col_CatProd.AddChangedProperty("HotLink");
			col_CatProd.Width = 122;
			col_CatProd.AddChangedProperty("Width");
			col_CatProd.SizeInChars = new System.Drawing.Size(8, 1);
			col_CatProd.AddChangedProperty("SizeInChars");
			col_CatProd.TitleTextColor = System.Drawing.Color.Black;
			col_CatProd.AddChangedProperty("TitleTextColor");
			col_CatProd.TitleBackColor = System.Drawing.Color.Transparent;
			col_CatProd.AddChangedProperty("TitleBackColor");
			col_CatProd.Visible = true;
			col_CatProd.AddChangedProperty("Visible");
			col_CatProd.AddChangedProperty("ColumnTitle");
			this.Add(col_CatProd, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(col_idparam, "col_idparam");
			resources.ApplyResources(col_CatProd, "col_CatProd");
		}
