...
namespace Customization.Doors.Doors.DynamicDocuments.Parametri.Parametri
{
	public class TileMTileDialog2 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public BEDBTDOORSParamsIn ctrl_DBTDOORSParamsIn;

		public override void CreateComponents()
		{
			ctrl_DBTDOORSParamsIn = new BEDBTDOORSParamsIn(this, "DBTDOORSParamsIn", "BodyEdit", new System.Drawing.Point(0, 22), false);
			ctrl_DBTDOORSParamsIn.DataBinding = new DBTDataBinding(Document.DBTDOORSParamsIn);
			ctrl_DBTDOORSParamsIn.AutoFill = false;
			ctrl_DBTDOORSParamsIn.AddChangedProperty("AutoFill");
			ctrl_DBTDOORSParamsIn.RightStretch = false;
			ctrl_DBTDOORSParamsIn.AddChangedProperty("RightStretch");
			ctrl_DBTDOORSParamsIn.BottomStretch = false;
			ctrl_DBTDOORSParamsIn.AddChangedProperty("BottomStretch");
			ctrl_DBTDOORSParamsIn.Size = new System.Drawing.Size(841, 400);
			ctrl_DBTDOORSParamsIn.AddChangedProperty("Size");
			this.Add(ctrl_DBTDOORSParamsIn, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_DBTDOORSParamsIn, "ctrl_DBTDOORSParamsIn");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			ctrl_DBTDOORSParamsIn = null;
		}
	}
}
