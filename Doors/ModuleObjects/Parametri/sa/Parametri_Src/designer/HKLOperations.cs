...
{
	public class HKLOperations : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLOperations() : base("MA_Operations", "Operations", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLOperations_MA_Operations TMA_Operations;

		public virtual THKLOperations_MA_Operations CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLOperations_MA_Operations)record;
		}

		public MHotLinkSearch HKLOperations_ByKey;

		public MHotLinkSearch HKLOperations_ByDescription;

		public override void CreateComponents()
		{
			TMA_Operations = new THKLOperations_MA_Operations(this.GetRecordPtr());
			this.Add(TMA_Operations, false);
			HKLOperations_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations_ByKey.UseInComboBox = true;
			HKLOperations_ByKey.AddChangedProperty("UseInComboBox");
			HKLOperations_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLOperations_ByKey.AddChangedProperty("AssociatedButton");
			HKLOperations_ByKey.FieldName = "Operation";
			HKLOperations_ByKey.AddChangedProperty("FieldName");
			HKLOperations_ByKey.AddChangedProperty("Description");
			HKLOperations_ByKey.Name = "ByKey";
			HKLOperations_ByKey.AddChangedProperty("Name");
			this.Add(HKLOperations_ByKey, true);
			HKLOperations_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, false);
			HKLOperations_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLOperations_ByDescription.AddChangedProperty("AssociatedButton");
			HKLOperations_ByDescription.FieldName = "Description";
			HKLOperations_ByDescription.AddChangedProperty("FieldName");
			HKLOperations_ByDescription.AddChangedProperty("Description");
			HKLOperations_ByDescription.Name = "ByDescription";
			HKLOperations_ByDescription.AddChangedProperty("Name");
			this.Add(HKLOperations_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLOperations_ByKey, "HKLOperations_ByKey");
			resources.ApplyResources(HKLOperations_ByDescription, "HKLOperations_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			TMA_Operations = null;
			HKLOperations_ByKey = null;
			HKLOperations_ByDescription = null;
		}
	}
}
