...
{
	public class MDParametri : MDocument
	{
		public MDParametri(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSParams DBTDOORSParams;

		public HKLCommodityCtg HKLCommodityCtg;

		public HKLCommodityCtgPorte HKLCommodityCtgPorte;

		public HKLCommodityCtgTelai HKLCommodityCtgTelai;

		public HKLCommodityCtgPannelli HKLCommodityCtgPannelli;

		public HKLCommodityCtgAccessori HKLCommodityCtgAccessori;

		public HKLCommodityCtgPannelliLav HKLCommodityCtgPannelliLav;

		public HKLOperations HKLOperations;

		public HKLOperationsPrimaDi HKLOperationsPrimaDi;

		public HKLCommodityCtgTelaiLav HKLCommodityCtgTelaiLav;

		public HKLCommodityCtgCoprifiliLav HKLCommodityCtgCoprifiliLav;

		public HKLCommodityCtgCfAl HKLCommodityCtgCfAl;

		public HKLCommodityCtgFerramenta HKLCommodityCtgFerramenta;

		public DBTDOORSParamsIn DBTDOORSParamsIn;

		public HKLProductCtg HKLProductCtg;

		public HKLCommodityCtgVetri HKLCommodityCtgVetri;
		...
		{
			DBTDOORSParams = new DBTDOORSParams();
			this.AttachMaster(this.DBTDOORSParams);
			HKLCommodityCtg = new HKLCommodityCtg();
			this.Add(this.HKLCommodityCtg, true);
			HKLCommodityCtg.DataMustExist = true;
			HKLCommodityCtg.AddChangedProperty("DataMustExist");
			HKLCommodityCtgPorte = new HKLCommodityCtgPorte();
			this.Add(this.HKLCommodityCtgPorte, true);
			HKLCommodityCtgPorte.DataMustExist = true;
			HKLCommodityCtgPorte.AddChangedProperty("DataMustExist");
			HKLCommodityCtgTelai = new HKLCommodityCtgTelai();
			this.Add(this.HKLCommodityCtgTelai, true);
			HKLCommodityCtgTelai.DataMustExist = true;
			HKLCommodityCtgTelai.AddChangedProperty("DataMustExist");
			HKLCommodityCtgPannelli = new HKLCommodityCtgPannelli();
			this.Add(this.HKLCommodityCtgPannelli, true);
			HKLCommodityCtgPannelli.DataMustExist = true;
			HKLCommodityCtgPannelli.AddChangedProperty("DataMustExist");
			HKLCommodityCtgAccessori = new HKLCommodityCtgAccessori();
			this.Add(this.HKLCommodityCtgAccessori, true);
			HKLCommodityCtgAccessori.DataMustExist = true;
			HKLCommodityCtgAccessori.AddChangedProperty("DataMustExist");
			HKLCommodityCtgPannelliLav = new HKLCommodityCtgPannelliLav();
			this.Add(this.HKLCommodityCtgPannelliLav, true);
			HKLCommodityCtgPannelliLav.DataMustExist = true;
			HKLCommodityCtgPannelliLav.AddChangedProperty("DataMustExist");
			HKLOperations = new HKLOperations();
			this.Add(this.HKLOperations, true);
			HKLOperations.DataMustExist = true;
			HKLOperations.AddChangedProperty("DataMustExist");
			HKLOperations.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.Operations";
			HKLOperations.AddChangedProperty("PublicationNamespace");
			HKLOperationsPrimaDi = new HKLOperationsPrimaDi();
			this.Add(this.HKLOperationsPrimaDi, true);
			HKLOperationsPrimaDi.DataMustExist = true;
			HKLOperationsPrimaDi.AddChangedProperty("DataMustExist");
			HKLOperationsPrimaDi.PublicationNamespace = "HotKeyLink.Doors.Doors.DynamicDocuments.OperationsPrimaDi";
			HKLOperationsPrimaDi.AddChangedProperty("PublicationNamespace");
			HKLCommodityCtgTelaiLav = new HKLCommodityCtgTelaiLav();
			this.Add(this.HKLCommodityCtgTelaiLav, true);
			HKLCommodityCtgTelaiLav.DataMustExist = true;
			HKLCommodityCtgTelaiLav.AddChangedProperty("DataMustExist");
			HKLCommodityCtgCoprifiliLav = new HKLCommodityCtgCoprifiliLav();
			this.Add(this.HKLCommodityCtgCoprifiliLav, true);
			HKLCommodityCtgCoprifiliLav.DataMustExist = true;
			HKLCommodityCtgCoprifiliLav.AddChangedProperty("DataMustExist");
			HKLCommodityCtgCfAl = new HKLCommodityCtgCfAl();
			this.Add(this.HKLCommodityCtgCfAl, true);
			HKLCommodityCtgCfAl.DataMustExist = true;
			HKLCommodityCtgCfAl.AddChangedProperty("DataMustExist");
			HKLCommodityCtgFerramenta = new HKLCommodityCtgFerramenta();
			this.Add(this.HKLCommodityCtgFerramenta, true);
			HKLCommodityCtgFerramenta.DataMustExist = true;
			HKLCommodityCtgFerramenta.AddChangedProperty("DataMustExist");
			DBTDOORSParamsIn = new DBTDOORSParamsIn();
			this.AttachSlave(DBTDOORSParamsIn);
			DBTDOORSParamsIn.AddMasterForeignKey(DBTDOORSParamsIn.TTAG_DOORS_ParamsIn.fld_idparam, "id");
			...
			HKLCommodityCtgVetri = new HKLCommodityCtgVetri();
			this.Add(this.HKLCommodityCtgVetri, true);
			HKLCommodityCtgVetri.DataMustExist = true;
			HKLCommodityCtgVetri.AddChangedProperty("DataMustExist");
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLCommodityCtg, "HKLCommodityCtg");
			resources.ApplyResources(HKLCommodityCtgPorte, "HKLCommodityCtgPorte");
			resources.ApplyResources(HKLCommodityCtgTelai, "HKLCommodityCtgTelai");
			resources.ApplyResources(HKLCommodityCtgPannelli, "HKLCommodityCtgPannelli");
			resources.ApplyResources(HKLCommodityCtgAccessori, "HKLCommodityCtgAccessori");
			resources.ApplyResources(HKLCommodityCtgPannelliLav, "HKLCommodityCtgPannelliLav");
			resources.ApplyResources(HKLOperations, "HKLOperations");
			resources.ApplyResources(HKLOperationsPrimaDi, "HKLOperationsPrimaDi");
			resources.ApplyResources(HKLCommodityCtgTelaiLav, "HKLCommodityCtgTelaiLav");
			resources.ApplyResources(HKLCommodityCtgCoprifiliLav, "HKLCommodityCtgCoprifiliLav");
			resources.ApplyResources(HKLCommodityCtgCfAl, "HKLCommodityCtgCfAl");
			resources.ApplyResources(HKLCommodityCtgFerramenta, "HKLCommodityCtgFerramenta");
			resources.ApplyResources(HKLProductCtg, "HKLProductCtg");
			resources.ApplyResources(HKLCommodityCtgVetri, "HKLCommodityCtgVetri");
		}
		...
		public override void ClearComponents()
		{
			...
			DBTDOORSParams = null;
			HKLCommodityCtg = null;
			HKLCommodityCtgPorte = null;
			HKLCommodityCtgTelai = null;
			HKLCommodityCtgPannelli = null;
			HKLCommodityCtgAccessori = null;
			HKLCommodityCtgPannelliLav = null;
			HKLOperations = null;
			HKLOperationsPrimaDi = null;
			HKLCommodityCtgTelaiLav = null;
			HKLCommodityCtgCoprifiliLav = null;
			HKLCommodityCtgCfAl = null;
			HKLCommodityCtgFerramenta = null;
			DBTDOORSParamsIn = null;
			HKLProductCtg = null;
			HKLCommodityCtgVetri = null;
			fld__DEBUG = null;
			fld_FormMode = null;
