...
{
	public class DBTDOORSParamsIn : MDBTSlaveBuffered
	{
		public DBTDOORSParamsIn() : base("TAG_DOORS_ParamsIn", "DOORSParamsIn", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSParamsIn(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_ParamsIn;
			}
		}

		public TDBTDOORSParamsIn_TAG_DOORS_ParamsIn TTAG_DOORS_ParamsIn;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_ParamsIn;
			}
		}

		public TDBTDOORSParamsIn_TAG_DOORS_ParamsIn OldTTAG_DOORS_ParamsIn;

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSParamsIn(dbtPtr);
		}

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn GetCurrentRow()
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn AddRow()
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)this.AddRecord();
		}

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn InsertRow(int rowNumber)
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn GetRow(int rowNumber)
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSParamsIn_TAG_DOORS_ParamsIn GetOldRow(int rowNumber)
		{
			return (TDBTDOORSParamsIn_TAG_DOORS_ParamsIn)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_ParamsIn = new TDBTDOORSParamsIn_TAG_DOORS_ParamsIn(this.GetRecordPtr());
			this.Add(TTAG_DOORS_ParamsIn, true);
			OldTTAG_DOORS_ParamsIn = new TDBTDOORSParamsIn_TAG_DOORS_ParamsIn(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_ParamsIn, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_ParamsIn = null;
			OldTTAG_DOORS_ParamsIn = null;
		}
	}
}
