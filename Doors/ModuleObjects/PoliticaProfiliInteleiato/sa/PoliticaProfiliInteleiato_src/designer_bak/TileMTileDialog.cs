...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaProfiliInteleiato.PoliticaProfiliInteleiato
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MParsedEdit ctrl_Item;

		public MParsedEdit ctrl_Quantita;

		public override void CreateComponents()
		{
			ctrl_Description = new Microarea.Framework.TBApplicationWrapper.MParsedStatic(this, "Description", "StringStatic", new System.Drawing.Point(175, 83), false);
			ctrl_Description.DataBinding = new FieldDataBinding(Document.HKLItems.TMA_Items.fld_Description, Document.HKLItems);
			ctrl_Description.AddChangedProperty("Caption");
			ctrl_Description.Border = true;
			ctrl_Description.AddChangedProperty("Border");
			ctrl_Description.Size = new System.Drawing.Size(355, 23);
			...
			ctrl_IDC_STATIC_AREA = new Microarea.Framework.TBApplicationWrapper.GenericGroupBox(this, "IDC_STATIC_AREA", "Button", new System.Drawing.Point(0, 27), new System.Drawing.Point(0, 0), false);
			ctrl_IDC_STATIC_AREA.Size = new System.Drawing.Size(175, 129);
			ctrl_IDC_STATIC_AREA.AddChangedProperty("Size");
			this.Add(ctrl_IDC_STATIC_AREA, true);
			ctrl_Item = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Item", "StringEdit", new System.Drawing.Point(175, 47), false);
			ctrl_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_Item, Document.DBTDOORSPolIntela);
			ctrl_Item.AddChangedProperty("Caption");
			ctrl_Item.HotLink = Document.HKLItems;
			ctrl_Item.AddChangedProperty("HotLink");
			ctrl_Item.Size = new System.Drawing.Size(156, 23);
			ctrl_Item.AddChangedProperty("Size");
			this.Add(ctrl_Item, true);
			ctrl_Quantita = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Quantita", "QuantityEdit", new System.Drawing.Point(176, 118), false);
			ctrl_Quantita.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_Quantita, Document.DBTDOORSPolIntela);
			ctrl_Quantita.AddChangedProperty("DataBinding");
			ctrl_Quantita.AddChangedProperty("Caption");
			ctrl_Quantita.Size = new System.Drawing.Size(155, 23);
			ctrl_Quantita.AddChangedProperty("Size");
			this.Add(ctrl_Quantita, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_Item, "ctrl_Item");
			resources.ApplyResources(ctrl_Quantita, "ctrl_Quantita");
		}
