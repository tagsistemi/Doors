...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaProfiliInteleiato.PoliticaProfiliInteleiato
{
	public partial class DocumentController : Microarea.EasyBuilder.MVC.DocumentController
	{
		...
		public new MDPoliticaProfiliInteleiato Document
		{
			get
			{
				return (MDPoliticaProfiliInteleiato)base.document;
			}
		}
		...
		public DocumentController(Microarea.TaskBuilderNet.Core.Generic.NameSpace nameSpace, System.IntPtr formHandle, System.IntPtr documentHandle) : base(nameSpace)
		{
			...
			document_PoliticaProfiliInteleiato = new MDPoliticaProfiliInteleiato(documentHandle);
			view_Dynamic = new DocumentView(formHandle);
			this.document = document_PoliticaProfiliInteleiato;
		...
		public MDPoliticaProfiliInteleiato document_PoliticaProfiliInteleiato;

		public DocumentView view_Dynamic;

		public override void CreateComponents()
		{
			this.Add(document_PoliticaProfiliInteleiato, true);
		...
		public override void ClearComponents()
		{
			...
			oldController = null;
			document_PoliticaProfiliInteleiato = null;
			view_Dynamic = null;
		}
	}
}
