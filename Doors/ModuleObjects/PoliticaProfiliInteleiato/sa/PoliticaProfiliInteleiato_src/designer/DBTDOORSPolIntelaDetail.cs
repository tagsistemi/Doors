...
{
	public class DBTDOORSPolIntelaDetail : MDBTSlaveBuffered
	{
		public DBTDOORSPolIntelaDetail() : base("TAG_DOORS_PolIntelaDetail", "DOORSPolIntelaDetail", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSPolIntelaDetail(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord Record
		{
			get
			{
				return TTAG_DOORS_PolIntelaDetail;
			}
		}

		public TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail TTAG_DOORS_PolIntelaDetail;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_PolIntelaDetail;
			}
		}

		public TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail OldTTAG_DOORS_PolIntelaDetail;

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSPolIntelaDetail(dbtPtr);
		}

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail GetCurrentRow()
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)this.GetCurrentRecord();
		}

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail AddRow()
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)this.AddRecord();
		}

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail InsertRow(int rowNumber)
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)this.InsertRecord(rowNumber);
		}

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail GetRow(int rowNumber)
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)this.GetRecord(rowNumber);
		}

		public virtual TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail GetOldRow(int rowNumber)
		{
			return (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)this.GetOldRecord(rowNumber);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_PolIntelaDetail = new TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail(this.GetRecordPtr());
			this.Add(TTAG_DOORS_PolIntelaDetail, true);
			OldTTAG_DOORS_PolIntelaDetail = new TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_PolIntelaDetail, true);
		}
		...
		public override void ClearComponents()
		{
			...
			TTAG_DOORS_PolIntelaDetail = null;
			OldTTAG_DOORS_PolIntelaDetail = null;
		}
	}
}
