...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaProfiliInteleiato.PoliticaProfiliInteleiato
{
	public partial class DocumentController
	{
		...
		public void Document_HKLItemsWithBOM_Queried(Object sender, EasyBuilderEventArgs e)
		{
			try
			{
				...
				{
					Document.DBTDOORSPolIntelaDetail.GetCurrentRow().fld_DescriDistinta.Value =  Document.HKLItemsWithBOM.TMA_BillOfMaterials.fld_Description.Value;
				}
				//and here
			}
		...
		public void Document_DBTDOORSPolIntelaDetail_AuxColumnsPrepared(Object sender, Microarea.Framework.TBApplicationWrapper.RowEventArgs e)
		{
			try
			{
				TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail record = (TDBTDOORSPolIntelaDetail_TAG_DOORS_PolIntelaDetail)e.Record;
				//Write your code between here
				if(record != null)
				{
					Document.HKLItemsWithBOM.FindRecord(record.fld_Distinta);
					record.fld_DescriDistinta.Value =  Document.HKLItemsWithBOM.TMA_BillOfMaterials.fld_Description.Value;
					record.fld_DescriDistinta.ReadOnly = true;
				}
