...
{
	public class BEDBTDOORSPolIntelaDetail : Microarea.Framework.TBApplicationWrapper.MBodyEdit
	{
		public BEDBTDOORSPolIntelaDetail(Microarea.TaskBuilderNet.Interfaces.View.IWindowWrapperContainer parentWindow, string controlName, string controlClass, System.Drawing.Point location, bool hasCodeBehind) : base(parentWindow, controlName, controlClass, location, hasCodeBehind)
		{
		}

		[Microarea.TaskBuilderNet.Core.EasyBuilder.PreserveFieldAttribute]
		public new MDPoliticaProfiliInteleiato Document
		{
			get
			{
				return (MDPoliticaProfiliInteleiato)DocumentController.controller.Document;
			}
		}

		public MBodyEditColumn col_Item;

		public MBodyEditColumn col_Distinta;

		public MBodyEditColumn col_HDa;

		public MBodyEditColumn col_HA;

		public MBodyEditColumn col_LDa;

		public MBodyEditColumn col_LA;

		public MBodyEditColumn col_DescriDistinta;
		...
		public override void CreateComponents()
		{
			...
			col_Item.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_Item, Document.DBTDOORSPolIntelaDetail);
			col_Item.ColPos = 0;
			...
			col_Distinta = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "Distinta", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_Distinta.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_Distinta, Document.DBTDOORSPolIntelaDetail);
			col_Distinta.ColPos = 1;
			col_Distinta.AddChangedProperty("ColPos");
			col_Distinta.HotLink = Document.HKLItemsWithBOM;
			col_Distinta.AddChangedProperty("HotLink");
			col_Distinta.SizeInChars = new System.Drawing.Size(21, 1);
			col_Distinta.AddChangedProperty("SizeInChars");
			col_Distinta.TitleTextColor = System.Drawing.Color.Black;
			col_Distinta.AddChangedProperty("TitleTextColor");
			col_Distinta.TitleBackColor = System.Drawing.Color.Transparent;
			col_Distinta.AddChangedProperty("TitleBackColor");
			col_Distinta.Visible = true;
			col_Distinta.AddChangedProperty("Visible");
			col_Distinta.AddChangedProperty("ColumnTitle");
			this.Add(col_Distinta, false);
			col_HDa = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "HDa", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_HDa.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_HDa, Document.DBTDOORSPolIntelaDetail);
			col_HDa.ColPos = 2;
			col_HDa.AddChangedProperty("ColPos");
			col_HDa.SizeInChars = new System.Drawing.Size(1, 1);
			col_HDa.AddChangedProperty("SizeInChars");
			col_HDa.TitleTextColor = System.Drawing.Color.Black;
			col_HDa.AddChangedProperty("TitleTextColor");
			col_HDa.TitleBackColor = System.Drawing.Color.Transparent;
			col_HDa.AddChangedProperty("TitleBackColor");
			col_HDa.Visible = false;
			col_HDa.AddChangedProperty("Visible");
			col_HDa.AddChangedProperty("ColumnTitle");
			this.Add(col_HDa, false);
			col_HA = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "HA", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_HA.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_HA, Document.DBTDOORSPolIntelaDetail);
			col_HA.ColPos = 3;
			col_HA.AddChangedProperty("ColPos");
			col_HA.SizeInChars = new System.Drawing.Size(1, 1);
			col_HA.AddChangedProperty("SizeInChars");
			col_HA.TitleTextColor = System.Drawing.Color.Black;
			col_HA.AddChangedProperty("TitleTextColor");
			col_HA.TitleBackColor = System.Drawing.Color.Transparent;
			col_HA.AddChangedProperty("TitleBackColor");
			col_HA.Visible = false;
			col_HA.AddChangedProperty("Visible");
			col_HA.AddChangedProperty("ColumnTitle");
			this.Add(col_HA, false);
			col_LDa = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "LDa", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_LDa.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_LDa, Document.DBTDOORSPolIntelaDetail);
			col_LDa.ColPos = 4;
			col_LDa.AddChangedProperty("ColPos");
			col_LDa.SizeInChars = new System.Drawing.Size(1, 1);
			col_LDa.AddChangedProperty("SizeInChars");
			col_LDa.TitleTextColor = System.Drawing.Color.Black;
			col_LDa.AddChangedProperty("TitleTextColor");
			col_LDa.TitleBackColor = System.Drawing.Color.Transparent;
			col_LDa.AddChangedProperty("TitleBackColor");
			col_LDa.Visible = false;
			col_LDa.AddChangedProperty("Visible");
			col_LDa.AddChangedProperty("ColumnTitle");
			this.Add(col_LDa, false);
			col_LA = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "LA", "DoubleEdit", new System.Drawing.Point(0, 0), false);
			col_LA.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_LA, Document.DBTDOORSPolIntelaDetail);
			col_LA.ColPos = 5;
			col_LA.AddChangedProperty("ColPos");
			col_LA.SizeInChars = new System.Drawing.Size(1, 1);
			col_LA.AddChangedProperty("SizeInChars");
			col_LA.TitleTextColor = System.Drawing.Color.Black;
			col_LA.AddChangedProperty("TitleTextColor");
			col_LA.TitleBackColor = System.Drawing.Color.Transparent;
			col_LA.AddChangedProperty("TitleBackColor");
			col_LA.Visible = false;
			col_LA.AddChangedProperty("Visible");
			col_LA.AddChangedProperty("ColumnTitle");
			this.Add(col_LA, false);
			col_DescriDistinta = new Microarea.Framework.TBApplicationWrapper.MBodyEditColumn(this, "DescriDistinta", "StringEdit", new System.Drawing.Point(0, 0), false);
			col_DescriDistinta.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_DescriDistinta, Document.DBTDOORSPolIntelaDetail);
			col_DescriDistinta.ColPos = 6;
			col_DescriDistinta.AddChangedProperty("ColPos");
			col_DescriDistinta.SizeInChars = new System.Drawing.Size(120, 1);
			col_DescriDistinta.AddChangedProperty("SizeInChars");
			col_DescriDistinta.TitleTextColor = System.Drawing.Color.Black;
			col_DescriDistinta.AddChangedProperty("TitleTextColor");
			col_DescriDistinta.TitleBackColor = System.Drawing.Color.Transparent;
			col_DescriDistinta.AddChangedProperty("TitleBackColor");
			col_DescriDistinta.Visible = true;
			col_DescriDistinta.AddChangedProperty("Visible");
			col_DescriDistinta.AddChangedProperty("ColumnTitle");
			this.Add(col_DescriDistinta, false);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(col_Distinta, "col_Distinta");
			resources.ApplyResources(col_HDa, "col_HDa");
			resources.ApplyResources(col_HA, "col_HA");
			resources.ApplyResources(col_LDa, "col_LDa");
			resources.ApplyResources(col_LA, "col_LA");
			resources.ApplyResources(col_DescriDistinta, "col_DescriDistinta");
		}
