...
namespace Customization.Doors.Doors.DynamicDocuments.PoliticaProfiliInteleiato.PoliticaProfiliInteleiato
{
	public class TileMTileDialog1 : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public MCheckBox ctrl_FindH;

		public MParsedEdit ctrl_HA;

		public MParsedEdit ctrl_HDa;

		public MCheckBox ctrl_FindL;

		public MParsedEdit ctrl_LDa;

		public MParsedEdit ctrl_LA;
		...
		public override void CreateComponents()
		{
			...
			ctrl_FindH = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "FindH", "CheckBox", new System.Drawing.Point(177, 124), false);
			ctrl_FindH.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_FindH, Document.DBTDOORSPolIntela);
			ctrl_FindH.AddChangedProperty("Text");
			ctrl_FindH.Size = new System.Drawing.Size(139, 23);
			ctrl_FindH.AddChangedProperty("Size");
			MCheckBoxProperties ctrl_FindH_MCheckBoxProperties = (MCheckBoxProperties)ctrl_FindH.Extensions["MCheckBoxProperties"];
			ctrl_FindH_MCheckBoxProperties.LabelOnLeft = false;
			ctrl_FindH_MCheckBoxProperties.AddChangedProperty("LabelOnLeft");
			this.Add(ctrl_FindH, true);
			ctrl_HA = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "HA", "DoubleEdit", new System.Drawing.Point(177, 179), false);
			ctrl_HA.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_HA, Document.DBTDOORSPolIntela);
			ctrl_HA.AddChangedProperty("Caption");
			ctrl_HA.TabOrder = 1;
			ctrl_HA.AddChangedProperty("TabOrder");
			ctrl_HA.Size = new System.Drawing.Size(84, 23);
			ctrl_HA.AddChangedProperty("Size");
			this.Add(ctrl_HA, true);
			ctrl_HDa = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "HDa", "DoubleEdit", new System.Drawing.Point(177, 152), false);
			ctrl_HDa.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_HDa, Document.DBTDOORSPolIntela);
			ctrl_HDa.AddChangedProperty("Caption");
			ctrl_HDa.Size = new System.Drawing.Size(84, 23);
			ctrl_HDa.AddChangedProperty("Size");
			this.Add(ctrl_HDa, true);
			ctrl_FindL = new Microarea.Framework.TBApplicationWrapper.MCheckBox(this, "FindL", "CheckBox", new System.Drawing.Point(177, 37), false);
			ctrl_FindL.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_FindL, Document.DBTDOORSPolIntela);
			ctrl_FindL.AddChangedProperty("Text");
			ctrl_FindL.Size = new System.Drawing.Size(139, 23);
			ctrl_FindL.AddChangedProperty("Size");
			MCheckBoxProperties ctrl_FindL_MCheckBoxProperties = (MCheckBoxProperties)ctrl_FindL.Extensions["MCheckBoxProperties"];
			ctrl_FindL_MCheckBoxProperties.LabelOnLeft = false;
			ctrl_FindL_MCheckBoxProperties.AddChangedProperty("LabelOnLeft");
			this.Add(ctrl_FindL, true);
			ctrl_LDa = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "LDa", "DoubleEdit", new System.Drawing.Point(177, 60), false);
			ctrl_LDa.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_LDa, Document.DBTDOORSPolIntela);
			ctrl_LDa.AddChangedProperty("Caption");
			ctrl_LDa.Size = new System.Drawing.Size(86, 23);
			ctrl_LDa.AddChangedProperty("Size");
			this.Add(ctrl_LDa, true);
			ctrl_LA = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "LA", "DoubleEdit", new System.Drawing.Point(177, 87), false);
			ctrl_LA.DataBinding = new FieldDataBinding(Document.DBTDOORSPolIntela.TTAG_DOORS_PolIntela.fld_LA, Document.DBTDOORSPolIntela);
			ctrl_LA.AddChangedProperty("Caption");
			ctrl_LA.Size = new System.Drawing.Size(88, 23);
			ctrl_LA.AddChangedProperty("Size");
			this.Add(ctrl_LA, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_FindH, "ctrl_FindH");
			resources.ApplyResources(ctrl_HA, "ctrl_HA");
			resources.ApplyResources(ctrl_HDa, "ctrl_HDa");
			resources.ApplyResources(ctrl_FindL, "ctrl_FindL");
			resources.ApplyResources(ctrl_LDa, "ctrl_LDa");
			resources.ApplyResources(ctrl_LA, "ctrl_LA");
		}
