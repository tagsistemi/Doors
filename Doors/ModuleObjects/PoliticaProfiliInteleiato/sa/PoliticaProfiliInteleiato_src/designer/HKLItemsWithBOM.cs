...
{
	public class HKLItemsWithBOM : Microarea.Framework.TBApplicationWrapper.MHotLink
	{
		public HKLItemsWithBOM() : base(new Microarea.TaskBuilderNet.Core.Generic.NameSpace("HotKeyLink.ERP.BillOfMaterials.Dbl.ItemsWithBOM"), "ItemsWithBOM", DocumentController.controller.Document, false)
		{
		}
		...
		public THKLItemsWithBOM_MA_BillOfMaterials TMA_BillOfMaterials;

		public virtual THKLItemsWithBOM_MA_BillOfMaterials CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (THKLItemsWithBOM_MA_BillOfMaterials)record;
		}

		public MHotLinkSearch HKLItemsWithBOM_ByKey;

		public MHotLinkSearch HKLItemsWithBOM_ByDescription;
		...
		public Microarea.Framework.TBApplicationWrapper.MHotLinkParam ParamAttive
		{
			get
			{
				return this.GetParamByName("Attive");
			}
		}

		[Microarea.TaskBuilderNet.Core.Localization.LocalizedCategoryAttribute("Parameters", typeof(Microarea.TaskBuilderNet.Core.EasyBuilder.EBCategories))]
		public Microarea.Framework.TBApplicationWrapper.MHotLinkParam ParamSemifinished
		{
			get
			{
				return this.GetParamByName("Semifinished");
			}
		}

		public override void CreateComponents()
		{
			TMA_BillOfMaterials = new THKLItemsWithBOM_MA_BillOfMaterials(this.GetRecordPtr());
			this.Add(TMA_BillOfMaterials, true);
			HKLItemsWithBOM_ByKey = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, true);
			HKLItemsWithBOM_ByKey.UseInComboBox = true;
			HKLItemsWithBOM_ByKey.AddChangedProperty("UseInComboBox");
			HKLItemsWithBOM_ByKey.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.UpperButton;
			HKLItemsWithBOM_ByKey.AddChangedProperty("AssociatedButton");
			HKLItemsWithBOM_ByKey.FieldName = "BOM";
			HKLItemsWithBOM_ByKey.AddChangedProperty("FieldName");
			HKLItemsWithBOM_ByKey.AddChangedProperty("Description");
			HKLItemsWithBOM_ByKey.Name = "ByKey";
			HKLItemsWithBOM_ByKey.AddChangedProperty("Name");
			this.Add(HKLItemsWithBOM_ByKey, true);
			HKLItemsWithBOM_ByDescription = new Microarea.Framework.TBApplicationWrapper.MHotLinkSearch(this, true);
			HKLItemsWithBOM_ByDescription.AssociatedButton = Microarea.Framework.TBApplicationWrapper.MHotLinkSearch.ButtonAssociation.LowerButton;
			HKLItemsWithBOM_ByDescription.AddChangedProperty("AssociatedButton");
			HKLItemsWithBOM_ByDescription.FieldName = "Description";
			HKLItemsWithBOM_ByDescription.AddChangedProperty("FieldName");
			HKLItemsWithBOM_ByDescription.AddChangedProperty("Description");
			HKLItemsWithBOM_ByDescription.Name = "ByDescription";
			HKLItemsWithBOM_ByDescription.AddChangedProperty("Name");
			this.Add(HKLItemsWithBOM_ByDescription, true);
		}
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLItemsWithBOM_ByKey, "HKLItemsWithBOM_ByKey");
			resources.ApplyResources(HKLItemsWithBOM_ByDescription, "HKLItemsWithBOM_ByDescription");
		}
		...
		public override void ClearComponents()
		{
			...
			HKLItemsWithBOM_ByKey = null;
			HKLItemsWithBOM_ByDescription = null;
		}
	}
}
