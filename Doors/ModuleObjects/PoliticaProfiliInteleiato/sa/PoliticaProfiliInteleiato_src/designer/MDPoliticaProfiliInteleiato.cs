...
{
	public class MDPoliticaProfiliInteleiato : MDocument
	{
		public MDPoliticaProfiliInteleiato(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSPolIntela DBTDOORSPolIntela;

		public HKLItems HKLItems;

		public DBTDOORSPolIntelaDetail DBTDOORSPolIntelaDetail;

		public HKLItemsWithBOM HKLItemsWithBOM;
		...
		{
			DBTDOORSPolIntela = new DBTDOORSPolIntela();
			this.AttachMaster(this.DBTDOORSPolIntela);
			...
			DBTDOORSPolIntelaDetail = new DBTDOORSPolIntelaDetail();
			this.AttachSlave(DBTDOORSPolIntelaDetail);
			DBTDOORSPolIntelaDetail.AddMasterForeignKey(DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_Item, "Item");
			DBTDOORSPolIntelaDetail.AddMasterForeignKey(DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_HDa, "HDa");
			DBTDOORSPolIntelaDetail.AddMasterForeignKey(DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_HA, "HA");
			DBTDOORSPolIntelaDetail.AddMasterForeignKey(DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_LDa, "LDa");
			DBTDOORSPolIntelaDetail.AddMasterForeignKey(DBTDOORSPolIntelaDetail.TTAG_DOORS_PolIntelaDetail.fld_LA, "LA");
			DBTDOORSPolIntelaDetail.AuxColumnsPrepared += new System.EventHandler<Microarea.Framework.TBApplicationWrapper.RowEventArgs>(DocumentController.controller.Document_DBTDOORSPolIntelaDetail_AuxColumnsPrepared);
			DBTDOORSPolIntelaDetail.AddChangedEvent(new EventInfo("DBTDOORSPolIntelaDetail.AuxColumnsPrepared", "Document_DBTDOORSPolIntelaDetail_AuxColumnsPrepared", "System.EventHandler`1[Microarea.Framework.TBApplicationWrapper.RowEventArgs]", "Document.DBTDOORSPolIntelaDetail", true));
			HKLItemsWithBOM = new HKLItemsWithBOM();
			this.Add(this.HKLItemsWithBOM, true);
			HKLItemsWithBOM.DataMustExist = true;
			HKLItemsWithBOM.AddChangedProperty("DataMustExist");
			HKLItemsWithBOM.Queried += new System.EventHandler<EasyBuilderEventArgs>(DocumentController.controller.Document_HKLItemsWithBOM_Queried);
			HKLItemsWithBOM.AddChangedEvent(new EventInfo("HKLItemsWithBOM.Queried", "Document_HKLItemsWithBOM_Queried", "System.EventHandler`1[EasyBuilderEventArgs]", "Document.HKLItemsWithBOM", true));
			HKLItemsWithBOM.ParamAttive.Value = (Int16)0;
			HKLItemsWithBOM.ParamSemifinished.Value = (Int16)0;
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(HKLItemsWithBOM, "HKLItemsWithBOM");
		}

		public override void ClearComponents()
		{
			base.ClearComponents();
			DBTDOORSPolIntela = null;
			HKLItems = null;
			DBTDOORSPolIntelaDetail = null;
			HKLItemsWithBOM = null;
			fld__DEBUG = null;
			fld_FormMode = null;
