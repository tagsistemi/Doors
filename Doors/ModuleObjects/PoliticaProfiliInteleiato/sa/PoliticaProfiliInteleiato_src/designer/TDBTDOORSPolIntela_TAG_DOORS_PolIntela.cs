...
{
	public class TDBTDOORSPolIntela_TAG_DOORS_PolIntela : Microarea.Framework.TBApplicationWrapper.MSqlRecord
	{
		public TDBTDOORSPolIntela_TAG_DOORS_PolIntela(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}
		...
		public MDataDbl fld_HDa;

		public MDataDbl fld_HA;

		public MDataDbl fld_LDa;

		public MDataDbl fld_LA;

		public MDataBool fld_FindH;

		public MDataBool fld_FindL;

		public MDataQty fld_RequiredQty;

		public MDataQty fld_Quantita;
		...
		public override void CreateComponents()
		{
			...
			fld_HDa = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("HDa"));
			this.Add(fld_HDa, false);
			fld_HA = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("HA"));
			this.Add(fld_HA, false);
			fld_LDa = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LDa"));
			this.Add(fld_LDa, false);
			fld_LA = new Microarea.Framework.TBApplicationWrapper.MDataDbl(this.GetFieldPtr("LA"));
			this.Add(fld_LA, false);
			fld_FindH = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("FindH"));
			this.Add(fld_FindH, false);
			fld_FindL = new Microarea.Framework.TBApplicationWrapper.MDataBool(this.GetFieldPtr("FindL"));
			this.Add(fld_FindL, false);
			fld_RequiredQty = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("RequiredQty"));
			this.Add(fld_RequiredQty, false);
			fld_Quantita = new Microarea.Framework.TBApplicationWrapper.MDataQty(this.GetFieldPtr("Quantita"));
			this.Add(fld_Quantita, false);
		}
