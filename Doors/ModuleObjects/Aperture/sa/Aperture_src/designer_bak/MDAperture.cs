...
{
	public class MDAperture : MDocument
	{
		public MDAperture(System.IntPtr wrappedObject) : base(wrappedObject)
		{
		}

		public DBTDOORSAperture DBTDOORSAperture;
		...
		{
			DBTDOORSAperture = new DBTDOORSAperture();
			this.AttachMaster(this.DBTDOORSAperture);
