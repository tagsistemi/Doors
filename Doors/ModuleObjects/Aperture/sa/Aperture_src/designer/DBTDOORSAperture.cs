...
using System.Data;
using System;
namespace Customization.Doors.Doors.DynamicDocuments.Aperture.Aperture
{
	public class DBTDOORSAperture : MDBTMaster
	{
		public DBTDOORSAperture() : base("TAG_DOORS_Aperture", "DOORSAperture", DocumentController.controller.Document, false)
		{
		}

		public DBTDOORSAperture(System.IntPtr dbtPtr) : base(dbtPtr)
		{
		}
		...
		public TDBTDOORSAperture_TAG_DOORS_Aperture TTAG_DOORS_Aperture;

		public override Microarea.TaskBuilderNet.Interfaces.Model.IRecord OldRecord
		{
			get
			{
				return OldTTAG_DOORS_Aperture;
			}
		}

		public TDBTDOORSAperture_TAG_DOORS_Aperture OldTTAG_DOORS_Aperture;

		public virtual TDBTDOORSAperture_TAG_DOORS_Aperture CastToMyRecord(Microarea.TaskBuilderNet.Interfaces.Model.IRecord record)
		{
			return (TDBTDOORSAperture_TAG_DOORS_Aperture)record;
		}

		public override Microarea.Framework.TBApplicationWrapper.MDBTObject CreateAndAttach(System.IntPtr dbtPtr)
		{
			return new DBTDOORSAperture(dbtPtr);
		}

		public override void CreateComponents()
		{
			TTAG_DOORS_Aperture = new TDBTDOORSAperture_TAG_DOORS_Aperture(this.GetRecordPtr());
			this.Add(TTAG_DOORS_Aperture, true);
			OldTTAG_DOORS_Aperture = new TDBTDOORSAperture_TAG_DOORS_Aperture(this.GetOldRecordPtr());
			this.Add(OldTTAG_DOORS_Aperture, true);
		}
