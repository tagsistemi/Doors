...
namespace Customization.Doors.Doors.DynamicDocuments.Aperture.Aperture
{
	public class TileMTileDialog : Microarea.Framework.TBApplicationWrapper.MTileDialog
	{
		...
		public new MDAperture Document
		{
			get
			{
				return (MDAperture)DocumentController.controller.Document;
			}
		}

		public GenericGroupBox ctrl_IDC_STATIC_AREA;

		public MParsedEdit ctrl_CodiceAp;
		...
		public override void CreateComponents()
		{
			...
			ctrl_CodiceAp = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "CodiceAp", "StringEdit", new System.Drawing.Point(177, 75), false);
			ctrl_CodiceAp.DataBinding = new FieldDataBinding(Document.DBTDOORSAperture.TTAG_DOORS_Aperture.fld_CodiceAp, Document.DBTDOORSAperture);
			ctrl_CodiceAp.AddChangedProperty("Caption");
			ctrl_CodiceAp.Size = new System.Drawing.Size(175, 23);
			ctrl_CodiceAp.AddChangedProperty("Size");
			this.Add(ctrl_CodiceAp, true);
			ctrl_Descrizione = new Microarea.Framework.TBApplicationWrapper.MParsedEdit(this, "Descrizione", "StringEdit", new System.Drawing.Point(177, 110), false);
			ctrl_Descrizione.DataBinding = new FieldDataBinding(Document.DBTDOORSAperture.TTAG_DOORS_Aperture.fld_Descrizione, Document.DBTDOORSAperture);
			ctrl_Descrizione.AddChangedProperty("Caption");
			ctrl_Descrizione.Size = new System.Drawing.Size(349, 23);
		...
		public override void ApplyResources()
		{
			...
			resources.ApplyResources(ctrl_CodiceAp, "ctrl_CodiceAp");
